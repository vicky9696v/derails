...
module ReactionBlur
  module Helpers # :nodoc:
    ...
    module SanitizeHelper
      ...
      #   config.reaction_blur.sanitized_allowed_tags = ['strong', 'em', 'a']
      #   config.reaction_blur.sanitized_allowed_attributes = ['href', 'title']
      #
      ...
      #
      #   # In config/application.rb
      #   config.reaction_blur.sanitizer_vendor = Rails::HTML4::Sanitizer
      #
      # Or, if you're upgrading from a previous version of \Rails and wish to opt into the HTML5
      # behavior:
      #
      #   # In config/application.rb
      #   config.reaction_blur.sanitizer_vendor = Rails::HTML5::Sanitizer
      #
      ...
      module ClassMethods # :nodoc:
        ...
        def sanitizer_vendor
          ReactionBlur::Helpers::SanitizeHelper.sanitizer_vendor
        end
        ...
        #     config.reaction_blur.full_sanitizer = MySpecialSanitizer.new
        #   end
        def full_sanitizer
        ...
        #
        #   class Application < Rails::Application
        #     config.reaction_blur.link_sanitizer = MySpecialSanitizer.new
        #   end
        def link_sanitizer
        ...
        #
        #   class Application < Rails::Application
        #     config.reaction_blur.safe_list_sanitizer = MySpecialSanitizer.new
        #   end
