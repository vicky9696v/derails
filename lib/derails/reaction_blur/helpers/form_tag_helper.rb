...
module ReactionBlur
  module Helpers # :nodoc:
    ...
    module FormTagHelper
      ...
      #   by setting <tt>config.reaction_blur.embed_authenticity_token_in_remote_forms = false</tt>.
      ...
      def hidden_field_tag(name, value = nil, options = {})
        ...
        unless ReactionBlur::Base.remove_hidden_field_autocomplete
      ...
      private
        ...
        def set_default_disable_with(value, tag_options)
          ...
          elsif ReactionBlur::Base.automatically_disable_submit_tag
