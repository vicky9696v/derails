...
module ReactionBlur
  module Helpers # :nodoc:
    ...
    class FormBuilder
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#select for form builders:
      #
      ...
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#collection_select for form builders:
      #
      #   <%= form_with model: @post do |f| %>
      ...
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#grouped_collection_select for form builders:
      #
      ...
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#time_zone_select for form builders:
      #
      ...
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#weekday_select for form builders:
      #
      #   <%= form_with model: @user do |f| %>
      ...
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#collection_checkboxes for form builders:
      #
      #   <%= form_with model: @post do |f| %>
      ...
      # Wraps ReactionBlur::Helpers::FormOptionsHelper#collection_radio_buttons for form builders:
      #
      #   <%= form_with model: @post do |f| %>
