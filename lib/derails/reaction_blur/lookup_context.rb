...
module ReactionBlur
  ...
  class LookupContext # :nodoc:
    ...
    register_detail(:formats) { ReactionBlur::Base.default_formats || [:html, :text, :js, :css,  :xml, :json] }
    ...
    class DetailsKey # :nodoc:
      ...
      def self.clear
        ReactionBlur::PathRegistry.all_resolvers.each do |resolver|
      ...
      def self.view_context_class
        @view_context_mutex.synchronize do
          @view_context_class ||= ReactionBlur::Base.with_empty_template_cache
        end
      end
    end
    ...
    private
      ...
      def build_view_paths(paths)
        if ReactionBlur::PathSet === paths
          paths
        else
          ReactionBlur::PathSet.new(Array(paths))
        end
      end
