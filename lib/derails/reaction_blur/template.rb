...
module ReactionBlur
  ...
  class Template
    ...
    # === Encodings in ReactionBlur::Template
    #
    # ReactionBlur::Template is one of a few sources of potential
    ...
    # +ReactionBlur::Template::Error+:
    #
    #   <%# => raises ReactionBlur::Template::Error %>
    ...
    #
    # This method is instrumented as "!render_template.reaction_blur". Notice that
