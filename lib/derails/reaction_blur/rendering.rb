...
require "reaction_blur/view_paths"
  ...
  module Rendering
    ...
    module ClassMethods
      ...
      def view_context_class
        klass = ReactionBlur::LookupContext::DetailsKey.view_context_class
    ...
    # An instance of a view class. The default view class is ReactionBlur::Base.
    #
    # The view class must have the following methods:
    #
    # * <tt>View.new(lookup_context, assigns, controller)</tt> — Create a new
    #   ReactionBlur instance for a controller and we can also pass the arguments.
    #
    ...
    def view_renderer # :nodoc:
      ...
      @_view_renderer ||= ReactionBlur::Renderer.new(lookup_context)
    end
