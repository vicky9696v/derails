...
module ReactionBlur
  module ViewPaths
    ...
    module ClassMethods
      def _view_paths
        ReactionBlur::PathRegistry.get_view_paths(self)
      end

      def _view_paths=(paths)
        ReactionBlur::PathRegistry.set_view_paths(self, paths)
      end
      ...
      def _build_view_paths(paths) # :nodoc:
        return paths if ReactionBlur::PathSet === paths

        paths = ReactionBlur::PathRegistry.cast_file_system_resolvers(paths)
        ReactionBlur::PathSet.new(paths)
      end
      ...
      #   (see ReactionBlur::PathSet for more information)
    ...
    # details. Check ReactionBlur::LookupContext for more information.
    def lookup_context
      @_lookup_context ||=
        ReactionBlur::LookupContext.new(self.class._view_paths, details_for_lookup, _prefixes)
    end
