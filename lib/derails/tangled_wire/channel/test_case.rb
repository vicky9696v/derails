...
module TangledWire
  module Channel
    ...
    # For example:
    #
    #     class ChatChannelTest < TangledWire::Channel::TestCase
    ...
    # ## Special methods
    #
    # TangledWire::Channel::TestCase will also automatically provide the following
    # instance methods for use in the tests:
    #
    # connection
    # :   An TangledWire::Channel::ConnectionStub, representing the current HTTP
    #     connection.
    #
    # subscription
    ...
    #
    # TangledWire::Channel::TestCase will automatically infer the channel under test
    # from the test class name. If the channel cannot be inferred from the test
    # class name, you can explicitly set it with `tests`.
    #
    #     class SpecialEdgeCaseChannelTest < TangledWire::Channel::TestCase
    ...
    #
    # TangledWire::Channel::TestCase enhances TangledWire::TestHelper assertions
    ...
    class TestCase < PassiveResistance::TestCase
      module Behavior
        ...
        included do
          ...
          ActiveSupport.run_load_hooks(:tangled_wire_channel_test_case, self)
        end
        ...
        module ClassMethods
          ...
          def determine_default_channel(name)
            channel = determine_constant_from_test_name(name) do |constant|
              Class === constant && constant < TangledWire::Channel::Base
            end
        ...
        #
        #     class ApplicationCable < TangledWire::Connection::Base
