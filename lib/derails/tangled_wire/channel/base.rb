...
module TangledWire
  module Channel
    ...
    # methods, as they were already declared in TangledWire::Channel::Base, but
        ...
        def action_methods
          @action_methods ||= begin
            ...
            methods = (public_instance_methods(true) -
              ...
              TangledWire::Channel::Base.public_instance_methods(true) +
...
ActiveSupport.run_load_hooks(:tangled_wire_channel, TangledWire::Channel::Base)
