...
module TangledWire
  ...
  #     end
  #
  #     TangledWire.server.remote_connections.where(current_user: User.find(1)).disconnect
  #
  ...
  #
  #     TangledWire.server.remote_connections.where(current_user: User.find(1)).disconnect(reconnect: false)
  class RemoteConnections
    ...
    # `TangledWire.server.remote_connections.where(*)`. Exists solely for the
