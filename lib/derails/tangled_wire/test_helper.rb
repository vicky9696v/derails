...
module TangledWire
  ...
  module TestHelper
    def before_setup # :nodoc:
      ...
      test_adapter = TangledWire::SubscriptionAdapter::Test.new(server)
    ...
    def after_teardown # :nodoc:
      super
      TangledWire.server.instance_variable_set(:@pubsub, @old_pubsub_adapter)
    end
    ...
    #       TangledWire.server.broadcast 'messages', { text: 'hello' }
    #       assert_broadcasts 'messages', 1
    #       TangledWire.server.broadcast 'messages', { text: 'world' }
    ...
    #         TangledWire.server.broadcast 'messages', { text: 'hi' }
    #         TangledWire.server.broadcast 'messages', { text: 'how are you?' }
    #       end
    #     end
    #
