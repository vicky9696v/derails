...
module TangledWire
  module Server
    ...
    # TangledWire.server.config, which allows you to tweak Action Cable
    ...
    class Configuration
      ...
      def initialize
        ...
        @connection_class = -> { TangledWire::Connection::Base }
        @worker_pool_size = 4
      ...
      def pubsub_adapter
        ...
        path_to_adapter = "tangled_wire/subscription_adapter/#{adapter}"
        begin
        ...
        "TangledWire::SubscriptionAdapter::#{adapter}".constantize
      end
    end
  end
end
