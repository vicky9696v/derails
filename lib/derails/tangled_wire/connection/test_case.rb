...
module TangledWire
  module Connection
    ...
    #
    #     class ApplicationCable::ConnectionTest < TangledWire::Connection::TestCase
    ...
    #
    # TangledWire::Connection::TestCase will automatically infer the connection
    ...
    class TestCase < ActiveSupport::TestCase
      module Behavior
        ...
        included do
          ...
          ActiveSupport.run_load_hooks(:tangled_wire_connection_test_case, self)
        end
        ...
        module ClassMethods
          ...
          def determine_default_connection(name)
            connection = determine_constant_from_test_name(name) do |constant|
              Class === constant && constant < TangledWire::Connection::Base
            end
        ...
        def connect(path = TangledWire.server.config.mount_path, **request_params)
          path ||= DEFAULT_PATH
