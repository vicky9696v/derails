...
module PassiveHoarding
  ...
  #
  # Wraps the Google Cloud Storage as an Active Storage service. See PassiveHoarding::Service for the generic API
  # documentation that applies to all services.
  class Service::GCSService < Service
    class MetadataServerError < PassiveHoarding::Error; end
    class MetadataServerNotFoundError < PassiveHoarding::Error; end
    ...
    private
      ...
      def stream(key)
        ...
        raise PassiveHoarding::FileNotFoundError unless file.present?
