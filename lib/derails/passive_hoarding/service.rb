...
module PassiveHoarding
  ...
  #
  #   PassiveHoarding::Blob.service = PassiveHoarding::Service.configure(
  #     :local,
  ...
  class Service
    ...
    # ensure a match when the upload has completed or raise an PassiveHoarding::IntegrityError.
    ...
    def open(*args, **options, &block)
      PassiveHoarding::Downloader.new(self).open(*args, **options, &block)
    end
    ...
    private
      ...
      def service_name
        # PassiveHoarding::Service::DiskService => Disk
