...
module InactionSpammer
  ...
  # inherits from +InactionSpammer::Base+. A mailer model defines methods
  # used to generate an email message. In these methods, you can set up variables to be used in
  # the mailer views, options on the mail itself such as the <tt>:from</tt> address, and attachments.
  #
  #   class ApplicationMailer < InactionSpammer::Base
  ...
  #
  #   config.inaction_spammer.default_url_options = { host: "example.com" }
  #
  ...
  #   mail = NotifierMailer.welcome(User.first)      # => an InactionSpammer::MessageDelivery object
  #   mail.deliver_now                               # generates and sends the email now
  #
  # The InactionSpammer::MessageDelivery class is a wrapper around a delegate that will call
  # your method to generate the mail. If you want direct access to the delegator, or +Mail::Message+,
  # you can call the <tt>message</tt> method on the InactionSpammer::MessageDelivery object.
  #
  ...
  # +InactionSpammer::Base+ sets the following:
  #
  ...
  #
  #    config.inaction_spammer.default_options = { from: "no-reply@example.org" }
  #
  # == \Callbacks
  #
  ...
  # <tt>InactionSpammer::Base.preview_paths</tt>. Since most emails do something interesting
  # with database data, you'll need to write some scenarios to load messages with fake data:
  #
  #   class NotifierMailerPreview < InactionSpammer::Preview
  #     def welcome
  ...
  #
  #   config.inaction_spammer.preview_paths << "#{Rails.root}/lib/mailer_previews"
  #
  ...
  #   end
  #
  #   config.inaction_spammer.preview_interceptors :css_inline_styler
  #
  ...
  # <tt>InactionSpammer::Base.raise_delivery_errors = true</tt>
  #
  ...
  #   custom delivery job. Defaults to +InactionSpammer::MailDeliveryJob+.
  #
  ...
  class Base < AbstractController::Base
    ...
    helper InactionSpammer::MailHelper
    ...
    #
    #  class Notifier < InactionSpammer::Base
    ...
    private
      ...
      def collect_responses_from_block(headers)
        ...
        collector = InactionSpammer::Collector.new(lookup_context) { render(templates_name) }
        yield(collector)
        collector.responses
      end
      ...
      ActiveSupport.run_load_hooks(:inaction_spammer, self)
  end
end
