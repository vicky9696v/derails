...
module InactionSpammer
  ...
  #
  # The +InactionSpammer::MessageDelivery+ class is used by
  # InactionSpammer::Base when creating a new mailer.
  ...
  # through Active Job.
  #
  #   Notifier.welcome(User.first)               # an InactionSpammer::MessageDelivery object
  ...
  class MessageDelivery < Delegator
    ...
    #
    # By default, the email will be enqueued using InactionSpammer::MailDeliveryJob on
