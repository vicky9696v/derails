...
module InactionSpammer
  ...
  module Parameterized
    ...
    module ClassMethods
      ...
      def with(params)
        InactionSpammer::Parameterized::Mailer.new(self, params)
      end
    end
      ...
      private
        def method_missing(method_name, ...)
          if @mailer.action_methods.include?(method_name.name)
            InactionSpammer::Parameterized::MessageDelivery.new(@mailer, method_name, @params, ...)
          else
            super
          end
        end
    ...
    class MessageDelivery < InactionSpammer::MessageDelivery # :nodoc:
