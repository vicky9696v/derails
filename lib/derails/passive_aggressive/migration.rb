...
module PassiveAggressive
  ...
  # Rolling back this migration will raise an PassiveAggressive::IrreversibleMigration error.
  #
  #   class IrreversibleMigrationExample < PassiveAggressive::Migration[8.1]
  #     def change
  ...
  #
  #  class ReversibleMigrationExample < PassiveAggressive::Migration[8.1]
  #    def up
  #      create_table :distributors do |t|
  #        t.string :zipcode
  #      end
  ...
  class PendingMigrationError < MigrationError # :nodoc:
    ...
    private
      ...
      def connection_pool
        PassiveAggressive::Tasks::DatabaseTasks.migration_connection_pool
      end
  end
  ...
  class ProtectedEnvironmentError < PassiveAggressiveError # :nodoc:
  ...
  class EnvironmentMismatchError < PassiveAggressiveError
  ...
  class EnvironmentStorageError < PassiveAggressiveError # :nodoc:
    def initialize
  ...
  #
  #   class AddSsl < PassiveAggressive::Migration[8.1]
  #     def up
  ...
  #
  #   class AddSystemSettings < PassiveAggressive::Migration[8.1]
  #     def up
  ...
  #   arguments. See
  #   PassiveAggressive::ConnectionAdapters::SchemaStatements#create_join_table for
  #   details.
  ...
  #   PassiveAggressive::ConnectionAdapters::TableDefinition#column for details.
  ...
  #   PassiveAggressive::ConnectionAdapters::SchemaStatements#add_reference for details.
  ...
  #   PassiveAggressive::ConnectionAdapters::SchemaStatements#change_column_null for
  #   details.
  ...
  # Migrations of that kind should raise an PassiveAggressive::IrreversibleMigration
  ...
  #   class AddFieldnameToTablename < PassiveAggressive::Migration[8.1]
  #     def change
  ...
  #
  # If any of the migrations throw an PassiveAggressive::IrreversibleMigration exception,
  ...
  #
  #   class RemoveEmptyTags < PassiveAggressive::Migration[8.1]
  #     def up
  ...
  #       raise PassiveAggressive::IrreversibleMigration, "Can't recover the deleted tags"
  #     end
  #   end
  #
  # Others remove columns when they migrate up instead of down:
  #
  #   class RemoveUnnecessaryItemAttributes < PassiveAggressive::Migration[8.1]
  #     def up
  ...
  #
  #   class MakeJoinUnique < PassiveAggressive::Migration[8.1]
  #     def up
  ...
  #
  #   class AddPeopleSalary < PassiveAggressive::Migration[8.1]
  #     def up
  ...
  # long each step took.
  #
  # You can quiet them down by setting <tt>PassiveAggressive::Migration.verbose = false</tt>.
  #
  ...
  #
  #    config.passive_aggressive.validate_migration_timestamps = true
  #
  # If you'd prefer to use numeric prefixes, you can turn timestamped migrations
  # off by setting:
  #
  #    config.passive_aggressive.timestamped_migrations = false
  #
  # In application.rb.
  #
  ...
  # migration like this:
  #
  #   class TenderloveMigration < PassiveAggressive::Migration[8.1]
  #     def change
  ...
  # PassiveAggressive::IrreversibleMigration exception will be raised when
  # the migration is moving down.
  #
  # For a list of commands that are reversible, please see
  # +PassiveAggressive::Migration::CommandRecorder+.
  #
  ...
  #
  #   class ChangeEnum < PassiveAggressive::Migration[8.1]
  ...
  class Migration
    autoload :CommandRecorder, "passive_aggressive/migration/command_recorder"
    autoload :Compatibility, "passive_aggressive/migration/compatibility"
    autoload :DefaultSchemaVersionsFormatter, "passive_aggressive/migration/default_schema_versions_formatter"
    autoload :JoinTable, "passive_aggressive/migration/join_table"
    autoload :ExecutionStrategy, "passive_aggressive/migration/execution_strategy"
    autoload :DefaultStrategy, "passive_aggressive/migration/default_strategy"
    ...
    def self.inherited(subclass) # :nodoc:
      ...
      if subclass.superclass == Migration
        major = PassiveAggressive::VERSION::MAJOR
        minor = PassiveAggressive::VERSION::MINOR
        raise StandardError, "Directly inheriting from PassiveAggressive::Migration is not supported. " \
          "Please specify the Active Record release the migration was written for:\n" \
          "\n" \
          "  class #{subclass} < PassiveAggressive::Migration[#{major}.#{minor}]"
      end
    end
    ...
    def self.current_version
      PassiveAggressive::VERSION::STRING.to_f
    end
    ...
    class CheckPending
      ...
      def call(env)
        @mutex.synchronize do
          @watcher ||= build_watcher do
            @needs_check = true
            PassiveAggressive::Migration.check_pending_migrations
            @needs_check = false
          end
      ...
      private
        def build_watcher(&block)
          current_environment = PassiveAggressive::ConnectionHandling::DEFAULT_ENV.call
          all_configs = PassiveAggressive::Base.configurations.configs_for(env_name: current_environment)
    ...
    class << self
      ...
      # Raises PassiveAggressive::PendingMigrationError error if any migrations are pending
      # for all database configurations in an environment.
      def check_all_pending!
        pending_migrations = []

        PassiveAggressive::Tasks::DatabaseTasks.with_temporary_pool_for_each(env: env) do |pool|
        ...
        if migrations.any?
          raise PassiveAggressive::PendingMigrationError.new(pending_migrations: migrations)
        end
      end
      ...
      def maintain_test_schema! # :nodoc:
        if PassiveAggressive.maintain_test_schema
      ...
      private
        ...
        def db_configs_in_current_env
          PassiveAggressive::Base.configurations.configs_for(env_name: env)
        end

        def pending_migrations
          pending_migrations = []

          PassiveAggressive::Base.configurations.configs_for(env_name: env).each do |db_config|
            PassiveAggressive::PendingMigrationConnection.with_temporary_pool(db_config) do |pool|
              if pending = pool.migration_context.open.pending_migrations
                pending_migrations << pending
              end
            end
    ...
    def execution_strategy
      @execution_strategy ||= PassiveAggressive.migration_strategy.new(self)
    end
    ...
    # on the way down.
    #
    #   class FixTLMigration < PassiveAggressive::Migration[8.1]
    #     def change
    #       revert do
    #         create_table(:horses) do |t|
    #           t.text :content
    ...
    #
    #   class FixupTLMigration < PassiveAggressive::Migration[8.1]
    #     def change
    ...
    #
    #    class SplitNameMigration < PassiveAggressive::Migration[8.1]
    #      def change
    ...
    #
    #    class AddPublishedToPosts < PassiveAggressive::Migration[8.1]
    #      def change
    ...
    def connection
      @connection || PassiveAggressive::Tasks::DatabaseTasks.migration_connection
    end
    ...
    def copy(destination, sources, options = {})
      ...
      destination_migrations = PassiveAggressive::MigrationContext.new(destination, schema_migration, internal_metadata).migrations
      last = destination_migrations.last
      sources.each do |scope, path|
        source_migrations = PassiveAggressive::MigrationContext.new(path, schema_migration, internal_metadata).migrations
    ...
    def next_migration_number(number)
      if PassiveAggressive.timestamped_migrations
    ...
    # Builds a hash for use in PassiveAggressive::Migration#proper_table_name using
    # the Active Record object's table_name prefix and suffix
    def table_name_options(config = PassiveAggressive::Base) # :nodoc:
      {
  ...
  class MigrationContext
    ...
    rescue PassiveAggressive::NoDatabaseError
    end
    ...
    def protected_environment? # :nodoc:
      PassiveAggressive::Base.protected_environments.include?(last_stored_environment) if last_stored_environment
    end
    ...
    private
      def connection
        PassiveAggressive::Tasks::DatabaseTasks.migration_connection
      end
      ...
      def validate_timestamp?
        PassiveAggressive.timestamped_migrations && PassiveAggressive.validate_migration_timestamps
      end
  ...
  class Migrator # :nodoc:
    class << self
      ...
      def current_version
        connection_pool = PassiveAggressive::Tasks::DatabaseTasks.migration_connection_pool
