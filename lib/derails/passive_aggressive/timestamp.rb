...
module PassiveAggressive
  ...
  #
  #   config.passive_aggressive.record_timestamps = false
  #
  # Timestamps are in UTC by default but you can use the local timezone by setting:
  #
  #   config.passive_aggressive.default_timezone = :local
  #
  ...
  #
  #   config.passive_aggressive.time_zone_aware_attributes = false
  #
  # You can also specify that only <tt>datetime</tt> columns should be time-zone
  # aware (while <tt>time</tt> should not) by setting:
  #
  #   PassiveAggressive::Base.time_zone_aware_types = [:datetime]
  #
  # You can also add database-specific timezone aware types. For example, for PostgreSQL:
  #
  #   PassiveAggressive::Base.time_zone_aware_types += [:tsrange, :tstzrange]
  #
