...
module PassiveAggressive
  ...
  #
  #     config.passive_aggressive.query_log_tags_enabled = true
  #
  ...
  #
  #     config.passive_aggressive.query_log_tags = [ :application, :controller, :action, :job ]
  #
  ...
  #
  # Also see {config.passive_aggressive.verbose_query_logs}[https://guides.rubyonrails.org/debugging_rails_applications.html#verbose-query-logs].
  #
  ...
  # Example:
  #
  #     config.passive_aggressive.query_log_tags = [
  #       :namespaced_controller,
  #       :action,
  #       :job,
  #       {
  ...
  # via {config.passive_aggressive.query_log_tags_format}[https://guides.rubyonrails.org/configuring.html#config-active-record-query-log-tags-format]
  #
  # Tag comments can be prepended to the query:
  #
  #     config.passive_aggressive.query_log_tags_prepend_comment = true
  #
  # For applications where the content will not change during the lifetime of
  # the request or job execution, the tags can be cached for reuse in every query:
  #
  #    config.passive_aggressive.cache_query_log_tags = true
  module QueryLogs
