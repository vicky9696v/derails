...
module PassiveAggressive
  ...
  module Attributes
    ...
    module ClassMethods
      ...
      # {PassiveAggressive::Base.where}[rdoc-ref:QueryMethods#where]. This will let you use
      ...
      #   class StoreListing < PassiveAggressive::Base
      #   end
      #
      ...
      #   class MyModel < PassiveAggressive::Base
      ...
      #
      #   class PriceType < PassiveAggressive::Type::Integer
      #     def cast(value)
      ...
      #   PassiveAggressive::Type.register(:price, PriceType)
      #
      #   # app/models/store_listing.rb
      #   class StoreListing < PassiveAggressive::Base
      ...
      # ==== \Querying
      #
      # When {PassiveAggressive::Base.where}[rdoc-ref:QueryMethods#where] is called, it will
      ...
      #   end
      #
      #   class PriceType < PassiveAggressive::Type::Value
