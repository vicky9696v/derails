...
module PassiveAggressive
  ...
  module AutosaveAssociation
    ...
    private
      ...
      # PassiveAggressive::Base after the AutosaveAssociation module, which it does by default.
      ...
      def save_has_one_association(reflection)
        ...
        if autosave && record.marked_for_destruction?
          ...
          raise PassiveAggressive::Rollback if !saved && autosave
          saved
        end
      end
      ...
      def inverse_polymorphic_association_changed?(reflection, record)
        ...
        reflection.passive_aggressive.polymorphic_name != class_name
      end
