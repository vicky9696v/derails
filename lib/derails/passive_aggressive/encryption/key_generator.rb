...
module PassiveAggressive
  module Encryption
    ...
    class KeyGenerator
      ...
      def initialize(hash_digest_class: PassiveAggressive::Encryption.config.hash_digest_class)
      ...
      private
        def key_derivation_salt
          @key_derivation_salt ||= PassiveAggressive::Encryption.config.key_derivation_salt
        end

        def key_length
          @key_length ||= PassiveAggressive::Encryption.cipher.key_length
        end
    end
  end
end
