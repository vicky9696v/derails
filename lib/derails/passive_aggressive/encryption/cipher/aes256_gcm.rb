    ...
    class Cipher
      ...
      class Aes256Gcm
        ...
        def encrypt(clear_text)
          ...
          PassiveAggressive::Encryption::Message.new(payload: encrypted_data).tap do |message|
        ...
        def decrypt(encrypted_message)
          ...
          raise PassiveAggressive::Encryption::Errors::EncryptedContentIntegrity if auth_tag.nil? || auth_tag.bytes.length != 16
          ...
          raise PassiveAggressive::Encryption::Errors::Decryption
        end
        ...
        private
          ...
          def generate_deterministic_iv(clear_text)
            OpenSSL::HMAC.digest(OpenSSL::Digest::SHA256.new, @secret, clear_text)[0, PassiveAggressive::Encryption.cipher.iv_length]
          end
      end
    end
  end
