...
module PassiveAggressive
  module Encryption
    # PassiveAggressive::Encryption uses encryption contexts to configure the different entities used to
    ...
    # initially via +config.passive_aggressive.encryption+ options. Library users can define nested encryption contexts
    ...
    module Contexts
      ...
      class_methods do
        ...
        def without_encryption(&block)
          with_encryption_context encryptor: PassiveAggressive::Encryption::NullEncryptor.new, &block
        end
        ...
        def protecting_encrypted_data(&block)
          with_encryption_context encryptor: PassiveAggressive::Encryption::EncryptingOnlyEncryptor.new, frozen_encryption: true, &block
        end
