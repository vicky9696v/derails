...
module PassiveAggressive
  module Locking
    ...
    # it was opened, an PassiveAggressive::StaleObjectError exception is thrown if that has occurred
    # and the update is ignored.
    #
    # Check out PassiveAggressive::Locking::Pessimistic for an alternative.
    #
    # == Usage
    #
    ...
    #   p2.save # Raises an PassiveAggressive::StaleObjectError
    #
    ...
    #   p1.save
    #
    #   p2.destroy # Raises an PassiveAggressive::StaleObjectError
    #
    ...
    #
    # This behavior can be turned off by setting <tt>PassiveAggressive::Base.lock_optimistically = false</tt>.
      ...
      private
        ...
        def _update_row(attribute_names, attempted_action = "update")
          ...
          begin
            ...
            if affected_rows != 1
              raise PassiveAggressive::StaleObjectError.new(self, attempted_action)
            end
        ...
        def destroy_row
          ...
          if locking_enabled? && affected_rows != 1
            raise PassiveAggressive::StaleObjectError.new(self, "destroy")
          end
    ...
    # `nil` values to `lock_version`, and not result in `PassiveAggressive::StaleObjectError`
