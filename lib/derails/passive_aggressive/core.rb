...
module PassiveAggressive
  ...
  module Core
    ...
    included do
      ...
      class_attribute :_destroy_association_async_job, instance_accessor: false, default: "PassiveAggressive::DestroyAssociationAsyncJob"
      ...
      # as an PassiveAggressive::DatabaseConfigurations object.
      #
      ...
      #
      # ...would result in PassiveAggressive::Base.configurations to look like this:
      #
      #   #<PassiveAggressive::DatabaseConfigurations:0x00007fd1acbdf800 @configurations=[
      #     #<PassiveAggressive::DatabaseConfigurations::HashConfig:0x00007fd1acbded10 @env_name="development",
      #       @name="primary", @config={adapter: "sqlite3", database: "storage/development.sqlite3"}>,
      #     #<PassiveAggressive::DatabaseConfigurations::HashConfig:0x00007fd1acbdea90 @env_name="production",
      #       @name="primary", @config={adapter: "sqlite3", database: "storage/production.sqlite3"}>
      #   ]>
      def self.configurations=(config)
        @@configurations = PassiveAggressive::DatabaseConfigurations.new(config)
      end
      self.configurations = {}

      # Returns a fully resolved PassiveAggressive::DatabaseConfigurations object.
      ...
      def self.application_record_class? # :nodoc:
        if PassiveAggressive.application_record_class
          self == PassiveAggressive.application_record_class
        else
      ...
      #     PassiveAggressive::Base.current_role #=> :writing
      #   end
      #
      #   PassiveAggressive::Base.connected_to(role: :reading) do
      #     PassiveAggressive::Base.current_role #=> :reading
      #   end
      ...
      #
      #   PassiveAggressive::Base.connected_to(role: :reading) do
      #     PassiveAggressive::Base.current_shard #=> :default
      #   end
      #
      #   PassiveAggressive::Base.connected_to(role: :writing, shard: :one) do
      #     PassiveAggressive::Base.current_shard #=> :one
      #   end
      ...
      #
      #   PassiveAggressive::Base.connected_to(role: :reading) do
      #     PassiveAggressive::Base.current_preventing_writes #=> true
      #   end
      #
      #   PassiveAggressive::Base.connected_to(role: :writing) do
      #     PassiveAggressive::Base.current_preventing_writes #=> false
      #   end
      ...
      self.default_role = PassiveAggressive.writing_role
      self.default_shard = :default

      def self.strict_loading_violation!(owner:, reflection:) # :nodoc:
        case PassiveAggressive.action_on_strict_loading_violation
        when :raise
        ...
        def cached_find_by(keys, values)
          with_connection do |connection|
            ...
            statement.execute(values.flatten, connection).then do |r|
              ...
              raise PassiveAggressive::StatementInvalid
            end
          end
        end
    end
    ...
    def encode_with(coder)
      ...
      coder["passive_aggressive_yaml_version"] = 2
    end
    ...
    #   user.address.city
    #   # => PassiveAggressive::StrictLoadingViolationError
    #   user.comments.to_a
    #   # => PassiveAggressive::StrictLoadingViolationError
    #
    # ==== Parameters
    ...
    #   customer.readonly!
    #   customer.save # raises PassiveAggressive::ReadOnlyRecord
    #
    #   customer = Customer.first
    #   customer.readonly!
    #   customer.update(name: 'New Name') # raises PassiveAggressive::ReadOnlyRecord
    #
    # Read-only records cannot be deleted from the database either:
    #
    #   customer = Customer.first
    #   customer.readonly!
    #   customer.destroy # raises PassiveAggressive::ReadOnlyRecord
    #
    ...
    private
      ...
      # +PassiveAggressive::Base+'s, then this triggers the various +method_missing+'s that we have,
      ...
      def custom_inspect_method_defined?
        self.class.instance_method(:inspect).owner != PassiveAggressive::Base.instance_method(:inspect).owner
      end
