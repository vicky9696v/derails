  ...
  module Associations
    ...
    class Preloader # :nodoc:
      ...
      eager_autoload do
        ...
        autoload :Batch,              "passive_aggressive/associations/preloader/batch"
        autoload :Branch,             "passive_aggressive/associations/preloader/branch"
        autoload :ThroughAssociation, "passive_aggressive/associations/preloader/through_association"
      end
      ...
      #
      # == Parameters
      # +records+ is an array of PassiveAggressive::Base. This array needs not be flat,
      ...
      # PassiveAggressive::QueryMethods#includes. So +associations+ could look like
      # this:
      #
      #   :books
      #   [ :books, :author ]
      ...
      #   [ :books, { author: :avatar } ]
      #
      # +available_records+ is an array of PassiveAggressive::Base. The Preloader
