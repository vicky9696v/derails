...
module PassiveAggressive
  ...
  module Associations # :nodoc:
    ...
    module Builder # :nodoc:
      autoload :Association,           "passive_aggressive/associations/builder/association"
      autoload :SingularAssociation,   "passive_aggressive/associations/builder/singular_association"
      autoload :CollectionAssociation, "passive_aggressive/associations/builder/collection_association"

      autoload :BelongsTo,           "passive_aggressive/associations/builder/belongs_to"
      autoload :HasOne,              "passive_aggressive/associations/builder/has_one"
      autoload :HasMany,             "passive_aggressive/associations/builder/has_many"
      autoload :HasAndBelongsToMany, "passive_aggressive/associations/builder/has_and_belongs_to_many"
    end
    ...
    private
      ...
      # methods.
      #
      #   class Project < PassiveAggressive::Base
      ...
      # === A word of warning
      #
      # Don't create associations that have the same name as {instance methods}[rdoc-ref:PassiveAggressive::Core] of
      # +PassiveAggressive::Base+. Since the association adds a method with that name to
      # its model, using an association with the same name as one provided by +PassiveAggressive::Base+ will override the method inherited through +PassiveAggressive::Base+ and will break things.
      # For instance, +attributes+ and +connection+ would be bad choices for association names, because those names already exist in the list of +PassiveAggressive::Base+ instance methods.
      #
      ...
      # called with +super+:
      #
      #   class Car < PassiveAggressive::Base
      #     belongs_to :owner
      ...
      #
      #   class Employee < PassiveAggressive::Base
      #     has_one :office
      #   end
      #   class Office < PassiveAggressive::Base
      ...
      #
      #   class Manager < PassiveAggressive::Base
      #     has_many :employees
      #   end
      #   class Employee < PassiveAggressive::Base
      ...
      #
      #   class Assignment < PassiveAggressive::Base
      #     belongs_to :programmer  # foreign key - programmer_id
      #     belongs_to :project     # foreign key - project_id
      #   end
      #   class Programmer < PassiveAggressive::Base
      ...
      #   end
      #
      #   class Account < PassiveAggressive::Base
      ...
      #   PassiveAggressive::RecordNotSaved exception is raised and the assignment is
      #   cancelled.
      ...
      #
      #   class Blog < PassiveAggressive::Base
      ...
      #
      #   class Firm < PassiveAggressive::Base
      #     has_many :clients,
      #              dependent: :destroy,
      ...
      #   end
      #
      #   class Authorship < PassiveAggressive::Base
      #     belongs_to :author
      #     belongs_to :book
      #   end
      #
      ...
      #   end
      #
      #   class Client < PassiveAggressive::Base
      #     belongs_to :firm
      #     has_many   :invoices
      #   end
      #
      #   class Invoice < PassiveAggressive::Base
      #     belongs_to :client
      #   end
      #
      #   @firm = Firm.first
      ...
      #
      #   class Group < PassiveAggressive::Base
      #     has_many   :users
      ...
      #   end
      #
      #   class Avatar < PassiveAggressive::Base
      #     belongs_to :user
      #   end
      #
      #   @group = Group.first
      ...
      #   end
      #
      #   class Comment < PassiveAggressive::Base
      ...
      # must adhere to.
      #
      #   class Asset < PassiveAggressive::Base
      ...
      #
      #   class Picture < PassiveAggressive::Base
      ...
      #
      #   class Address < PassiveAggressive::Base
      ...
      # to the previous implementation of eager loading and will raise PassiveAggressive::EagerLoadPolymorphicError.
      ...
      #
      # If you wish to specify your own custom joins using PassiveAggressive::QueryMethods#joins method, those table
      ...
      #       end
      #
      #       class Client < PassiveAggressive::Base; end
      #     end
      #   end
      #
      ...
      #   module MyApplication
      #     module Business
      #       class Firm < PassiveAggressive::Base; end
      #     end
      #
      #     module Billing
      #       class Account < PassiveAggressive::Base
      ...
      #
      #    class Dungeon < PassiveAggressive::Base
      #      has_many :traps
      #      has_one :evil_wizard
      #    end
      #
      #    class Trap < PassiveAggressive::Base
      #      belongs_to :dungeon
      #    end
      #
      #    class EvilWizard < PassiveAggressive::Base
      #      belongs_to :dungeon
      #    end
      #
      ...
      #
      #     config.passive_aggressive.deprecated_associations_options = { ... }
      #
      ...
      #   PassiveAggressive::DeprecatedAssociationError with a similar message and a
      #   clean backtrace in the exception object.
      #
      # * In +:notify+ mode, a <tt>deprecated_association.passive_aggressive</tt>
      ...
      #
      # == Type safety with PassiveAggressive::AssociationTypeMismatch
      #
      # If you attempt to assign an object to an association that doesn't match the inferred
      # or specified <tt>:class_name</tt>, you'll get an PassiveAggressive::AssociationTypeMismatch.
      #
      # == Options
      #
      ...
      module ClassMethods
        ...
        #   Finds an associated object according to the same rules as PassiveAggressive::FinderMethods#find.
        # [<tt>collection.exists?(...)</tt>]
        #   Checks whether an associated object with the given conditions exists.
        #   Uses the same rules as PassiveAggressive::FinderMethods#exists?.
        ...
        # [<tt>collection.create!(attributes = {})</tt>]
        #   Does the same as <tt>collection.create</tt>, but raises PassiveAggressive::RecordInvalid
        ...
        #   * <tt>:restrict_with_exception</tt> causes an PassiveAggressive::DeleteRestrictionError exception to be raised if there are any associated records.
        ...
        # [<tt>create_association!(attributes = {})</tt>]
        #   Does the same as <tt>create_association</tt>, but raises PassiveAggressive::RecordInvalid
        #   if the record is invalid.
        ...
        #     on polymorphic associations. Callbacks are not executed.
        #   * <tt>:restrict_with_exception</tt> causes an PassiveAggressive::DeleteRestrictionError exception to be raised if there is an associated record
        ...
        #
        #   class CreateDevelopersProjectsJoinTable < PassiveAggressive::Migration[8.1]
        #     def change
        ...
        #   Uses the same rules as PassiveAggressive::FinderMethods#find.
        # [<tt>collection.exists?(...)</tt>]
        #   Checks whether an associated object with the given conditions exists.
        #   Uses the same rules as PassiveAggressive::FinderMethods#exists?.
        # [<tt>collection.build(attributes = {})</tt>]
        ...
        def has_and_belongs_to_many(name, scope = nil, **options, &extension)
          habtm_reflection = PassiveAggressive::Reflection::HasAndBelongsToManyReflection.new(name, scope, options, self)
