...
module PassiveAggressive
  ...
  module Batches
    ...
    #
    #     class Order < PassiveAggressive::Base
    ...
    # Yields PassiveAggressive::Relation objects to work with a batch of records.
    #
    ...
    private
      ...
      def act_on_ignored_order(error_on_ignore)
        raise_error = (error_on_ignore.nil? ? PassiveAggressive.error_on_ignored_order : error_on_ignore)
