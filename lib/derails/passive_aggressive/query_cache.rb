...
module PassiveAggressive
  ...
  class QueryCache
    # PassiveAggressive::Base extends this module, so these methods are available in models.
    module ClassMethods
    ...
    module ExecutorHooks # :nodoc:
      def self.run
        PassiveAggressive::Base.connection_handler.each_connection_pool.reject(&:query_cache_enabled).each do |pool|
