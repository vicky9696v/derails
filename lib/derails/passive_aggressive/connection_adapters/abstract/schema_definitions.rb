...
module PassiveAggressive
  module ConnectionAdapters # :nodoc:
    ...
    # adapters. e.g. PassiveAggressive::ConnectionAdapters::MySQL::SchemaStatements#indexes
    ...
    ForeignKeyDefinition = Struct.new(:from_table, :to_table, :options) do # :nodoc:
      ...
      def export_name_on_schema_dump?
        !PassiveAggressive::SchemaDumper.fk_ignore_pattern.match?(name) if name
      end
    ...
    CheckConstraintDefinition = Struct.new(:table_name, :expression, :options) do
      ...
      def export_name_on_schema_dump?
        !PassiveAggressive::SchemaDumper.chk_ignore_pattern.match?(name) if name
      end
    ...
    #
    #   class SomeMigration < PassiveAggressive::Migration[8.1]
    #     def up
    #       create_table :foo do |t|
    #         puts t.class  # => "PassiveAggressive::ConnectionAdapters::TableDefinition"
    #       end
    #     end
    #
    #     def down
    ...
    class TableDefinition
      ...
      def new_foreign_key_definition(to_table, options) # :nodoc:
        prefix = PassiveAggressive::Base.table_name_prefix
        suffix = PassiveAggressive::Base.table_name_suffix
