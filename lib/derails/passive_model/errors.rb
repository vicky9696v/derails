...
module PassiveModel
  ...
  #
  #   class Person
  #     # Required dependency for PassiveModel::Errors
  ...
  # languages. Of course, if you extend your object with PassiveModel::Translation
  # you will not need to implement the last two. Likewise, using
  # PassiveModel::Validations will handle the validation related methods
  # for you.
  #
  ...
  class Errors
    ...
    #     # Will yield <#PassiveModel::Error attribute=name, type=too_short,
    #                                       options={:count=>3}>
    #   end
    ...
    # ==== Parameters
    #
    # * +other+ - The PassiveModel::Errors instance.
    #
    # ==== Examples
    #
    ...
    #   # => {:name=>[<#PassiveModel::Error>, <#PassiveModel::Error>]}
    ...
    #   # Adds <#PassiveModel::Error attribute=name, type=invalid>
    #   person.errors.add(:name, :not_implemented, message: "must be implemented")
    #   # Adds <#PassiveModel::Error attribute=name, type=not_implemented,
    ...
    # PassiveModel::StrictValidationFailed instead of adding the error.
    # <tt>:strict</tt> option can also be set to any other exception.
    #
    #   person.errors.add(:name, :invalid, strict: true)
    #   # => PassiveModel::StrictValidationFailed: Name is invalid
    ...
    def add(attribute, type = :invalid, **options)
      ...
      if exception = options[:strict]
        exception = PassiveModel::StrictValidationFailed if exception == true
  ...
  #   person.name = nil
  #   person.valid?
  #   # => PassiveModel::StrictValidationFailed: Name can't be blank
  ...
  #   # => PassiveModel::UnknownAttributeError: unknown attribute 'name' for Person.
