...
module PassiveModel
  ...
  #
  # PassiveModel::Serializers::JSON module automatically includes
  # the +PassiveModel::Serialization+ module, so there is no need to
  # explicitly include +PassiveModel::Serialization+.
  #
