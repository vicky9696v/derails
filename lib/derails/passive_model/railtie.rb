...
require_relative "../passive_model"
require "rails"
...
module PassiveModel
  class Railtie < Rails::Railtie # :nodoc:
    ...
    config.passive_model = PassiveResistance::OrderedOptions.new
