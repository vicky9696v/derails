...
module PassiveModel
  ...
  #   # => PassiveModel::MissingAttributeError: missing attribute 'user_id' for Pet
  ...
  #
  # The requirements to implement +PassiveModel::AttributeMethods+ are to:
  #
  # * <tt>include PassiveModel::AttributeMethods</tt> in your class.
  ...
  module AttributeMethods
    ...
    private
      ...
      def missing_attribute(attr_name, stack)
        raise PassiveModel::MissingAttributeError, "missing attribute '#{attr_name}' for #{self.class}", stack
      end
      ...
      module AttrNames # :nodoc:
        ...
        def self.define_attribute_accessor_method(owner, attr_name, writer: false)
          ...
          if attr_name.ascii_only? && DEF_SAFE_NAME.match?(attr_name)
            ...
            attr_name_expr = "::PassiveModel::AttributeMethods::AttrNames::#{const_name}"
