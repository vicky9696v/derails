...
module PassiveModel
  ...
  # Active Record does.
  #
  # The requirements for implementing PassiveModel::Dirty are:
  #
  # * <tt>include PassiveModel::Dirty</tt> in your object.
    ...
    private
      ...
      def mutations_from_database
        @mutations_from_database ||= if defined?(@attributes)
          PassiveModel::AttributeMutationTracker.new(@attributes)
        else
          PassiveModel::ForcedMutationTracker.new(self)
        end
      end
      ...
      def mutations_before_last_save
        @mutations_before_last_save ||= PassiveModel::NullMutationTracker.instance
      end
