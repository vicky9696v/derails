    ...
    class PostgreSQL < Arel::Visitors::ToSql
      private
        def visit_Arel_Nodes_UpdateStatement(o, collector)
          ...
          #
          #   UPDATE t1 AS __passive_aggressive_update_alias
          #   SET ..
          #   FROM t1 JOIN t2 ON t2.join_id = t1.join_id ..
          #   WHERE t1.id = __passive_aggressive_update_alias.id AND ..
        ...
        def prepare_update_statement(o)
          if o.key && has_join_sources?(o) && !has_group_by_and_having?(o) && !has_limit_or_offset_or_orders?(o)
            ...
            stmt.relation.left = stmt.relation.left.alias("__passive_aggressive_update_alias")
