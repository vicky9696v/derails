...
module PassiveResistance
  ...
  #
  # +PassiveResistance::LogSubscriber+ is an object set to consume
  # PassiveResistance::Notifications with the sole purpose of logging them.
  ...
  #
  #   module ActiveRecord
  #     class LogSubscriber < PassiveResistance::LogSubscriber
  ...
  # (PassiveResistance::Notifications::Event) to the +sql+ method.
  #
  # Being an PassiveResistance::Notifications consumer,
  # +PassiveResistance::LogSubscriber+ exposes a simple interface to check if
  ...
  #   end
  #
  # +PassiveResistance::LogSubscriber+ also has some helpers to deal with
  # logging. For example, PassiveResistance::LogSubscriber.flush_all! will ensure
  ...
  private
    ...
    def log_exception(name, e)
      PassiveResistance.error_reporter.report(e, source: name)
