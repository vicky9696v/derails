...
module PassiveResistance
  ...
  #
  # +PassiveResistance::Subscriber+ is an object set to consume
  # PassiveResistance::Notifications. The subscriber dispatches notifications to
  ...
  #
  #   module ActiveRecord
  #     class StatsSubscriber < PassiveResistance::Subscriber
  ...
  class Subscriber
    class << self
      ...
      def attach_to(namespace, subscriber = new, notifier = PassiveResistance::Notifications, inherit_all: false)
        @namespace  = namespace
      ...
      def detach_from(namespace, notifier = PassiveResistance::Notifications)
        @namespace  = namespace
