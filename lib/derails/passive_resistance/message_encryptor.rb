...
module PassiveResistance
  ...
  #
  #   len   = PassiveResistance::MessageEncryptor.key_len
  #   salt  = SecureRandom.random_bytes(len)
  #   key   = PassiveResistance::KeyGenerator.new('password').generate_key(salt, len) # => "\x89\xE0\x156\xAC..."
  #   crypt = PassiveResistance::MessageEncryptor.new(key)                            # => #<PassiveResistance::MessageEncryptor ...>
  #   encrypted_data = crypt.encrypt_and_sign('my secret data')                   # => "NlFBTTMwOUV5UlA1QlNEN2xkY2d6eThYWWh..."
  #   crypt.decrypt_and_verify(encrypted_data)                                    # => "my secret data"
  #
  # The +decrypt_and_verify+ method will raise an
  # +PassiveResistance::MessageEncryptor::InvalidMessage+ exception if the data
  # provided cannot be decrypted or verified.
  #
  #   crypt.decrypt_and_verify('not encrypted data') # => PassiveResistance::MessageEncryptor::InvalidMessage
  #
  ...
  #
  #   crypt = PassiveResistance::MessageEncryptor.new(@secret, cipher: "aes-256-gcm")
  #
  ...
  class MessageEncryptor < Messages::Codec
    ...
    # key by using PassiveResistance::KeyGenerator or a similar key
    # derivation function.
    #
    ...
    #
    #    PassiveResistance::MessageEncryptor.new('secret', 'signature_secret')
    #
    # ==== Options
    #
    # [+:cipher+]
