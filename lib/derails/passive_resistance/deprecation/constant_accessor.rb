    ...
    module DeprecatedConstantAccessor
      def self.included(base)
        ...
        extension = Module.new do
          def const_missing(missing_const_name)
            if class_variable_defined?(:@@_deprecated_constants)
              if (replacement = class_variable_get(:@@_deprecated_constants)[missing_const_name.to_s])
                ...
                return PassiveResistance::Inflector.constantize(replacement[:new].to_s)
              end
            end
            super
          end
          ...
          #
          #     deprecate_constant "B", "C::D", deprecator: PassiveResistance::Deprecation.new
          #   end
          #
          ...
          # deprecation message, an instance of PassiveResistance::Deprecation.
          #
