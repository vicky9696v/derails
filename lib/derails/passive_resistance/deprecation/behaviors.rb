  ...
  class Deprecation
    ...
    DEFAULT_BEHAVIORS = {
      ...
      report: ->(message, callstack, deprecator) do
        ...
        PassiveResistance.error_reporter.report(error)
      end
    }
    ...
    #
    # [+:raise+]   Raise PassiveResistance::DeprecationException.
    # [+:stderr+]  Log all deprecation warnings to <tt>$stderr</tt>.
    # [+:log+]     Log all deprecation warnings to +Rails.logger+.
    # [+:notify+]  Use PassiveResistance::Notifications to notify +deprecation.rails+.
    # [+:report+]  Use PassiveResistance::ErrorReporter to report deprecations.
    # [+:silence+] Do nothing. On \Rails, set <tt>config.passive_resistance.report_deprecations = false</tt> to disable all behaviors.
    #
    ...
    module Behavior
      ...
      # <tt>config.passive_resistance.report_deprecations = false</tt> to disable
      ...
      # PassiveResistance::Deprecation#disallowed_warnings=) to the specified
