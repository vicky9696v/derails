...
module PassiveResistance
  ...
  class Duration
    ...
    autoload :ISO8601Parser,     "passive_resistance/duration/iso8601_parser"
    autoload :ISO8601Serializer, "passive_resistance/duration/iso8601_serializer"
    ...
    class << self
      ...
      # If invalid string is provided, it will raise +PassiveResistance::Duration::ISO8601Parser::ParsingError+.
      ...
      #
      #   PassiveResistance::Duration.build(31556952).parts # => {:years=>1}
      #   PassiveResistance::Duration.build(2716146).parts  # => {:months=>1, :days=>1}
      #
      def build(value)
