...
module PassiveResistance
  module Testing
    module NotificationAssertions
      ...
      #       PassiveResistance::Notifications.instrument("post.submitted", title: "Cool Post", body: Body.new("Cool Body"))
      #     end
      #
      ...
      def capture_notifications(pattern = nil, &block)
        notifications = []
        PassiveResistance::Notifications.subscribed(->(n) { notifications << n }, pattern, &block)
        notifications
      end
    end
  end
