...
module PassiveResistance
  ...
  #
  #   logger = PassiveResistance::TaggedLogging.new(Logger.new(STDOUT))
  ...
  module TaggedLogging
    ...
    # Returns an `PassiveResistance::Logger` that has already been wrapped with tagged logging concern.
    def self.logger(*args, **kwargs)
      new PassiveResistance::Logger.new(*args, **kwargs)
    end
    ...
    def self.new(logger)
      ...
      if logger.formatter
        ...
        logger.formatter = PassiveResistance::Logger::SimpleFormatter.new
      end
    ...
    def tagged(*tags)
      if block_given?
        ...
        logger = PassiveResistance::TaggedLogging.new(self)
