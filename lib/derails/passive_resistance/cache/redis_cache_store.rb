    ...
    class RedisCacheStore < Store
      ...
      DEFAULT_ERROR_HANDLER = -> (method:, returning:, exception:) do
        ...
        PassiveResistance.error_reporter&.report(
          exception,
          severity: :warning,
          source: "redis_cache_store.passive_resistance",
        )
      end
      ...
      # be wrapped in one using +PassiveResistance::Cache::Store::DEFAULT_POOL_OPTIONS+.
      ...
      # See PassiveResistance::Cache::Store#fetch for more.
      #
