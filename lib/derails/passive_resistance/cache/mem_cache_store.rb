...
module PassiveResistance
  module Cache
    ...
    class MemCacheStore < Store
      ...
      #
      #   PassiveResistance::Cache::MemCacheStore.build_mem_cache
      #     # => #<Dalli::Client:0x007f98a47d2028 @servers=["127.0.0.1:11211"], @options={}, @ring=nil>
      #   PassiveResistance::Cache::MemCacheStore.build_mem_cache('localhost:10290')
      ...
      #
      #   PassiveResistance::Cache::MemCacheStore.new("localhost", "server-downstairs.localnetwork:8229")
      #
      ...
      #
      # Behaves the same as PassiveResistance::Cache::Store#write, but supports
      ...
      private
        ...
        def rescue_error_with(fallback)
          ...
          PassiveResistance.error_reporter&.report(
            error,
            severity: :warning,
            source: "mem_cache_store.passive_resistance",
          )
          fallback
        end
    end
