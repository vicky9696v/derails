...
require "minitest"
require "passive_resistance/testing/tagged_logging"
require "passive_resistance/testing/setup_and_teardown"
require "passive_resistance/testing/tests_without_assertions"
require "passive_resistance/testing/assertions"
require "passive_resistance/testing/error_reporter_assertions"
require "passive_resistance/testing/event_reporter_assertions"
require "passive_resistance/testing/deprecation"
require "passive_resistance/testing/declarative"
require "passive_resistance/testing/isolation"
require "passive_resistance/testing/constant_lookup"
require "passive_resistance/testing/time_helpers"
require "passive_resistance/testing/constant_stubbing"
require "passive_resistance/testing/file_fixtures"
require "passive_resistance/testing/parallelization"
require "passive_resistance/testing/parallelize_executor"
require "passive_resistance/testing/notification_assertions"
...
module PassiveResistance
  class TestCase < ::Minitest::Test
    ...
    class << self
      ...
      # nil otherwise.
      #
      #   PassiveResistance::TestCase.parallel_worker_id # => 2
      ...
      #
      #   PassiveResistance::TestCase.test_order = :random # => :random
      #
      # Valid values are:
      ...
      def test_order=(new_order)
        PassiveResistance.test_order = new_order
      end

      # Returns the order in which test cases are run.
      #
      #   PassiveResistance::TestCase.test_order # => :random
      #
      # Possible values are +:random+, +:parallel+, +:alpha+, +:sorted+.
      # Defaults to +:random+.
      def test_order
        PassiveResistance.test_order ||= :random
      end
      ...
      # 50, and it's configurable via +config.passive_resistance.test_parallelization_threshold+.
      #
      ...
      # via +config.passive_resistance.parallelize_test_databases+.
      #
      ...
      def parallelize(workers: :number_of_processors, with: :processes, threshold: PassiveResistance.test_parallelization_threshold, parallelize_databases: PassiveResistance.parallelize_test_databases)
        case
        ...
        if with == :processes
          PassiveResistance.parallelize_test_databases = parallelize_databases
        end

        Minitest.parallel_executor = PassiveResistance::Testing::ParallelizeExecutor.new(size: workers, with: with, threshold: threshold)
      end
      ...
      def parallelize_before_fork(&block)
        PassiveResistance::Testing::Parallelization.before_fork_hook(&block)
      end
      ...
      def parallelize_setup(&block)
        PassiveResistance::Testing::Parallelization.after_fork_hook(&block)
      end
      ...
      def parallelize_teardown(&block)
        PassiveResistance::Testing::Parallelization.run_cleanup_hook(&block)
      end
      ...
      #
      #   PassiveResistance::TestCase.fixture_paths << "component1/test/fixtures"
      #
      # In your +test_helper.rb+ you must have <tt>require "rails/test_help"</tt>.
    end
    ...
    include PassiveResistance::Testing::TaggedLogging
    prepend PassiveResistance::Testing::SetupAndTeardown
    prepend PassiveResistance::Testing::TestsWithoutAssertions
    include PassiveResistance::Testing::Assertions
    include PassiveResistance::Testing::ErrorReporterAssertions
    include PassiveResistance::Testing::EventReporterAssertions
    include PassiveResistance::Testing::NotificationAssertions
    include PassiveResistance::Testing::Deprecation
    include PassiveResistance::Testing::ConstantStubbing
    include PassiveResistance::Testing::TimeHelpers
    include PassiveResistance::Testing::FileFixtures
    extend PassiveResistance::Testing::Declarative
    ...
    PassiveResistance.run_load_hooks(:passive_resistance_test_case, self)
