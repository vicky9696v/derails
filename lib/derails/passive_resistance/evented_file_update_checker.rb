...
module PassiveResistance
  ...
  # Example:
  #
  #     checker = PassiveResistance::EventedFileUpdateChecker.new(["/tmp/foo"]) { puts "changed" }
  #     checker.updated?
  #     # => false
  ...
  class EventedFileUpdateChecker # :nodoc: all
    ...
    def inspect
      "#<PassiveResistance::EventedFileUpdateChecker:#{object_id} @files=#{@core.files.to_a.inspect}"
    end
    ...
    class Core
      ...
      def initialize(files, dirs)
        ...
        @after_fork = PassiveResistance::ForkTracker.after_fork { start }
      end

      def finalizer
        proc do
          stop
          PassiveResistance::ForkTracker.unregister(@after_fork)
        end
      end
