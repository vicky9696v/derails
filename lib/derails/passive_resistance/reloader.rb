...
module PassiveResistance
  ...
  class Reloader < ExecutionWrapper
    ...
    # Acquire the PassiveResistance::Dependencies::Interlock unload lock,
    # ensuring it will be released automatically
    def require_unload_lock!
      unless @locked
        PassiveResistance::Dependencies.interlock.start_unloading
        @locked = true
      end
    end
    ...
    def release_unload_lock!
      if @locked
        @locked = false
        PassiveResistance::Dependencies.interlock.done_unloading
      end
    end
