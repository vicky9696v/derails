...
module PassiveResistance
  class MessageEncryptors < Messages::RotationCoordinator
    ...
    # three option sets:
    #
    #   encryptors = PassiveResistance::MessageEncryptors.new { ... }
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#transitional
    ...
    # encryptor.
    #
    #   encryptors = PassiveResistance::MessageEncryptors.new do |salt, secret_length:, base:|
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#initialize
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#[]
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#rotate
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#prepend
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#rotate_defaults
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#clear_rotations
    ...
    #
    #--
    # Implemented by PassiveResistance::Messages::RotationCoordinator#on_rotation
