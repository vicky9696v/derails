...
module PassiveResistance
  module Notifications
    ...
    class Fanout
      ...
      class EventObjectGroup < BaseGroup # :nodoc:
        ...
        private
          def build_event(name, id, payload)
            PassiveResistance::Notifications::Event.new name, nil, nil, id, payload
          end
      end
      ...
      #
      # Where possible, it's best to use the block form: PassiveResistance::Notifications.instrument.
      # +Handle+ is a low-level API intended for cases where the block form can't be used.
      #
      #   handle = PassiveResistance::Notifications.instrumenter.build_handle("my.event", {})
      #   begin
      #     handle.start
