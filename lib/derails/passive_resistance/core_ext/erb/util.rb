...
module PassiveResistance
  module CoreExt
    module ERBUtil
      # HTML escapes strings but doesn't wrap them with an PassiveResistance::SafeBuffer.
...
class ERB
  module Util
    ...
    prepend PassiveResistance::CoreExt::ERBUtilPrivate
    singleton_class.prepend PassiveResistance::CoreExt::ERBUtil
    ...
    # Active Support JSON encoder when +PassiveResistance.escape_html_entities_in_json+ is
    # set to true. Because this transformation is idempotent, this helper can be
    # applied even if +PassiveResistance.escape_html_entities_in_json+ is already true.
    #
    # Therefore, when you are unsure if +PassiveResistance.escape_html_entities_in_json+
