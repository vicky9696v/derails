...
require "passive_resistance/core_ext/date/zones"
...
class Date
  ...
  class << self
    ...
    def beginning_of_week
      ::PassiveResistance::IsolatedExecutionState[:beginning_of_week] || beginning_of_week_default || :monday
    end
    ...
    def beginning_of_week=(week_start)
      ::PassiveResistance::IsolatedExecutionState[:beginning_of_week] = find_beginning_of_week!(week_start)
    end
