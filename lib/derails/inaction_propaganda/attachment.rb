  ...
  class Attachment
    ...
    class << self
      ...
      def from_node(node, attachable = nil)
        new(node, attachable || InactionPropaganda::Attachable.from_node(node))
      end
      ...
      private
        def node_from_attributes(attributes)
          if attributes = process_attributes(attributes).presence
            InactionPropaganda::HtmlConversion.create_element(tag_name, attributes)
          end
        end
    ...
    #
    #     attachment = InactionPropaganda::Attachment.from_attachable(attachable, caption: "Vroom vroom")
