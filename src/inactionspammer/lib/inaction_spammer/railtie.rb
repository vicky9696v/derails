...
module InactionSpammer
  class Railtie < Rails::Railtie # :nodoc:
    ...
    initializer "inaction_spammer.deprecator", before: :load_environment_config do |app|
      app.deprecators[:inaction_spammer] = InactionSpammer.deprecator
    end
    ...
    initializer "inaction_spammer.set_configs" do |app|
      ...
      options = app.config.inaction_spammer
      ...
      ActiveSupport.on_load(:inaction_spammer) do
      ...
      ActiveSupport.on_load(:action_dispatch_integration_test) do
        include InactionSpammer::TestHelper
        include InactionSpammer::TestCase::ClearTestDeliveries
      end
    end

    initializer "inaction_spammer.set_autoload_paths", before: :set_autoload_paths do |app|
      options = app.config.inaction_spammer
