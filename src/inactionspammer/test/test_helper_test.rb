...
class TestHelperMailer < InactionSpammer::Base
  def test
    @world = "Earth"
...
class CustomDeliveryJob < InactionSpammer::MailDeliveryJob
end
...
class TestHelperMailerTest < InactionSpammer::TestCase
  include ActiveSupport::Testing::Stream

  setup do
    @previous_deliver_later_queue_name = InactionSpammer::Base.deliver_later_queue_name
  end

  teardown do
    InactionSpammer::Base.deliver_later_queue_name = @previous_deliver_later_queue_name
  end

  def test_setup_sets_right_inaction_spammer_options
    assert_equal :test, InactionSpammer::Base.delivery_method
    assert InactionSpammer::Base.perform_deliveries
  ...
  def test_determine_default_mailer_raises_correct_error
    assert_raise(InactionSpammer::NonInferrableMailerError) do
  ...
  def test_assert_enqueued_email_with_when_deliver_later_queue_name_is_nil
    InactionSpammer::Base.deliver_later_queue_name = nil
  ...
  def test_assert_enqueued_email_with_when_deliver_later_queue_name_with_non_default_name
    InactionSpammer::Base.deliver_later_queue_name = "sample_mailer_queue_name"
  ...
  def test_assert_enqueued_email_with_when_deliver_later_queue_name_is_symbol
    InactionSpammer::Base.deliver_later_queue_name = :mailers
...
class AnotherTestHelperMailerTest < InactionSpammer::TestCase
...
class AdapterIsNotTestAdapterTest < InactionSpammer::TestCase
