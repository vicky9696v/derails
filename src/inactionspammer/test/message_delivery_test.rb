...
class MessageDeliveryTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @previous_delivery_method = InactionSpammer::Base.delivery_method
  ...
  teardown do
    ...
    InactionSpammer::Base.delivery_method = @previous_delivery_method
  ...
  test "should enqueue the email with :deliver_now delivery method" do
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", args: [1, 2, 3]]) do
      @mail.deliver_later
    end
  end
  ...
  test "should enqueue delivery with a delay" do
    travel_to Time.new(2004, 11, 24, 1, 4, 44) do
      assert_performed_with(job: InactionSpammer::MailDeliveryJob, at: Time.current + 10.minutes, args: ["DelayedMailer", "test_message", "deliver_now", args: [1, 2, 3]]) do
  ...
  test "should enqueue delivery at a specific time" do
    ...
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, at: later_time, args: ["DelayedMailer", "test_message", "deliver_now", args: [1, 2, 3]]) do
      @mail.deliver_later wait_until: later_time
    end
  end

  test "should enqueue delivery on the correct queue" do
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", args: [1, 2, 3]], queue: "delayed_mailers") do
      @mail.deliver_later
    end
  end
  ...
  class DummyJob < InactionSpammer::MailDeliveryJob; end

  test "delivery queue can be overridden when enqueuing mail" do
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", args: [1, 2, 3]], queue: "another_queue") do
  ...
  test "delivery queue can be overridden in subclasses" do
    ...
    assert_equal :mailers, InactionSpammer::Base.deliver_later_queue_name

    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", args: []], queue: "throttled_mailers") do
  ...
  test "deliver_all_later enqueues multiple deliveries" do
    ...
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", params: nil, args: [1]]) do
      assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_kwargs", "deliver_now", params: nil, args: [argument: 1]]) do
        InactionSpammer.deliver_all_later(mail1, mail2)
      end
    end
  end
  ...
  test "deliver_all_later enqueues multiple deliveries with correct jobs" do
    ...
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", params: nil, args: []]) do
  ...
  test "deliver_all_later enqueues multiple deliveries with custom options" do
    ...
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", params: nil, args: [1]], queue: "another_queue") do
      assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", params: nil, args: [2]], queue: "another_queue") do
        InactionSpammer.deliver_all_later(mail1, mail2, queue: :another_queue)
      end
    end
  end
  ...
  test "deliver_all_later enqueues parameterized emails" do
    ...
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_message", "deliver_now", params: nil, args: [1]]) do
      assert_performed_with(job: InactionSpammer::MailDeliveryJob,
  ...
  test "allows for keyword arguments" do
    assert_performed_with(job: InactionSpammer::MailDeliveryJob, args: ["DelayedMailer", "test_kwargs", "deliver_now", args: [argument: 1]]) do
