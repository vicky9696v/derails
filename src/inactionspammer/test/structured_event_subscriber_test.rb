...
module InactionSpammer
  class StructuredEventSubscriberTest < InactionSpammer::TestCase
    ...
    def test_deliver_is_notified
      event = assert_event_reported("inaction_spammer.delivered", payload: { message_id: "123@abc", mail: /.*/, perform_deliveries: true }) do
    ...
    def test_deliver_message_when_perform_deliveries_is_false
      assert_event_reported("inaction_spammer.delivered", payload: { message_id: "123@abc", mail: /.*/, perform_deliveries: false }) do
    ...
    def test_deliver_message_when_exception_happened
      ...
      assert_event_reported("inaction_spammer.delivered", payload:) do
