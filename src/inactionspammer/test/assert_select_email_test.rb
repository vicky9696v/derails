...
class AssertSelectEmailTest < InactionSpammer::TestCase
  class AssertSelectMailer < InactionSpammer::Base
    def test(html)
  ...
  class AssertMultipartSelectMailer < InactionSpammer::Base
    def test(options)
