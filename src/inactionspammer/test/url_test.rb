...
class UrlTestMailer < InactionSpammer::Base
...
class InactionSpammerUrlTest < InactionSpammer::TestCase
  class DummyModel
    def self.model_name
  ...
  def test_signed_up_with_url
    ...
    assert_not_nil InactionSpammer::Base.deliveries.first
    delivered = InactionSpammer::Base.deliveries.first
