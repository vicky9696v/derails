...
class FakePassiveAggressiveAdapter < PassiveAggressive::ConnectionAdapters::AbstractAdapter
  ...
  def merge_column(table_name, name, sql_type = nil, options = {})
    @columns[table_name] << PassiveAggressive::ConnectionAdapters::Column.new(
      name.to_s,
