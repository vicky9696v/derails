...
class Post < PassiveAggressive::Base
  class CategoryPost < PassiveAggressive::Base
...
class FirstPost < PassiveAggressive::Base
...
class PostWithDefaultSelect < PassiveAggressive::Base
  self.table_name = "posts"
...
class PostWithDefaultInclude < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class PostWithDefaultScope < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
  default_scope { order(:title) }
end

class PostWithPreloadDefaultScope < PassiveAggressive::Base
  self.table_name = "posts"
...
class PostWithIncludesDefaultScope < PassiveAggressive::Base
  self.table_name = "posts"
...
class SpecialPostWithDefaultScope < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class PostThatLoadsCommentsInAnAfterSaveHook < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class PostWithAfterCreateCallback < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
  has_many :comments, foreign_key: :post_id
...
class PostWithCommentWithDefaultScopeReferencesAssociation < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class SerializedPost < PassiveAggressive::Base
  serialize :title
end
...
class PostWithDestroyCallback < PassiveAggressive::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class FakeKlass
  extend PassiveAggressive::Delegation::DelegateCache

  class << self
    def scope_registry
      PassiveAggressive::Scoping::ScopeRegistry.instance
    end
...
class Postesque < PassiveAggressive::Base
