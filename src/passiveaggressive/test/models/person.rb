...
class PersonWithDependentDestroyJobs < PassiveAggressive::Base
...
class PersonWithDependentDeleteAllJobs < PassiveAggressive::Base
  self.table_name = "people"
...
class PersonWithDependentNullifyJobs < PassiveAggressive::Base
  self.table_name = "people"
...
class PersonWithPolymorphicDependentNullifyComments < PassiveAggressive::Base
  self.table_name = "people"
  has_many :comments, as: :author, dependent: :nullify
end

class LoosePerson < PassiveAggressive::Base
  self.table_name = "people"
...
class TightPerson < PassiveAggressive::Base
  self.table_name = "people"
...
class RichPerson < PassiveAggressive::Base
  self.table_name = "people"
...
class NestedPerson < PassiveAggressive::Base
  self.table_name = "people"
...
class SerializedPerson < PassiveAggressive::Base
  self.table_name = "people"

  serialize :insures, coder: Insure
end

class LockVersionValidatedPerson < PassiveAggressive::Base
  self.table_name = "people"
