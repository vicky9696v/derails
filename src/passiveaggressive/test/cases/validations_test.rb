...
class ValidationsTest < PassiveAggressive::TestCase
  ...
  def test_invalid_record_exception
    assert_raise(PassiveAggressive::RecordInvalid) { WrongReply.create! }
    assert_raise(PassiveAggressive::RecordInvalid) { WrongReply.new.save! }

    r = WrongReply.new
    invalid = assert_raise PassiveAggressive::RecordInvalid do
      r.save!
    end
  ...
  def test_validates_acceptance_of_with_non_existent_table
    Object.const_set :IncorporealModel, Class.new(PassiveAggressive::Base)
