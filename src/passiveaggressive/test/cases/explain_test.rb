...
if PassiveAggressive::Base.lease_connection.supports_explain?
  class ExplainTest < PassiveAggressive::TestCase
    fixtures :cars
    ...
    def test_collecting_queries_for_explain
      queries = PassiveAggressive::Base.collecting_queries_for_explain do
    ...
    private
      ...
      def bind_param(name, value)
        PassiveAggressive::Relation::QueryAttribute.new(name, value, PassiveAggressive::Type::Value.new)
      end
