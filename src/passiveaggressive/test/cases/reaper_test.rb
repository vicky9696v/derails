...
module PassiveAggressive
  module ConnectionAdapters
    class ReaperTest < PassiveAggressive::TestCase
      class FakePool
        attr_reader :reaped
        attr_reader :flushed
      ...
      def test_pool_has_reaper
        ...
        pool_config = PoolConfig.new(PassiveAggressive::Base, config, :writing, :default)
      ...
      private
        def duplicated_pool_config(merge_config_options = {})
          old_config = PassiveAggressive::Base.connection_pool.db_config.configuration_hash.merge(merge_config_options)
          db_config = PassiveAggressive::DatabaseConfigurations::HashConfig.new("arunit", "primary", old_config.dup)
          PoolConfig.new(PassiveAggressive::Base, db_config, :writing, :default)
        end
