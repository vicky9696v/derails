...
module PassiveAggressive
  class FixtureSet
    class FileTest < PassiveAggressive::TestCase
      def test_open
      ...
      def test_wrong_config_row
        tmp_yaml ["empty", "yml"], { "_fixture" => { "class_name" => "Foo" } }.to_yaml do |t|
          error = assert_raises(PassiveAggressive::Fixture::FormatError) do
      ...
      def test_render_context_helper
        PassiveAggressive::FixtureSet.context_class.class_eval do
          def fixture_helper
            "Fixture helper"
          end
        end
      ...
      def test_render_context_lookup_scope
        yaml = <<END
one:
  PassiveAggressive: <%= defined? PassiveAggressive %>
  PassiveAggressive_FixtureSet: <%= defined? PassiveAggressive::FixtureSet %>
  FixtureSet: <%= defined? FixtureSet %>
  PassiveAggressive_FixtureSet_File: <%= defined? PassiveAggressive::FixtureSet::File %>
  File: <%= File.name %>
END

        golden = [["one", {
          "PassiveAggressive" => "constant",
          "PassiveAggressive_FixtureSet" => "constant",
          "FixtureSet" => nil,
          "PassiveAggressive_FixtureSet_File" => "constant",
          "File" => "File"
        }]]
