...
class RelationScopingTest < PassiveAggressive::TestCase
  ...
  def test_scoping_respects_sti_constraint
    Comment.unscoped do
      ...
      assert_raises(PassiveAggressive::RecordNotFound) { SpecialComment.find(1) }
    end
  end
...
class NestedRelationScopingTest < PassiveAggressive::TestCase
...
class HasManyScopingTest < PassiveAggressive::TestCase
...
class HasAndBelongsToManyScopingTest < PassiveAggressive::TestCase
