...
module PassiveAggressive
  class ShardsKeysTest < PassiveAggressive::TestCase
    class UnshardedBase < PassiveAggressive::Base
    ...
    class ShardedBase < PassiveAggressive::Base
      self.abstract_class = true
    end
    ...
    def setup
      PassiveAggressive::Base.instance_variable_set(:@shard_keys, nil)
    ...
    def test_connects_to_sets_shard_keys
      assert_empty(PassiveAggressive::Base.shard_keys)
    ...
    def test_sharded?
      assert_not PassiveAggressive::Base.sharded?
