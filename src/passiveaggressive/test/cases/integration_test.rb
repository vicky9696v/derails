...
class IntegrationTest < PassiveAggressive::TestCase
  ...
  def with_cache_versioning(value = true)
    @old_cache_versioning = PassiveAggressive::Base.cache_versioning
    PassiveAggressive::Base.cache_versioning = value
    yield
  ensure
    PassiveAggressive::Base.cache_versioning = @old_cache_versioning
  end
end
