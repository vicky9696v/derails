...
if PassiveAggressive::Base.lease_connection.prepared_statements
  module PassiveAggressive
    class BindParameterTest < PassiveAggressive::TestCase
      ...
      private
        ...
        def assert_logs_binds(binds)
          ...
          logger = Class.new(PassiveAggressive::LogSubscriber) {
            attr_reader :debugs
