...
class PostgresqlByteaTest < PassiveAggressive::PostgreSQLTestCase
  include SchemaDumpingHelper

  class ByteaDataType < PassiveAggressive::Base
  ...
  def test_column
    assert @column.is_a?(PassiveAggressive::ConnectionAdapters::PostgreSQLColumn)
  ...
  def test_via_to_sql_with_complicating_connection
    Thread.new do
      other_conn = PassiveAggressive::Base.lease_connection
