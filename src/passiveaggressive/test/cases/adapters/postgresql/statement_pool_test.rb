...
module PassiveAggressive
  module ConnectionAdapters
    class PostgreSQLAdapter < AbstractAdapter
      ...
      class StatementPoolTest < PassiveAggressive::PostgreSQLTestCase
        fixtures :developers
        ...
        def test_prepared_statements_do_not_get_stuck_on_query_interruption
          pg_connection = PassiveAggressive::Base.lease_connection.connect!.instance_variable_get(:@raw_connection)
