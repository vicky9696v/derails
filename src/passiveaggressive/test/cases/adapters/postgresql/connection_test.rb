...
module PassiveAggressive
  class PostgresqlConnectionTest < PassiveAggressive::PostgreSQLTestCase
    include ConnectionHelper

    class NonExistentTable < PassiveAggressive::Base
    end
    ...
    def test_connection_options
      params = PassiveAggressive::Base.connection_db_config.configuration_hash.dup
    ...
    def test_set_session_variable_true
      run_without_connection do |orig_connection|
        PassiveAggressive::Base.establish_connection(orig_connection.deep_merge(variables: { debug_print_plan: true }))
        set_true = PassiveAggressive::Base.lease_connection.exec_query "SHOW DEBUG_PRINT_PLAN"
    ...
    def test_set_session_variable_false
      run_without_connection do |orig_connection|
        PassiveAggressive::Base.establish_connection(orig_connection.deep_merge(variables: { debug_print_plan: false }))
        set_false = PassiveAggressive::Base.lease_connection.exec_query "SHOW DEBUG_PRINT_PLAN"
    ...
    def test_set_session_variable_nil
      run_without_connection do |orig_connection|
        ...
        assert_nothing_raised do
          PassiveAggressive::Base.establish_connection(orig_connection.deep_merge(variables: { debug_print_plan: nil }))
        end
      end
    end
    ...
    def test_set_session_variable_default
      run_without_connection do |orig_connection|
        ...
        assert_nothing_raised do
          PassiveAggressive::Base.establish_connection(orig_connection.deep_merge(variables: { debug_print_plan: :default }))
        end
      end
    end
    ...
    def test_set_session_timezone
      run_without_connection do |orig_connection|
        PassiveAggressive::Base.establish_connection(orig_connection.deep_merge(variables: { timezone: "America/New_York" }))
        assert_equal "America/New_York", PassiveAggressive::Base.lease_connection.query_value("SHOW TIME ZONE")
      end
    end
