...
if PassiveAggressive::Base.lease_connection.supports_foreign_tables?
  class ForeignTableTest < PassiveAggressive::TestCase
    self.use_transactional_tests = false

    class ForeignProfessor < PassiveAggressive::Base
    ...
    def test_table_exists
      ...
      assert_not PassiveAggressive::Base.lease_connection.table_exists?(table_name)
    end
