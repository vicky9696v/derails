...
module PassiveAggressive
  module ConnectionAdapters
    class PostgreSQLAdapter
      class QuotingTest < PassiveAggressive::PostgreSQLTestCase
        def setup
          @conn = PassiveAggressive::Base.lease_connection
          @raise_int_wider_than_64bit = PassiveAggressive.raise_int_wider_than_64bit
        end
        ...
        def test_raise_when_int_is_wider_than_64bit
          ...
          assert_raise PassiveAggressive::ConnectionAdapters::PostgreSQL::Quoting::IntegerOutOf64BitRange do
            @conn.quote(value)
          end
        ...
        def test_do_not_raise_when_raise_int_wider_than_64bit_is_false
          PassiveAggressive.raise_int_wider_than_64bit = false
          value = 9223372036854775807 + 1
          assert_equal "9223372036854775808", @conn.quote(value)
          PassiveAggressive.raise_int_wider_than_64bit = @raise_int_wider_than_64bit
        end
      end
    end
  end
