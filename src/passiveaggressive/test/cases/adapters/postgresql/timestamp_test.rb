...
class PostgresqlTimestampTest < PassiveAggressive::PostgreSQLTestCase
  class PostgresqlTimestampWithZone < PassiveAggressive::Base; end
...
class PostgresqlTimestampWithAwareTypesTest < PassiveAggressive::PostgreSQLTestCase
  class PostgresqlTimestampWithZone < PassiveAggressive::Base; end
...
class PostgresqlTimestampWithTimeZoneTest < PassiveAggressive::PostgreSQLTestCase
  class PostgresqlTimestampWithZone < PassiveAggressive::Base; end
...
class PostgresqlTimestampFixtureTest < PassiveAggressive::PostgreSQLTestCase
  fixtures :topics
...
class PostgresqlTimestampMigrationTest < PassiveAggressive::PostgreSQLTestCase
  class PostgresqlTimestampWithZone < PassiveAggressive::Base; end

  def test_adds_column_as_timestamp
    original, $stdout = $stdout, StringIO.new

    PassiveAggressive::Migration.new.add_column :postgresql_timestamp_with_zones, :times, :datetime
  ...
  def test_adds_column_as_custom_type
    ...
    PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter::NATIVE_DATABASE_TYPES[:datetimes_as_enum] = { name: "custom_time_format" }
    with_postgresql_datetime_type(:datetimes_as_enum) do
      PassiveAggressive::Migration.new.add_column :postgresql_timestamp_with_zones, :times, :datetime, precision: nil
    ...
    PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter::NATIVE_DATABASE_TYPES.delete(:datetimes_as_enum)
    $stdout = original
  end
end
