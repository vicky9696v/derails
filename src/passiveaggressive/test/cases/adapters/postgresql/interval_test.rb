...
class PostgresqlIntervalTest < PassiveAggressive::PostgreSQLTestCase
  include SchemaDumpingHelper

  class IntervalDataType < PassiveAggressive::Base
  ...
  def setup
    ...
    assert(@column_max.is_a?(PassiveAggressive::ConnectionAdapters::PostgreSQLColumn))
    assert(@column_min.is_a?(PassiveAggressive::ConnectionAdapters::PostgreSQLColumn))
