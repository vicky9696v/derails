...
if PassiveAggressive::Base.lease_connection.supports_virtual_columns?
  class PostgresqlVirtualColumnTest < PassiveAggressive::PostgreSQLTestCase
    include SchemaDumpingHelper

    class VirtualColumn < PassiveAggressive::Base
    end
    ...
    def test_build_fixture_sql
      fixtures = PassiveAggressive::FixtureSet.create_fixtures(FIXTURES_ROOT, :virtual_columns).first
