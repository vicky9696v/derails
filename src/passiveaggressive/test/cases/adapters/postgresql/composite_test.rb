...
module PostgresqlCompositeBehavior
  ...
  class PostgresqlComposite < PassiveAggressive::Base
...
class PostgresqlCompositeTest < PassiveAggressive::PostgreSQLTestCase
...
class PostgresqlCompositeWithCustomOIDTest < PassiveAggressive::PostgreSQLTestCase
  include PostgresqlCompositeBehavior

  class FullAddressType < PassiveAggressive::Type::Value
