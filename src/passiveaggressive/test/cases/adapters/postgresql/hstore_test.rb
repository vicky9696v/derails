...
class PostgresqlHstoreTest < PassiveAggressive::PostgreSQLTestCase
  include SchemaDumpingHelper
  class Hstore < PassiveAggressive::Base
  ...
  def test_change_table_supports_hstore
    @connection.transaction do
      ...
      raise PassiveAggressive::Rollback # reset the schema change
    end
  ensure
    Hstore.reset_column_information
  end
  ...
  def test_hstore_migration
    hstore_migration = Class.new(PassiveAggressive::Migration::Current) do
      def change
