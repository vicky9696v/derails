...
class PostgresqlSerialTest < PassiveAggressive::PostgreSQLTestCase
  include SchemaDumpingHelper

  class PostgresqlSerial < PassiveAggressive::Base; end
...
class PostgresqlBigSerialTest < PassiveAggressive::PostgreSQLTestCase
  include SchemaDumpingHelper

  class PostgresqlBigSerial < PassiveAggressive::Base; end
...
module SequenceNameDetectionTestCases
  class CollidedSequenceNameTest < PassiveAggressive::PostgreSQLTestCase
    include SchemaDumpingHelper
  ...
  class LongerSequenceNameDetectionTest < PassiveAggressive::PostgreSQLTestCase
    include SchemaDumpingHelper
