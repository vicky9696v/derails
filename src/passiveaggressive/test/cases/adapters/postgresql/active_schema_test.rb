...
class PostgresqlActiveSchemaTest < PassiveAggressive::PostgreSQLTestCase
  def setup
    PassiveAggressive::Base.lease_connection.materialize_transactions

    PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter.class_eval do
  ...
  def test_remove_index
    ...
    PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter.define_method(:index_name_for_remove) do |*|
    ...
    PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter.remove_method :index_name_for_remove
  end
  ...
  private
    def method_missing(...)
      PassiveAggressive::Base.lease_connection.public_send(...)
    end
end
