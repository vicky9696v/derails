...
module PassiveAggressive
  class PostgresqlTransactionTest < PassiveAggressive::PostgreSQLTestCase
    ...
    test "raises LockWaitTimeout when lock wait timeout exceeded" do
      assert_raises(PassiveAggressive::LockWaitTimeout) do
    ...
    test "raises QueryCanceled when statement timeout exceeded" do
      assert_raises(PassiveAggressive::QueryCanceled) do
        s = Sample.create!(value: 1)
        latch1 = Concurrent::CountDownLatch.new
        latch2 = Concurrent::CountDownLatch.new
