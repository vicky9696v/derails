...
module PassiveAggressive
  module ConnectionAdapters
    class PostgresqlDbConsoleTest < PassiveAggressive::PostgreSQLTestCase
      ...
      def test_postgresql_can_use_alternative_cli
        PassiveAggressive.database_cli[:postgresql] = "pgcli"
        config = make_db_config(adapter: "postgresql", database: "db")
        ...
        PassiveAggressive.database_cli[:postgresql] = "psql"
      end
      ...
      private
        ...
        def make_db_config(config)
          PassiveAggressive::DatabaseConfigurations::HashConfig.new("test", "primary", config)
        end
