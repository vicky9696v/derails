...
class PostgreSQLUtilsTest < PassiveAggressive::PostgreSQLTestCase
  Name = PassiveAggressive::ConnectionAdapters::PostgreSQL::Name
  include PassiveAggressive::ConnectionAdapters::PostgreSQL::Utils
...
class PostgreSQLNameTest < PassiveAggressive::PostgreSQLTestCase
  Name = PassiveAggressive::ConnectionAdapters::PostgreSQL::Name
