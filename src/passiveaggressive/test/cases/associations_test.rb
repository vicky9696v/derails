...
class AssociationsTest < PassiveAggressive::TestCase
  ...
  def test_bad_collection_keys
    assert_raise(ArgumentError, "PassiveAggressive should have barked on bad collection keys") do
      Class.new(PassiveAggressive::Base).has_many(:wheels, name: "wheels")
    end
  end
  ...
  def test_using_query_constraints_warns_about_changing_behavior
    ...
    assert_raises(PassiveAggressive::ConfigurationError, match: has_many_expected_message) do
    ...
    assert_raises(PassiveAggressive::ConfigurationError, match: belongs_to_expected_message) do
...
class AssociationProxyTest < PassiveAggressive::TestCase
  ...
  test "getting a scope from an association" do
    ...
    assert david.projects.scope.is_a?(PassiveAggressive::Relation)
...
class OverridingAssociationsTest < PassiveAggressive::TestCase
  class DifferentPerson < PassiveAggressive::Base; end

  class PeopleList < PassiveAggressive::Base
  ...
  class ModelAssociatedToClassesThatDoNotExist < PassiveAggressive::Base
...
class PreloaderTest < PassiveAggressive::TestCase
  ...
  def test_preload_with_scope
    ...
    preloader = PassiveAggressive::Associations::Preloader.new(records: [post], associations: :comments, scope: Comment.where(body: "Thank you for the welcome"))
    preloader.call
  ...
  def test_preload_makes_correct_number_of_queries_on_array
    ...
    assert_queries_count(1) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [post], associations: :comments)
      preloader.call
    end
  end
  ...
  def test_preload_makes_correct_number_of_queries_on_relation
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: relation, associations: :comments)
      preloader.call
    end
  end
  ...
  def test_preload_does_not_concatenate_duplicate_records
    ...
    PassiveAggressive::Associations::Preloader.new(records: [post], associations: :comments).call
  ...
  def test_preload_for_hmt_with_conditions
    ...
    preloader = PassiveAggressive::Associations::Preloader.new(records: [post], associations: :hmt_special_categories)
    preloader.call
  ...
  def test_preload_groups_queries_with_same_scope
    ...
    assert_queries_count(1) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [book, post], associations: :author)
      preloader.call
    end
  ...
  def test_preload_grouped_queries_with_already_loaded_records
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: [book, post], associations: :author).call
      book.author
      post.author
    end
  end
  ...
  def test_preload_grouped_queries_of_middle_records
    ...
    assert_queries_count(2) do
      PassiveAggressive::Associations::Preloader.new(records: comments, associations: [:author, :ordinary_post]).call
    end
  end
  ...
  def test_preload_grouped_queries_of_through_records
    ...
    assert_queries_count(3) do
      PassiveAggressive::Associations::Preloader.new(records: [author], associations: [:hello_post_comments, :comments]).call
    end
  end
  ...
  def test_preload_through_records_with_already_loaded_middle_record
    ...
    assert_queries_count(1) do
      PassiveAggressive::Associations::Preloader.new(records: [member], associations: :organization_member_details_2).call
    end
  ...
  def test_preload_with_instance_dependent_scope
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [david, david2, bob], associations: :posts_mentioning_author)
      preloader.call
    end
  ...
  def test_preload_with_instance_dependent_through_scope
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [david, david2, bob], associations: :comments_mentioning_author)
      preloader.call
    end
  ...
  def test_preload_with_through_instance_dependent_scope
    ...
    assert_queries_count(3) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [david, david2, bob], associations: :comments_on_posts_mentioning_author)
      preloader.call
    end
  ...
  def test_some_already_loaded_associations
    ...
    assert_queries_count(5) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [invoice], associations: [
  ...
  def test_preload_through
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: comments, associations: [:author, :post])
      preloader.call
    end
  ...
  def test_preload_with_grouping_sets_inverse_association
    ...
    assert_queries_count(1) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: favorites, associations: [:author, :favorite_author])
      preloader.call
    end
  ...
  def test_preload_can_group_separate_levels
    ...
    assert_queries_count(3) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [mary], associations: [:posts, favorite_authors: :posts])
      preloader.call
    end
  ...
  def test_preload_can_group_multi_level_ping_pong_through
    ...
    assert_queries_count(9) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [mary], associations: associations)
      preloader.call
    end
  ...
  def test_preload_does_not_group_same_class_different_scope
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [post, postesque], associations: :author_with_the_letter_a)
      preloader.call
    end
    ...
    assert_queries_count(3) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [post, postesque], associations: :author_with_address)
      preloader.call
    end
  ...
  def test_preload_does_not_group_same_scope_different_key_name
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [post, postesque], associations: :author)
      preloader.call
    end
  ...
  def test_multi_database_polymorphic_preload_with_same_table_name
    ...
    assert_queries_count(2) do
      preloader = PassiveAggressive::Associations::Preloader.new(records: [dog_comment, other_dog_comment], associations: :origin)
      preloader.call
    end
  end
  ...
  def test_preload_with_available_records
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: [post], associations: :author, available_records: [[david]]).call
  ...
  def test_preload_with_available_records_sti
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: [book], associations: :essay, available_records: [[essay_special]]).call
    end
  ...
  def test_preload_with_only_some_records_available
    ...
    assert_queries_count(1) do
      PassiveAggressive::Associations::Preloader.new(records: [bob_post, mary_post], associations: :author, available_records: [bob]).call
    end
  ...
  def test_preload_with_some_records_already_loaded
    ...
    assert_queries_count(1) do
      PassiveAggressive::Associations::Preloader.new(records: [bob_post, mary_post], associations: :author).call
    end
  ...
  def test_preload_with_available_records_with_through_association
    ...
    assert_queries_count(1) do
      ...
      PassiveAggressive::Associations::Preloader.new(records: [author], associations: :essay_category, available_records: categories).call
    end
  ...
  def test_preload_with_only_some_records_available_with_through_associations
    ...
    assert_queries_count(2) do
      PassiveAggressive::Associations::Preloader.new(records: [mary, dave], associations: :essay_category, available_records: [mary_category]).call
    end
  ...
  def test_preload_with_available_records_with_multiple_classes
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: [essay], associations: [:category, :author], available_records: [general, david]).call
  ...
  def test_preload_with_available_records_queries_when_scoped
    ...
    assert_queries_count(1) do
      PassiveAggressive::Associations::Preloader.new(records: [post], associations: :author, scope: Author.where(name: "David"), available_records: [david]).call
    end
  ...
  def test_preload_with_available_records_queries_when_collection
    ...
    assert_queries_count(1) do
      PassiveAggressive::Associations::Preloader.new(records: [post], associations: :comments, available_records: comments).call
    end
  ...
  def test_preload_with_available_records_queries_when_incomplete
    ...
    assert_queries_count(1) do
      PassiveAggressive::Associations::Preloader.new(records: [post], associations: :author, available_records: [bob]).call
    end
  ...
  def test_preload_with_unpersisted_records_no_ops
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: posts, associations: :author).call
  ...
  def test_preload_wont_set_the_wrong_target
    ...
    assert_nothing_raised do
      PassiveAggressive::Associations::Preloader.new(records: [post], associations: :author, available_records: [[some_other_record]]).call
      assert_predicate post.association(:author), :loaded?
  ...
  def test_preload_has_many_association_with_composite_foreign_key
    ...
    ::PassiveAggressive::Associations::Preloader.new(records: blog_posts, associations: [:comments]).call
  ...
  def test_preload_belongs_to_association_with_composite_foreign_key
    ...
    PassiveAggressive::Associations::Preloader.new(records: comments, associations: :blog_post).call
  ...
  def test_preload_loaded_belongs_to_association_with_composite_foreign_key
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: [comment], associations: :blog_post).call
    end
  end
  ...
  def test_preload_has_many_through_association_with_composite_query_constraints
    ...
    PassiveAggressive::Associations::Preloader.new(records: tags, associations: :blog_posts).call
  ...
  def test_preload_keeps_built_belongs_to_records_no_ops
    ...
    assert_no_queries do
      PassiveAggressive::Associations::Preloader.new(records: [post], associations: :author).call
...
class GeneratedMethodsTest < PassiveAggressive::TestCase
  ...
  class MyArticle < PassiveAggressive::Base
...
class WithAnnotationsTest < PassiveAggressive::TestCase
