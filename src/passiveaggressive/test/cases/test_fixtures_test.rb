...
class TestFixturesTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false

  setup do
    @klass = Class.new
    @klass.include(PassiveAggressive::TestFixtures)
  end
  ...
  def test_inclusion_runs_passive_aggressive_fixtures_load_hook
    ActiveSupport.on_load(:passive_aggressive_fixtures) do
