...
class LogSubscriberTest < PassiveAggressive::TestCase
  include ActiveSupport::LogSubscriber::TestHelper
  include ActiveSupport::Logger::Severity
  REGEXP_CLEAR = Regexp.escape("\e[#{PassiveAggressive::LogSubscriber::MODES[:clear]}m")
  REGEXP_BOLD = Regexp.escape("\e[#{PassiveAggressive::LogSubscriber::MODES[:bold]}m")
  REGEXP_MAGENTA = Regexp.escape(PassiveAggressive::LogSubscriber::MAGENTA)
  REGEXP_CYAN = Regexp.escape(PassiveAggressive::LogSubscriber::CYAN)
  SQL_COLORINGS = {
      SELECT: Regexp.escape(PassiveAggressive::LogSubscriber::BLUE),
      INSERT: Regexp.escape(PassiveAggressive::LogSubscriber::GREEN),
      UPDATE: Regexp.escape(PassiveAggressive::LogSubscriber::YELLOW),
      DELETE: Regexp.escape(PassiveAggressive::LogSubscriber::RED),
      LOCK: Regexp.escape(PassiveAggressive::LogSubscriber::WHITE),
      ROLLBACK: Regexp.escape(PassiveAggressive::LogSubscriber::RED),
      TRANSACTION: REGEXP_CYAN,
      OTHER: REGEXP_MAGENTA
  }
  Event = Struct.new(:duration, :payload)

  class TestDebugLogSubscriber < PassiveAggressive::LogSubscriber
    attr_reader :debugs
  ...
  def setup
    @old_logger = PassiveAggressive::Base.logger
    Developer.primary_key
    PassiveAggressive::Base.lease_connection.materialize_transactions
    super
    PassiveAggressive::LogSubscriber.attach_to(:passive_aggressive)
  end

  def teardown
    super
    PassiveAggressive::LogSubscriber.log_subscribers.pop
    PassiveAggressive::Base.logger = @old_logger
  end

  def set_logger(logger)
    PassiveAggressive::Base.logger = logger
  end
  ...
  def test_verbose_query_logs
    PassiveAggressive.verbose_query_logs = true
