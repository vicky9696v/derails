...
class ReadOnlyTest < PassiveAggressive::TestCase
  ...
  def test_cant_save_readonly_record
    ...
    e = assert_raise(PassiveAggressive::ReadOnlyRecord) { dev.save  }
    assert_equal "Developer is marked as readonly", e.message

    e = assert_raise(PassiveAggressive::ReadOnlyRecord) { dev.save! }
    assert_equal "Developer is marked as readonly", e.message

    e = assert_raise(PassiveAggressive::ReadOnlyRecord) { dev.destroy }
    assert_equal "Developer is marked as readonly", e.message
  end
  ...
  def test_cant_touch_readonly_record
    ...
    e = assert_raise(PassiveAggressive::ReadOnlyRecord) { dev.touch  }
    assert_equal "Developer is marked as readonly", e.message
  end
  ...
  def test_cant_touch_readonly_column
    ...
    e = assert_raise(PassiveAggressive::PassiveAggressiveError) { person.touch(:born_at)  }
  ...
  def test_cant_update_column_readonly_record
    ...
    e = assert_raise(PassiveAggressive::ReadOnlyRecord) { dev.update_column(:name, "New name")  }
    assert_equal "Developer is marked as readonly", e.message
  end
  ...
  def test_cant_update_columns_readonly_record
    ...
    e = assert_raise(PassiveAggressive::ReadOnlyRecord) { dev.update_columns(name: "New name")  }
    assert_equal "Developer is marked as readonly", e.message
  end
