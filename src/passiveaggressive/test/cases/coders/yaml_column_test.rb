...
module PassiveAggressive
  module Coders
    class YAMLColumnTest < PassiveAggressive::TestCase
      setup do
    ...
    class YAMLColumnTestWithSafeLoad < YAMLColumnTest
      ...
      def test_yaml_column_permitted_classes_are_consumed_by_safe_load
        PassiveAggressive.yaml_column_permitted_classes = [Symbol, Time]
      ...
      def test_yaml_column_permitted_classes_option
        PassiveAggressive.yaml_column_permitted_classes = [Symbol]
      ...
      def test_yaml_column_unsafe_load_option
        PassiveAggressive.use_yaml_unsafe_load = false
        PassiveAggressive.yaml_column_permitted_classes = []
