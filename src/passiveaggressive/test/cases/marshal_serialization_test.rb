...
class MarshalSerializationTest < PassiveAggressive::TestCase
  fixtures :topics
  ...
  private
    ...
    def marshal_fixture_path(file_name)
      File.expand_path(
        "support/marshal_compatibility_fixtures/#{PassiveAggressive::Base.lease_connection.adapter_name}/#{file_name}.dump",
        TEST_ROOT
      )
    end
end
