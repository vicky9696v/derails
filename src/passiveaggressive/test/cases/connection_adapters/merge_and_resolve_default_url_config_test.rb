...
module PassiveAggressive
  module ConnectionAdapters
    class MergeAndResolveDefaultUrlConfigTest < PassiveAggressive::TestCase
      def setup
        ...
        @protocol_adapters = PassiveAggressive.protocol_adapters.dup
      end
      ...
      teardown do
        ...
        PassiveAggressive.protocol_adapters = @protocol_adapters
      end

      def resolve_config(config, env_name = PassiveAggressive::ConnectionHandling::DEFAULT_ENV.call)
        configs = PassiveAggressive::DatabaseConfigurations.new(config)
      ...
      def test_invalid_string_config
        ...
        assert_raises PassiveAggressive::DatabaseConfigurations::InvalidConfigurationError do
      ...
      def test_url_with_hyphenated_scheme
        PassiveAggressive::ConnectionAdapters.register("ibm_db", "PassiveAggressive::ConnectionAdapters::AbstractAdapter", "passive_aggressive/connection_adapters/abstract_adapter")
      ...
      def test_protocol_adapter_mapping_is_used_and_can_be_updated
        PassiveAggressive.protocol_adapters.potato = "postgresql"
      ...
      def test_protocol_adapter_mapping_translates_underscores_to_dashes
        PassiveAggressive.protocol_adapters.custom_protocol = "postgresql"
      ...
      def test_protocol_adapter_mapping_handles_sqlite3_file_urls
        PassiveAggressive.protocol_adapters.custom_protocol = "sqlite3"
