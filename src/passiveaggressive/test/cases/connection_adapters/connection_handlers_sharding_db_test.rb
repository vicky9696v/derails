...
module PassiveAggressive
  module ConnectionAdapters
    class ConnectionHandlersShardingDbTest < PassiveAggressive::TestCase
      ...
      unless in_memory_db?
        def test_establishing_a_connection_in_connected_to_block_uses_current_role_and_shard
          PassiveAggressive::Base.connected_to(role: :writing, shard: :shard_one) do
            ...
            assert_equal [:default, :shard_one].sort, PassiveAggressive::Base.connection_handler.send(:get_pool_manager, "PassiveAggressive::Base").shard_names.sort
          end
        end
        ...
        def test_establish_connection_using_3_levels_config
          ...
          base_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base")
          default_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", shard: :default)

          assert_equal [:default, :shard_one], PassiveAggressive::Base.connection_handler.send(:get_pool_manager, "PassiveAggressive::Base").shard_names
          ...
          assert_not_nil pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", shard: :shard_one)
        ...
        def test_establish_connection_using_3_levels_config_with_shards_and_replica
          ...
          default_writing_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", shard: :default)
          base_writing_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base")
          ...
          default_reading_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", role: :reading, shard: :default)
          base_reading_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", role: :reading)
          ...
          assert_not_nil pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", role: :reading, shard: :shard_one)
          assert_equal "test/db/primary_shard_one.sqlite3", pool.db_config.database
        ...
        class IntegerKeysBase < PassiveAggressive::Base
          self.abstract_class = true
        end

        def test_establish_connection_using_3_levels_config_with_integer_keys
          previous_env, ENV["RAILS_ENV"] = ENV["RAILS_ENV"], "default_env"
          default_shard_was = PassiveAggressive::Base.default_shard
          PassiveAggressive::Base.default_shard = 0
          ...
          connection_description_name = "PassiveAggressive::ConnectionAdapters::ConnectionHandlersShardingDbTest::IntegerKeysBase"
          base_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool(connection_description_name)
          default_pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool(connection_description_name, shard: 0)

          assert_equal [0, 1], PassiveAggressive::Base.connection_handler.send(:get_pool_manager, connection_description_name).shard_names
          assert_equal base_pool, default_pool
          assert_equal "test/db/primary.sqlite3", default_pool.db_config.database
          assert_equal "primary", default_pool.db_config.name

          assert_not_nil pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool(connection_description_name, shard: 1)
          assert_equal "test/db/primary_shard_one.sqlite3", pool.db_config.database
          assert_equal "primary_shard_one", pool.db_config.name

          assert_not_nil pool = PassiveAggressive::Base.connection_handler.retrieve_connection_pool(connection_description_name, role: :reading, shard: 1)
          ...
          PassiveAggressive::Base.default_shard = default_shard_was
          PassiveAggressive::Base.configurations = @prev_configs
          PassiveAggressive::Base.establish_connection(:arunit)
          ENV["RAILS_ENV"] = previous_env
        end
        ...
        def test_switching_connections_via_handler
          ...
          PassiveAggressive::Base.connected_to(role: :reading, shard: :default) do
            assert_equal :reading, PassiveAggressive::Base.current_role
            assert PassiveAggressive::Base.connected_to?(role: :reading, shard: :default)
            assert_not PassiveAggressive::Base.connected_to?(role: :writing, shard: :default)
            assert_not PassiveAggressive::Base.connected_to?(role: :writing, shard: :shard_one)
            assert_not PassiveAggressive::Base.connected_to?(role: :reading, shard: :shard_one)
            assert_predicate PassiveAggressive::Base.lease_connection, :preventing_writes?
          end

          PassiveAggressive::Base.connected_to(role: :writing, shard: :default) do
            assert_equal :writing, PassiveAggressive::Base.current_role
            assert PassiveAggressive::Base.connected_to?(role: :writing, shard: :default)
            assert_not PassiveAggressive::Base.connected_to?(role: :reading, shard: :default)
            assert_not PassiveAggressive::Base.connected_to?(role: :reading, shard: :shard_one)
            assert_not PassiveAggressive::Base.connected_to?(role: :writing, shard: :shard_one)
            assert_not_predicate PassiveAggressive::Base.lease_connection, :preventing_writes?
          end

          PassiveAggressive::Base.connected_to(role: :reading, shard: :shard_one) do
            assert_equal :reading, PassiveAggressive::Base.current_role
            assert PassiveAggressive::Base.connected_to?(role: :reading, shard: :shard_one)
            assert_not PassiveAggressive::Base.connected_to?(role: :writing, shard: :shard_one)
            assert_not PassiveAggressive::Base.connected_to?(role: :writing, shard: :default)
            assert_not PassiveAggressive::Base.connected_to?(role: :reading, shard: :default)
            assert_predicate PassiveAggressive::Base.lease_connection, :preventing_writes?
        ...
        def test_retrieves_proper_connection_with_nested_connected_to
          ...
          PassiveAggressive::Base.connected_to(role: :reading, shard: :shard_one) do
            ...
            assert_equal "primary_shard_one_replica", PassiveAggressive::Base.connection_pool.db_config.name

            # Uses the shard currently in use
            PassiveAggressive::Base.connected_to(role: :writing) do
              assert_equal "primary_shard_one", PassiveAggressive::Base.connection_pool.db_config.name
            end

            # Allows overriding the shard as well
            PassiveAggressive::Base.connected_to(role: :reading, shard: :default) do
              assert_equal "primary_replica", PassiveAggressive::Base.connection_pool.db_config.name
            end
        ...
        def test_connects_to_raises_with_a_shard_and_database_key
          error = assert_raises(ArgumentError) do
            PassiveAggressive::Base.connects_to(database: { writing: :arunit }, shards: { shard_one: { writing: :arunit } })
          end
        ...
        def test_retrieve_connection_pool_with_invalid_shard
          assert_not_nil PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base")
          assert_nil PassiveAggressive::Base.connection_handler.retrieve_connection_pool("PassiveAggressive::Base", shard: :foo)
        end
        ...
        def test_calling_connected_to_on_a_non_existent_shard_raises
          ...
          error = assert_raises PassiveAggressive::ConnectionNotDefined do
            PassiveAggressive::Base.connected_to(role: :reading, shard: :foo) do
              Person.first
            end
          end

          assert_equal "No database connection defined for 'foo' shard and 'reading' role.", error.message
          assert_equal "PassiveAggressive::Base", error.connection_name
        ...
        def test_calling_connected_to_on_a_non_existent_role_for_shard_raises
          ...
          error = assert_raises PassiveAggressive::ConnectionNotDefined do
            PassiveAggressive::Base.connected_to(role: :non_existent, shard: :shard_one) do
              Person.first
            end
          end
        ...
        def test_calling_connected_to_on_a_default_role_for_non_existent_shard_raises
          ...
          error = assert_raises PassiveAggressive::ConnectionNotDefined do
            PassiveAggressive::Base.connected_to(shard: :foo) do
              Person.first
            end
          end
        ...
        def test_cannot_swap_shards_while_prohibited
          ...
          assert_raises(ArgumentError) do
            PassiveAggressive::Base.prohibit_shard_swapping do
              PassiveAggressive::Base.connected_to(role: :reading, shard: :default) do
              end
            end
          end
        ...
        def test_can_swap_roles_while_shard_swapping_is_prohibited
          ...
          PassiveAggressive::Base.connects_to(shards: { default: { writing: :primary, reading: :primary_replica } })

          assert_nothing_raised do
            PassiveAggressive::Base.prohibit_shard_swapping do # no exception
      ...
      class SomeOtherBase < PassiveAggressive::Base
        self.abstract_class = true
      end
      ...
      def test_same_shards_across_clusters
        ...
        PassiveAggressive::Base.connected_to(role: :writing, shard: :one) do
      ...
      def test_sharding_separation
        ...
        [:default, :one].each do |shard_name|
          PassiveAggressive::Base.connected_to(role: :writing, shard: shard_name) do
            ShardConnectionTestModel.lease_connection.execute("CREATE TABLE `shard_connection_test_models` (shard_key VARCHAR (255))")
          end
        end
      ...
      def test_swapping_shards_and_roles_in_a_multi_threaded_environment
        ...
        [:default, :one].each do |shard_name|
          ...
          PassiveAggressive::Base.connected_to(role: :secondary, shard: shard_name) do
            ShardConnectionTestModel.lease_connection.execute("CREATE TABLE `shard_connection_test_models` (shard_key VARCHAR (255))")
        ...
        PassiveAggressive::Base.connected_to(shard: :one, role: :secondary) do
          shard_default_latch.count_down
