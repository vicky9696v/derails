...
module PassiveAggressive
  module ConnectionAdapters
    class ConnectionSwappingNestedTest < PassiveAggressive::TestCase
      ...
      class PrimaryBase < PassiveAggressive::Base
      ...
      class TertiaryBase < PassiveAggressive::Base
        self.abstract_class = true
      end
      ...
      unless in_memory_db?
        ...
        def test_shards_can_be_swapped_granularly
          ...
          PassiveAggressive::Base.connected_to(role: global_role, shard: :default) do
            assert_equal "primary", PrimaryBase.connection_pool.db_config.name
            assert_equal "secondary", SecondaryBase.connection_pool.db_config.name
            ...
            PrimaryBase.connected_to(shard: :shard_one) do
              ...
              PassiveAggressive::Base.connected_to(shard: :shard_one) do
                assert_equal "primary_shard_one", PrimaryBase.connection_pool.db_config.name
                ...
                PassiveAggressive::Base.connected_to(role: global_role) do
                  assert_equal "primary_shard_one", PrimaryBase.connection_pool.db_config.name
                  assert_equal "secondary_shard_one", SecondaryBase.connection_pool.db_config.name
                end
              end
              ...
              # Switch everything to default
              PassiveAggressive::Base.connected_to(shard: :default) do
                assert_equal "primary", PrimaryBase.connection_pool.db_config.name
                assert_equal "secondary", SecondaryBase.connection_pool.db_config.name
              end
        ...
        def test_connected_to_many
          ...
          PassiveAggressive::Base.connected_to(role: :writing, shard: :default) do
            ...
            PassiveAggressive::Base.connected_to_many([SecondaryBase, TertiaryBase], role: :reading) do
              assert_equal "primary", PrimaryBase.connection_pool.db_config.name
              assert_equal "secondary_replica", SecondaryBase.connection_pool.db_config.name
              assert_equal "tertiary_replica", TertiaryBase.connection_pool.db_config.name

              # Switch one back
              PassiveAggressive::Base.connected_to_many([TertiaryBase], role: :writing) do
                assert_equal "primary", PrimaryBase.connection_pool.db_config.name
                assert_equal "secondary_replica", SecondaryBase.connection_pool.db_config.name
                assert_equal "tertiary", TertiaryBase.connection_pool.db_config.name
              end
        ...
        def test_application_record_prevent_writes_can_be_changed
          ...
          PassiveAggressive.application_record_class = nil
        ...
        def test_prevent_writes_handles_class_reloading
          ...
          Object.const_set(:ReloadedRecord, Class.new(PassiveAggressive::Base) { self.abstract_class = true })
          ReloadedRecord.connects_to(database: { writing: :arunit, reading: :arunit })

          PassiveAggressive::Base.connected_to(role: :reading, prevent_writes: true) do
