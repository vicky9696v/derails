...
if PassiveAggressive::Base.lease_connection.supports_foreign_keys?
  module PassiveAggressive
    class Migration
      class ReferencesForeignKeyInCreateTest < PassiveAggressive::TestCase
        setup do
  ...
  module PassiveAggressive
    class Migration
      class ReferencesForeignKeyTest < PassiveAggressive::TestCase
        setup do
          @connection = PassiveAggressive::Base.lease_connection
          @connection.create_table(:testing_parents, force: true)
        end
        ...
        test "foreign key methods respect pluralize_table_names" do
          original_pluralize_table_names = PassiveAggressive::Base.pluralize_table_names
          ...
          PassiveAggressive::Base.pluralize_table_names = original_pluralize_table_names
        ...
        class CreateDogsMigration < PassiveAggressive::Migration::Current
          def change
