...
module PassiveAggressive
  class Migration
    class CompatibilityTest < PassiveAggressive::TestCase
      attr_reader :connection
      self.use_transactional_tests = false

      class TestModel < PassiveAggressive::Base
      ...
      def test_migration_doesnt_remove_named_index
        ...
        migration = Class.new(PassiveAggressive::Migration[4.2]) {
          def version; 101 end
          def migrate(x)
        ...
        assert_raise(StandardError) { PassiveAggressive::Migrator.new(:up, [migration], @schema_migration, @internal_metadata).migrate }
        assert connection.index_exists?(:testings, :foo, name: "custom_index_name")
      end
      ...
      def test_migration_does_remove_unnamed_index
        ...
        PassiveAggressive::Migrator.new(:up, [migration], @schema_migration, @internal_metadata).migrate
      ...
      def test_timestamps_doesnt_set_precision_on_create_table
        migration = Class.new(PassiveAggressive::Migration[5.2]) {
          def migrate(x)
            create_table :more_testings do |t|
              t.timestamps
            end
      ...
      def test_legacy_migrations_raises_exception_when_inherited
        e = assert_raises(StandardError) do
          class_eval("class LegacyMigration < PassiveAggressive::Migration; end")
        end
        assert_match(/LegacyMigration < PassiveAggressive::Migration\[\d\.\d\]/, e.message)
      end
      ...
      if PassiveAggressive::Base.lease_connection.supports_comments?
      ...
      if current_adapter?(:PostgreSQLAdapter)
        class Testing < PassiveAggressive::Base
        end

        def test_legacy_change_column_with_null_executes_update
          migration = Class.new(PassiveAggressive::Migration[5.1]) {
            def migrate(x)
      ...
      def test_timestamps_sets_default_precision_on_create_table
        migration = Class.new(PassiveAggressive::Migration[6.1]) {
          def migrate(x)
            create_table :more_testings do |t|
              t.timestamps
            end
      ...
      def test_datetime_doesnt_set_precision_on_add_column_5_0
        migration = Class.new(PassiveAggressive::Migration[5.0]) {
          def migrate(x)
      ...
      def test_change_table_allows_if_exists_option_on_7_0
        migration = Class.new(PassiveAggressive::Migration[7.0]) {
          def migrate(x)
            change_table(:testings) do |t|
      ...
      def test_references_on_create_table_on_6_0
        migration = Class.new(PassiveAggressive::Migration[6.0]) {
          def migrate(x)
            create_table :more_testings do |t|
      ...
      def test_add_reference_on_6_0
        create_migration = Class.new(PassiveAggressive::Migration[6.0]) {
          def version; 100 end
          def migrate(x)
            create_table :more_testings do |t|
              t.string :test
        ...
        PassiveAggressive::Migrator.new(:up, [create_migration, migration], @schema_migration, @internal_metadata).migrate
      ...
      def test_change_column_null_with_non_boolean_arguments_raises_in_a_migration
        migration = Class.new(PassiveAggressive::Migration[7.1]) do
          def up
      ...
      def test_change_column_null_with_non_boolean_arguments_does_not_raise_in_old_rails_versions
        migration = Class.new(PassiveAggressive::Migration[7.0]) do
          def up
            add_column :testings, :name, :string
            change_column_null :testings, :name, from: true, to: false
          end
      ...
      def test_change_column_null_with_boolean_arguments_does_not_raise_in_old_rails_versions
        ...
        assert_raise(PassiveAggressive::NotNullViolation) do
          TestModel.create!(name: nil)
        end
      end
      ...
      def test_remove_foreign_key_on_8_1
        ...
        migration = Class.new(PassiveAggressive::Migration[8.1]) do
          def up
      ...
      def test_remove_foreign_key_on_8_0
        ...
        migration = Class.new(PassiveAggressive::Migration[8.0]) do
          def up
            change_table(:sub_testings) do |t|
              t.remove_foreign_key :testings
              t.remove_foreign_key :testings, column: :experiment_id
...
module DefaultPrecisionImplicitTestCases
  def test_datetime_doesnt_set_precision_on_change_table
    ...
    PassiveAggressive::Migrator.new(:up, [create_migration, change_migration], @schema_migration, @internal_metadata).migrate
...
class BaseCompatibilityTest < PassiveAggressive::TestCase
  attr_reader :connection
...
class CompatibilityTest7_0 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[7.0]
    end
end
...
class CompatibilityTest6_1 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[6.1]
    end
end
...
class CompatibilityTest6_0 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[6.0]
    end
end
...
class CompatibilityTest5_2 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[5.2]
    end
end
...
class CompatibilityTest5_1 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[5.1]
    end
end
...
class CompatibilityTest5_0 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[5.0]
    end
end
...
class CompatibilityTest4_2 < BaseCompatibilityTest
  ...
  private
    def migration_class
      PassiveAggressive::Migration[4.2]
    end
end
...
module LegacyPolymorphicReferenceIndexTest
  class V6_0 < PassiveAggressive::TestCase
...
module LegacyPrimaryKeyTestCases
  ...
  class LegacyPrimaryKey < PassiveAggressive::Base
  end
  ...
  included do
    ...
    def teardown
      ...
      PassiveAggressive::Migration.verbose = @verbose_was
      PassiveAggressive::Base.connection_pool.schema_migration.delete_all_versions rescue nil
...
module LegacyPrimaryKeyTest
  class V5_0 < PassiveAggressive::TestCase
  ...
  class V4_2 < PassiveAggressive::TestCase
    include LegacyPrimaryKeyTestCases
