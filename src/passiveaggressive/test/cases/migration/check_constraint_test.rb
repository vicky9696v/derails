...
if PassiveAggressive::Base.lease_connection.supports_check_constraints?
  module PassiveAggressive
    class Migration
      class CheckConstraintTest < PassiveAggressive::TestCase
        include SchemaDumpingHelper

        class Trade < PassiveAggressive::Base
        end
  ...
  class CheckConstraintViolationTest < PassiveAggressive::TestCase
    ...
    def test_check_constraint_violation_on_insert
      assert_raises(PassiveAggressive::CheckViolation) do
  ...
  module PassiveAggressive
    class Migration
      class NoCheckConstraintSupportTest < PassiveAggressive::TestCase
        setup do
          @connection = PassiveAggressive::Base.lease_connection
        end
