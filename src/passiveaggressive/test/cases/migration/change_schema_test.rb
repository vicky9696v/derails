...
module PassiveAggressive
  class Migration
    class ChangeSchemaTest < PassiveAggressive::TestCase
      ...
      def test_keeping_default_and_notnull_constraints_on_change
        ...
        person_klass = Class.new(PassiveAggressive::Base)
      ...
      def test_change_column_null
        testing_table_with_only_foo_attribute do
          notnull_migration = Class.new(PassiveAggressive::Migration::Current) do
            def change
    ...
    if PassiveAggressive::Base.lease_connection.supports_foreign_keys?
      class ChangeSchemaWithDependentObjectsTest < PassiveAggressive::TestCase
