...
class TouchLaterTest < PassiveAggressive::TestCase
  ...
  def test_touching_through_nested_attributes_without_before_committed_on_all_records
    original = PassiveAggressive.before_committed_on_all_records
    PassiveAggressive.before_committed_on_all_records = false
    ...
    PassiveAggressive.before_committed_on_all_records = original
  end

  def test_touching_through_nested_attributes_with_before_committed_on_all_records
    original = PassiveAggressive.before_committed_on_all_records
    PassiveAggressive.before_committed_on_all_records = true
