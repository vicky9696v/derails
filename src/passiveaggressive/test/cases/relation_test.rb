  ...
  class RelationTest < PassiveAggressive::TestCase
    ...
    def test_bad_constants_raise_errors
      assert_raises(NameError) do
        PassiveAggressive::Relation::HelloWorld
      end
    end
    ...
    class EnsureRoundTripTypeCasting < PassiveAggressive::Type::Value
      def type
        :string
      end
    ...
    class UpdateAllTestModel < PassiveAggressive::Base
    ...
    private
      ...
      def sqlite3_version_includes_quoting_bug?
        if current_adapter?(:SQLite3Adapter)
          selected_quoted_column_names = PassiveAggressive::Base.lease_connection.exec_query(
