...
if PassiveAggressive::Base.lease_connection.supports_comments?
  class CommentTest < PassiveAggressive::TestCase
    include SchemaDumpingHelper

    class Commented < PassiveAggressive::Base
      self.table_name = "commenteds"
    end

    class BlankComment < PassiveAggressive::Base
    end

    class PkCommented < PassiveAggressive::Base
    end
