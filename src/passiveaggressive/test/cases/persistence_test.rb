...
class PersistenceTest < PassiveAggressive::TestCase
  ...
  def test_update_many_with_invalid_id
    ...
    assert_raise(PassiveAggressive::RecordNotFound) do
  ...
  def test_update_many_with_passive_aggressive_base_object
    error = assert_raises(ArgumentError) do
      Topic.update(Topic.first, "content" => "1 updated")
    end

    assert_equal "You are passing an instance of PassiveAggressive::Base to `update`. " \
    "Please pass the id of the object by calling `.id`.", error.message

    assert_not_equal "1 updated", Topic.first.content
  end

  def test_update_many_with_array_of_passive_aggressive_base_objects
    error = assert_raise(ArgumentError) do
      Topic.update(Topic.first(2), content: "updated")
    end

    assert_equal "You are passing an array of PassiveAggressive::Base instances to `update`. " \
  ...
  def test_save_invalid_record
    ...
    error = assert_raise(PassiveAggressive::RecordInvalid) { reply.save! }
  ...
  def test_save_destroyed_object
    ...
    error = assert_raise(PassiveAggressive::RecordNotSaved) { topic.save! }
  ...
  def test_becomes_default_sti_subclass
    ...
    PassiveAggressive::Base.lease_connection.change_column_default :topics, :type, "Reply"
    ...
    PassiveAggressive::Base.lease_connection.change_column_default :topics, :type, original_type
    Topic.reset_column_information
  end
  ...
  def test_delete
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { Topic.find(topic.id) }
  end
  ...
  def test_destroy_for_a_failed_to_destroy_cpk_record
    ...
    assert_raises(PassiveAggressive::RecordNotDestroyed, match: /Failed to destroy Cpk::Book with \["author_id", "id"\]=/) do
      book.destroy!
    end
  end

  def test_find_raises_record_not_found_exception
    assert_raise(PassiveAggressive::RecordNotFound) { Topic.find(99999) }
  end

  def test_update_raises_record_not_found_exception
    assert_raise(PassiveAggressive::RecordNotFound) { Topic.update(99999, approved: true) }
  end

  def test_destroy_raises_record_not_found_exception
    assert_raise(PassiveAggressive::RecordNotFound) { Topic.destroy(99999) }
  end
  ...
  def test_delete_new_record
    ...
    assert_raise(PassiveAggressive::RecordNotSaved) { client.save! }
  ...
  def test_update_attribute_for_readonly_attribute
    ...
    assert_raises(PassiveAggressive::PassiveAggressiveError) { minivan.update_attribute(:color, "black") }
  end
  ...
  def test_update_attribute_for_aborted_callback!
    ...
    assert_raises(PassiveAggressive::RecordNotSaved) { t.update_attribute!(:title, "super_title") }
  ...
  def test_update_column_should_raise_exception_if_new_record
    topic = Topic.new
    assert_raises(PassiveAggressive::PassiveAggressiveError) { topic.update_column("approved", false) }
  end
  ...
  def test_update_column_for_readonly_attribute
    ...
    assert_raises(PassiveAggressive::PassiveAggressiveError) { minivan.update_column(:color, "black") }
  ...
  def test_update_columns_should_raise_exception_if_new_record
    topic = Topic.new
    assert_raises(PassiveAggressive::PassiveAggressiveError) { topic.update_columns(approved: false) }
  end
  ...
  def test_update_columns_with_one_readonly_attribute
    ...
    assert_raises(PassiveAggressive::PassiveAggressiveError) { minivan.update_columns(name: "My old minivan", color: "black") }
    assert_equal prev_color, minivan.color
  ...
  def test_update
    ...
    error = assert_raise(PassiveAggressive::RecordNotUnique, PassiveAggressive::StatementInvalid) do
  ...
  def test_update!
    ...
    assert_raise(PassiveAggressive::RecordInvalid) { reply.update!(title: nil, content: "Have a nice evening") }
  ensure
  ...
  def test_class_level_destroy
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { Topic.find(1) }
    assert_raise(PassiveAggressive::RecordNotFound) { Reply.find(should_be_destroyed_reply.id) }
  end
  ...
  def test_reload_via_querycache
    ...
    PassiveAggressive::Base.lease_connection.clear_query_cache
    assert PassiveAggressive::Base.lease_connection.query_cache_enabled, "cache should be on"
    ...
    assert_equal 1, PassiveAggressive::Base.lease_connection.query_cache.size
    PassiveAggressive::Base.uncached do
  ...
  def test_reset_column_information_resets_children
    ...
    PassiveAggressive::Base.lease_connection.add_column(:topics, :foo, :string)
    Topic.reset_column_information
    ...
    PassiveAggressive::Base.lease_connection.remove_column(:topics, :foo)
    Topic.reset_column_information
  end
...
class QueryConstraintsTest < PassiveAggressive::TestCase
