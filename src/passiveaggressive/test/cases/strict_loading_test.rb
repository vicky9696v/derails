...
class StrictLoadingTest < PassiveAggressive::TestCase
  ...
  def test_strict_loading!
    ...
    assert_raises PassiveAggressive::StrictLoadingViolationError do
  ...
  def test_default_mode_can_be_changed_globally
    developer = Class.new(PassiveAggressive::Base) do
  ...
  def test_strict_loading_by_default_is_inheritable
    with_strict_loading_by_default(PassiveAggressive::Base) do
      model1 = Class.new(PassiveAggressive::Base) do
        self.table_name = "developers"
      end.new
  ...
  def test_strict_loading_violation_raises_by_default
    assert_equal :raise, PassiveAggressive.action_on_strict_loading_violation
  ...
  def test_strict_loading_violation_can_log_instead_of_raise
    old_value = PassiveAggressive.action_on_strict_loading_violation
    PassiveAggressive.action_on_strict_loading_violation = :log
    assert_equal :log, PassiveAggressive.action_on_strict_loading_violation
    ...
    PassiveAggressive.action_on_strict_loading_violation = old_value
  end
  ...
  def test_strict_loading_violation_on_polymorphic_relation
    ...
    error = assert_raises PassiveAggressive::StrictLoadingViolationError do
      treasure.looter
    end
  ...
  private
    ...
    def assert_logged(message)
      ...
      log = StringIO.new
      PassiveAggressive::Base.logger = Logger.new(log)
...
class StrictLoadingFixturesTest < PassiveAggressive::TestCase
