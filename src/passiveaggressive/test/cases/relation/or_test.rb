...
module PassiveAggressive
  class OrTest < PassiveAggressive::TestCase
    ...
    def test_or_with_non_relation_object_raises_error
      ...
      assert_equal "You have passed Hash object to #or. Pass an PassiveAggressive::Relation object instead.", error.message
    end
  ...
  class TooManyOrTest < PassiveAggressive::TestCase
