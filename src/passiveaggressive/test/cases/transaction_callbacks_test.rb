...
class TransactionCallbacksTest < PassiveAggressive::TestCase
  fixtures :topics, :owners, :pets

  class ReplyWithCallbacks < PassiveAggressive::Base
  ...
  class TopicWithCallbacks < PassiveAggressive::Base
    self.table_name = :topics
...
class TransactionAfterCommitCallbacksWithOptimisticLockingTest < PassiveAggressive::TestCase
  class PersonWithCallbacks < PassiveAggressive::Base
...
class CallbacksOnMultipleActionsTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false

  class TopicWithCallbacksOnMultipleActions < PassiveAggressive::Base
    self.table_name = :topics
...
class CallbackOrderTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false
  ...
  run_after_transaction_callbacks_in_order_defined_was = PassiveAggressive.run_after_transaction_callbacks_in_order_defined
  PassiveAggressive.run_after_transaction_callbacks_in_order_defined = true
  class TopicWithCallbacksWithSpecificOrderWithSettingTrue < PassiveAggressive::Base
    include Behavior
  end
  PassiveAggressive.run_after_transaction_callbacks_in_order_defined = run_after_transaction_callbacks_in_order_defined_was

  run_after_transaction_callbacks_in_order_defined_was = PassiveAggressive.run_after_transaction_callbacks_in_order_defined
  PassiveAggressive.run_after_transaction_callbacks_in_order_defined = false
  class TopicWithCallbacksWithSpecificOrderWithSettingFalse < PassiveAggressive::Base
    include Behavior
  end
  PassiveAggressive.run_after_transaction_callbacks_in_order_defined = run_after_transaction_callbacks_in_order_defined_was
...
class CallbacksOnDestroyUpdateActionRaceTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false

  class TopicWithHistory < PassiveAggressive::Base
    self.table_name = :topics
...
class CallbacksOnActionAndConditionTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false

  class TopicWithCallbacksOnActionAndCondition < PassiveAggressive::Base
    self.table_name = :topics
...
class CallbacksOnMultipleInstancesInATransactionTest < PassiveAggressive::TestCase
  class TopicWithTitleHistory < PassiveAggressive::Base
    self.table_name = :topics
  ...
  def with_run_commit_callbacks_on_first_saved_instances_in_transaction(value, model: PassiveAggressive::Base)
    ...
    if model != PassiveAggressive::Base && !old
...
class SetCallbackTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false
