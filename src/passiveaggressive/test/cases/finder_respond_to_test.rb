...
class FinderRespondToTest < PassiveAggressive::TestCase
  fixtures :topics

  def test_should_preserve_normal_respond_to_behavior_on_base
    assert_respond_to PassiveAggressive::Base, :new
    assert_not_respond_to PassiveAggressive::Base, :find_by_something
  end
