...
class UnsafeRawSqlTest < PassiveAggressive::TestCase
  ...
  test "order: disallows invalid column name" do
    assert_raises(PassiveAggressive::UnknownAttributeReference) do
  ...
  test "order: allows valid arguments with COLLATE" do
    collation_name = {
      ...
      "Trilogy" => "utf8mb4_bin",
      "SQLite" => "binary"
    }[PassiveAggressive::Base.lease_connection.adapter_name]
  ...
  test "order: disallows dangerous query method" do
    e = assert_raises(PassiveAggressive::UnknownAttributeReference) do
