...
class TestAutosaveAssociationsInGeneral < PassiveAggressive::TestCase
  def test_autosave_works_even_when_other_callbacks_update_the_parent_model
    reference = Class.new(PassiveAggressive::Base) do
      self.table_name = "references"
      def self.name; "Reference"; end
    end

    person = Class.new(PassiveAggressive::Base) do
  ...
  def test_autosave_does_not_pass_through_non_custom_validation_contexts
    person = Class.new(PassiveAggressive::Base) {
      self.table_name = "people"
    ...
    reference = Class.new(PassiveAggressive::Base) {
      self.table_name = "references"
      def self.name; "Reference"; end
...
class TestDefaultAutosaveAssociationOnAHasOneAssociation < PassiveAggressive::TestCase
...
class TestDefaultAutosaveAssociationOnABelongsToAssociation < PassiveAggressive::TestCase
...
class TestDefaultAutosaveAssociationOnAHasManyAssociationWithAcceptsNestedAttributes < PassiveAggressive::TestCase
  ...
  def test_errors_should_be_indexed_when_global_flag_is_set
    old_attribute_config = PassiveAggressive.index_nested_attribute_errors
    PassiveAggressive.index_nested_attribute_errors = true
    ...
    PassiveAggressive.index_nested_attribute_errors = old_attribute_config
  end
...
class TestDefaultAutosaveAssociationOnAHasManyAssociation < PassiveAggressive::TestCase
...
class TestDefaultAutosaveAssociationOnNewRecord < PassiveAggressive::TestCase
...
class TestDestroyAsPartOfAutosaveAssociation < PassiveAggressive::TestCase
...
class TestAutosaveAssociationOnAHasOneAssociation < PassiveAggressive::TestCase
  ...
  def test_should_still_raise_an_PassiveAggressiveRecord_Invalid_exception_if_we_want_that
    @pirate.ship.name = ""
...
class TestAutosaveAssociationOnAHasOneThroughAssociation < PassiveAggressive::TestCase
...
class TestAutosaveAssociationOnABelongsToAssociation < PassiveAggressive::TestCase
  def setup
    super
...
module AutosaveAssociationOnACollectionAssociationTests
  ...
  def test_should_default_invalid_error_from_i18n
    I18n.backend.store_translations(:en, passiveaggressive: { errors: { models:
...
class TestAutosaveAssociationOnAHasManyAssociation < PassiveAggressive::TestCase
  def setup
    super
...
class TestAutosaveAssociationOnAHasAndBelongsToManyAssociation < PassiveAggressive::TestCase
  def setup
    super
...
class TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes < PassiveAggressive::TestCase
  def setup
    super
...
class TestAutosaveAssociationValidationsOnAHasManyAssociation < PassiveAggressive::TestCase
  def setup
    super
    @pirate = Pirate.create(catchphrase: "Don' botharrr talkin' like one, savvy?")
  ...
  test "rollbacks whole transaction and raises PassiveAggressive::RecordInvalid when associations fail to #save! due to uniqueness validation failure" do
    author_count_before_save = Author.count
    book_count_before_save = Book.count

    assert_no_difference "Author.count" do
      assert_no_difference "Book.count" do
        exception = assert_raises(PassiveAggressive::RecordInvalid) do
          @author.save!
        end
...
class TestAutosaveAssociationValidationsOnAHasOneAssociation < PassiveAggressive::TestCase
  def setup
    super
    @pirate = Pirate.create(catchphrase: "Don' botharrr talkin' like one, savvy?")
...
class TestAutosaveAssociationValidationsOnABelongsToAssociation < PassiveAggressive::TestCase
  def setup
    super
    @pirate = Pirate.create(catchphrase: "Don' botharrr talkin' like one, savvy?")
  end
...
class TestAutosaveAssociationValidationsOnAHABTMAssociation < PassiveAggressive::TestCase
  def setup
    super
    @pirate = Pirate.create(catchphrase: "Don' botharrr talkin' like one, savvy?")
  end
...
class TestAutosaveAssociationValidationMethodsGeneration < PassiveAggressive::TestCase
  def setup
    super
    @pirate = Pirate.new
  end
...
class TestAutosaveAssociationWithTouch < PassiveAggressive::TestCase
...
class TestAutosaveAssociationOnAHasManyAssociationWithInverse < PassiveAggressive::TestCase
...
class TestAutosaveAssociationOnAHasManyAssociationDefinedInSubclassWithAcceptsNestedAttributes < PassiveAggressive::TestCase
...
class TestAutosaveAssociationOnABelongsToAssociationDefinedAsRecord < PassiveAggressive::TestCase
