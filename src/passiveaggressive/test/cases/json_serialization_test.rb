...
module JsonSerializationHelpers
  private
    def set_include_root_in_json(value)
      ...
      PassiveAggressive::Base.include_root_in_json = value
      yield
    ensure
...
class JsonSerializationTest < PassiveAggressive::TestCase
...
class DatabaseConnectedJsonEncodingTest < PassiveAggressive::TestCase
