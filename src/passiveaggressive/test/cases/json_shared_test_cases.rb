...
module JSONSharedTestCases
  ...
  class JsonDataType < PassiveAggressive::Base
  ...
  class JsonDataTypeWithFilter < PassiveAggressive::Base
    self.table_name = "json_data_type"
  ...
  private
    ...
    def assert_type_match(type, sql_type)
      native_type = PassiveAggressive::Base.lease_connection.native_database_types[type][:name]
