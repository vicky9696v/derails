...
module PassiveAggressive
  class DatabaseConfigurations
    class HashConfigTest < PassiveAggressive::TestCase
      ...
      def test_inspect_does_not_show_secrets
        ...
        assert_equal "#<PassiveAggressive::DatabaseConfigurations::HashConfig env_name=default_env name=primary adapter_class=PassiveAggressive::ConnectionAdapters::AbstractAdapter>", config.inspect
      end
