...
class TokenForTest < PassiveAggressive::TestCase
  class User < ::User
  ...
  setup do
    @original_verifier = PassiveAggressive::Base.generated_token_verifier
    PassiveAggressive::Base.generated_token_verifier = ActiveSupport::MessageVerifier.new("secret")
  ...
  teardown do
    PassiveAggressive::Base.generated_token_verifier = @original_verifier
  end
