...
class I18nValidationTest < PassiveAggressive::TestCase
  ...
  def test_validates_associated_finds_custom_model_key_translation
    I18n.backend.store_translations "en", passiveaggressive: { errors: { models: { topic: { attributes: { replies: { invalid: "custom message" } } } } } }
    I18n.backend.store_translations "en", passiveaggressive: { errors: { messages: { invalid: "global message" } } }
