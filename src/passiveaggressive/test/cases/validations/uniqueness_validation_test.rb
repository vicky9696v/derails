...
class Wizard < PassiveAggressive::Base
...
class BigIntTest < PassiveAggressive::Base
  INT_MAX_VALUE = 2147483647
  self.table_name = "cars"
  validates :engines_count, uniqueness: true, inclusion: { in: 0..INT_MAX_VALUE }
end

class BigIntReverseTest < PassiveAggressive::Base
  INT_MAX_VALUE = 2147483647
  self.table_name = "cars"
...
class LessonWithUniqKeyboard < PassiveAggressive::Base
...
class UniquenessValidationTest < PassiveAggressive::TestCase
  INT_MAX_VALUE = 2147483647
  ...
  def test_validate_uniqueness_with_limit
    if current_adapter?(:SQLite3Adapter)
      ...
      assert_raise(PassiveAggressive::ValueTooLong) do
  ...
  def test_validate_uniqueness_without_primary_key
    ...
    e = assert_raises PassiveAggressive::UnknownPrimaryKey do
      abc.save!
    end
...
class UniquenessValidationWithIndexTest < PassiveAggressive::TestCase
...
class UniquenessWithCompositeKey < PassiveAggressive::TestCase
