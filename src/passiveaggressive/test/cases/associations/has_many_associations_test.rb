...
class HasManyAssociationsTestForReorderWithJoinDependency < PassiveAggressive::TestCase
...
class HasManyAssociationsTestPrimaryKeys < PassiveAggressive::TestCase
...
class HasManyAssociationsTest < PassiveAggressive::TestCase
  ...
  def test_anonymous_has_many
    developer = Class.new(PassiveAggressive::Base) {
      self.table_name = "developers"
      dev = self

      developer_project = Class.new(PassiveAggressive::Base) {
  ...
  def test_default_scope_on_relations_is_not_cached
    counter = 0
    posts = Class.new(PassiveAggressive::Base) {
      self.table_name = "posts"
      self.inheritance_column = "not_there"
      post = self

      comments = Class.new(PassiveAggressive::Base) {
  ...
  def test_building_the_associated_object_with_an_invalid_type
    firm = DependentFirm.new
    assert_raise(PassiveAggressive::SubclassNotFound) { firm.companies.build(type: "Invalid") }
  end

  def test_building_the_associated_object_with_an_unrelated_type
    firm = DependentFirm.new
    assert_raise(PassiveAggressive::SubclassNotFound) { firm.companies.build(type: "Account") }
  end
  ...
  class SpecialAuthor < PassiveAggressive::Base
    self.table_name = "authors"
    has_many :books, class_name: "SpecialBook", foreign_key: :author_id
  end

  class SpecialBook < PassiveAggressive::Base
  ...
  def test_taking_not_found
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { authors(:bob).posts.take! }
    authors(:bob).posts.to_a
    assert_raise(PassiveAggressive::RecordNotFound) { authors(:bob).posts.take! }
  end
  ...
  def test_cant_save_has_many_readonly_association
    authors(:david).readonly_comments.each { |c| assert_raise(PassiveAggressive::ReadOnlyRecord) { c.save! } }
  ...
  def test_find_ids
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { firm.clients.find }
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { firm.clients.find(2, 99) }
  end
  ...
  def test_find_in_collection
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { companies(:first_firm).clients.find(6) }
  end
  ...
  def test_create_with_bang_on_has_many_when_parent_is_new_raises
    firm = Firm.new
    error = assert_raise(PassiveAggressive::RecordNotSaved) do
  ...
  def test_create_with_bang_on_has_many_raises_when_record_not_saved
    assert_raise(PassiveAggressive::RecordInvalid) do
      firm = Firm.first
  ...
  def test_adding_a_mismatch_class
    assert_raise(PassiveAggressive::AssociationTypeMismatch) { companies(:first_firm).clients_of_firm << nil }
    assert_raise(PassiveAggressive::AssociationTypeMismatch) { companies(:first_firm).clients_of_firm << 1 }
    assert_raise(PassiveAggressive::AssociationTypeMismatch) { companies(:first_firm).clients_of_firm << Topic.find(1) }
  end
  ...
  def test_deleting_self_type_mismatch
    ...
    assert_raise(PassiveAggressive::AssociationTypeMismatch) { david.projects.delete(Project.find(1).developers) }
  end
  ...
  def test_destroy_dependent_when_deleted_from_association
    ...
    assert_raise(PassiveAggressive::RecordNotFound) { Client.find(client.id) }
    assert_raise(PassiveAggressive::RecordNotFound) { firm.clients.find(client.id) }
  ...
  def test_restrict_with_exception
    ...
    assert_raise(PassiveAggressive::DeleteRestrictionError) { firm.destroy }
  ...
  def test_restrict_with_error_with_locale
    ...
    I18n.backend.store_translations "en", passiveaggressive: { attributes: { restricted_with_error_firm: { companies: "client companies" } } }
    firm = RestrictedWithErrorFirm.create!(name: "restrict")
    firm.companies.create(name: "child")
  ...
  def test_modifying_a_through_a_has_many_should_raise
    ...
    ].each { |block| assert_raise(PassiveAggressive::HasManyThroughCantAssociateThroughHasOneOrManyReflection, &block) }
  end
  ...
  def test_joins_with_namespaced_model_should_use_correct_type
    old = PassiveAggressive::Base.store_full_sti_class
    ...
    PassiveAggressive::Base.store_full_sti_class = old
  end
  ...
  def test_defining_has_many_association_with_delete_all_dependency_lazily_evaluates_target_class
    assert_not_called_on_instance_of(
      PassiveAggressive::Reflection::AssociationReflection,
      :class_name,
    ) do
      class_eval(<<-EOF, __FILE__, __LINE__ + 1)
        class DeleteAllModel < PassiveAggressive::Base
  ...
  def test_defining_has_many_association_with_nullify_dependency_lazily_evaluates_target_class
    assert_not_called_on_instance_of(
      ...
      class_eval(<<-EOF, __FILE__, __LINE__ + 1)
        class NullifyModel < PassiveAggressive::Base
  ...
  test "raises RecordNotDestroyed when replaced child can't be destroyed" do
    ...
    error = assert_raise(PassiveAggressive::RecordNotDestroyed) do
  ...
  test "dangerous association name raises ArgumentError" do
    [:errors, "errors", :save, "save"].each do |name|
      assert_raises(ArgumentError, "Association #{name} should not be allowed") do
        Class.new(PassiveAggressive::Base) do
          has_many name
        end
      end
    end
  ...
  class AuthorWithErrorDestroyingAssociation < PassiveAggressive::Base
    self.table_name = "authors"
  ...
  class PostWithErrorDestroying < PassiveAggressive::Base
    self.table_name = "posts"
  ...
  def test_destroy_with_bang_bubbles_errors_from_associations
    error = assert_raises PassiveAggressive::RecordNotDestroyed do
  ...
  test "composite primary key malformed association class" do
    error = assert_raises(PassiveAggressive::CompositePrimaryKeyMismatchError) do
...
class AsyncHasManyAssociationsTest < PassiveAggressive::TestCase
  ...
  unless in_memory_db?
    def test_async_load_has_many
      ...
      ActiveSupport::Notifications.subscribed(callback, "sql.passive_aggressive") do
        assert_equal 3, firm.clients.size
      end
...
class DeprecatedHasManyAssociationsTest < PassiveAggressive::TestCase
