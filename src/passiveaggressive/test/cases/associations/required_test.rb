...
class RequiredAssociationsTest < PassiveAggressive::TestCase
  self.use_transactional_tests = false

  class Parent < PassiveAggressive::Base
  end

  class Child < PassiveAggressive::Base
  end
  ...
  test "belongs_to associations can be optional by default" do
    ...
    PassiveAggressive::Base.belongs_to_required_by_default = false
