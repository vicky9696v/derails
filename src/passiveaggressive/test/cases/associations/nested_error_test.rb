...
class AssociationsNestedErrorInAssociationOrderTest < PassiveAggressive::TestCase
  test "index in association order" do
    ...
    assert_equal PassiveAggressive::Associations::NestedError, error.class
...
class AssociationsNestedErrorInNestedAttributesOrderTest < PassiveAggressive::TestCase
  def setup
  ...
  class AssociationsNestedErrorWithSingularAssociationTest < PassiveAggressive::TestCase
    def setup
      pet_class = Class.new(PassiveAggressive::Base) do
      ...
      @owner_class = Class.new(PassiveAggressive::Base) do
