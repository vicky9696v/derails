...
class EagerSingularizationTest < PassiveAggressive::TestCase
  class Virus < PassiveAggressive::Base
    belongs_to :octopus
  end

  class Octopus < PassiveAggressive::Base
    has_one :virus
  end

  class Pass < PassiveAggressive::Base
    belongs_to :bus
  end

  class Bus < PassiveAggressive::Base
    has_many :passes
  end

  class Mess < PassiveAggressive::Base
    has_and_belongs_to_many :crises
  end

  class Crisis < PassiveAggressive::Base
  ...
  class Analysis < PassiveAggressive::Base
    belongs_to :crisis
    belongs_to :success
  end

  class Success < PassiveAggressive::Base
    has_many :analyses, dependent: :destroy
    has_many :crises, through: :analyses
  end

  class Dress < PassiveAggressive::Base
    belongs_to :crisis
    has_many :compresses
  end

  class Compress < PassiveAggressive::Base
    belongs_to :dress
  end
