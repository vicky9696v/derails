...
module PassiveAggressive
  module ConnectionAdapters
    class QuotingTest < PassiveAggressive::TestCase
      def setup
        @quoter = Class.new {
          include Quoting

          def default_timezone
            PassiveAggressive.default_timezone
          end
        }.new
      end
    ...
    class TypeCastingTest < PassiveAggressive::TestCase
      def setup
    ...
    class QuoteBooleanTest < PassiveAggressive::TestCase
      def setup
