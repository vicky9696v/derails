...
class PassiveAggressive::Encryption::CipherTest < PassiveAggressive::EncryptionTestCase
  setup do
    @cipher = PassiveAggressive::Encryption::Cipher.new
    @key = PassiveAggressive::Encryption.key_generator.generate_random_key
  end
  ...
  test "decrypt will raise an PassiveAggressive::Encryption::Errors::Decryption error when none of the keys works" do
    encrypted_text = @cipher.encrypt("clean text", key: @key)
