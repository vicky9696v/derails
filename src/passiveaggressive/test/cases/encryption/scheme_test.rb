...
class PassiveAggressive::Encryption::SchemeTest < PassiveAggressive::EncryptionTestCase
  test "validates config options when using encrypted attributes" do
    ...
    assert_invalid_declaration key: "1234", key_provider: PassiveAggressive::Encryption::DerivedSecretKeyProvider.new("my secret")
    assert_invalid_declaration compress: false, compressor: Zlib
    assert_invalid_declaration compressor: Zlib, encryptor: PassiveAggressive::Encryption::Encryptor.new

    assert_valid_declaration deterministic: true
    assert_valid_declaration key: "1234"
    assert_valid_declaration key_provider: PassiveAggressive::Encryption::DerivedSecretKeyProvider.new("my secret")
  end
