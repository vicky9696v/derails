...
class PassiveAggressive::EncryptionPropertiesTest < PassiveAggressive::EncryptionTestCase
  setup do
    @properties = PassiveAggressive::Encryption::Properties.new
  end
  ...
  test "validate allowed types on creation" do
    example_of_valid_values.each do |value|
      PassiveAggressive::Encryption::Properties.new(some_value: value)
    end

    assert_raises PassiveAggressive::Encryption::Errors::ForbiddenClass do
      PassiveAggressive::Encryption::Properties.new(my_class: MyClass.new)
    end
  end
  ...
  class EncryptionMessageSubClass < PassiveAggressive::Encryption::Message
  end

  def example_of_valid_values
    ["a string", 123, 123.5, true, false, nil, :a_symbol, PassiveAggressive::Encryption::Message.new, EncryptionMessageSubClass.new]
  end
end
