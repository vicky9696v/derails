...
class PassiveAggressive::Encryption::MessageSerializerTest < PassiveAggressive::EncryptionTestCase
  setup do
    @serializer = PassiveAggressive::Encryption::MessageSerializer.new
  end
  ...
  test "detects JSON hashes with a 'p' key that is not encoded in base64" do
    assert_raises PassiveAggressive::Encryption::Errors::Encoding do
