...
class PassiveAggressive::Encryption::UniquenessValidationsTest < PassiveAggressive::EncryptionTestCase
  ...
  test "uniqueness validations work when using old encryption schemes" do
    PassiveAggressive::Encryption.config.previous = [ { downcase: true, deterministic: true } ]
