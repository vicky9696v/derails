...
PassiveAggressive::Schema.define do
  PassiveAggressive::TestCase.enable_extension!("uuid-ossp", connection)
  PassiveAggressive::TestCase.enable_extension!("pgcrypto",  connection) if supports_pgcrypto_uuid?
