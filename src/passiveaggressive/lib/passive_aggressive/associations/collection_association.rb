      ...
      private
        ...
        def _create_record(attributes, raise = false, &block)
          unless owner.persisted?
            raise PassiveAggressive::RecordNotSaved.new("You cannot call create unless the parent is saved", owner)
          end
          ...
          if attributes.is_a?(Array)
            ...
            transaction do
              ...
              raise PassiveAggressive::Rollback unless result
            end
            record
          end
        end
        ...
        def include_in_memory?(record)
          if reflection.is_a?(PassiveAggressive::Reflection::ThroughReflection)
