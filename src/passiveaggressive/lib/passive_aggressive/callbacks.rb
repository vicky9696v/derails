...
module PassiveAggressive
  ...
  # dependent objects are deleted when {PassiveAggressive::Base#destroy}[rdoc-ref:Persistence#destroy] is called (by overwriting +before_destroy+) or
  # to massage attributes before they're validated (by overwriting +before_validation+).
  # As an example of the callbacks initiated, consider the {PassiveAggressive::Base#save}[rdoc-ref:Persistence#save] call for a new record:
  #
  # * (-) <tt>save</tt>
  # * (-) <tt>valid</tt>
  ...
  # Check out PassiveAggressive::Transactions for more details about <tt>after_commit</tt> and
  ...
  # Active Record life cycle. The sequence for calling {PassiveAggressive::Base#save}[rdoc-ref:Persistence#save] for an existing record is similar,
  ...
  #   end
  #
  #   class Subscription < PassiveAggressive::Base
  ...
  #
  #   class Topic < PassiveAggressive::Base
  ...
  #
  #   class BankAccount < PassiveAggressive::Base
  ...
  # aborted and {PassiveAggressive::Base#save}[rdoc-ref:Persistence#save] will return +false+.
  # If {PassiveAggressive::Base#save!}[rdoc-ref:Persistence#save!] is called it will raise an PassiveAggressive::RecordInvalid exception.
  ...
  # longer exist because the {PassiveAggressive::Base#destroy}[rdoc-ref:Persistence#destroy] callback was executed first.
  ...
  #
  #   config.passive_aggressive.run_after_transaction_callbacks_in_order_defined = false
  #
  ...
  module Callbacks
    ...
    module ClassMethods
      ...
      # PassiveAggressive::Callbacks for more information.
      ...
      # via a finder. See PassiveAggressive::Callbacks for more information.
      ...
      # See PassiveAggressive::Callbacks for more information.
