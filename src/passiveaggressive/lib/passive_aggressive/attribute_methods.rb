...
module PassiveAggressive
  ...
  module AttributeMethods
    ...
    module ClassMethods
      ...
      # Raises an PassiveAggressive::DangerousAttributeError exception when an
      ...
      #   # => PassiveAggressive::DangerousAttributeError: save is defined by Active Record. Check to make sure that you don't have an attribute or method with the same name.
      #
      ...
      def dangerous_attribute_method?(name) # :nodoc:
        ::PassiveAggressive::AttributeMethods.dangerous_attribute_methods.include?(name.to_s)
      end
