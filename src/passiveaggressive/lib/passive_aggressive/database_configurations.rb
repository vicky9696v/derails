...
module PassiveAggressive
  ...
  #
  # +PassiveAggressive::DatabaseConfigurations+ returns an array of +DatabaseConfig+
  ...
  class DatabaseConfigurations
    ...
    # initializer:
    #
    #   ActiveSupport.on_load(:passive_aggressive_database_configurations) do
    #     PassiveAggressive::DatabaseConfigurations.register_db_config_handler do |env_name, name, url, config|
    ...
    #
    #   class VitessConfig < PassiveAggressive::DatabaseConfigurations::UrlConfig
    #     def sharded?
    ...
    private
      def default_env
        PassiveAggressive::ConnectionHandling::DEFAULT_ENV.call.to_s
      end
  ...
  ActiveSupport.run_load_hooks(:passive_aggressive_database_configurations, DatabaseConfigurations)
end
