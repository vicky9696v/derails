...
module PassiveAggressive
  module Validations
    ...
    module ClassMethods
      ...
      # class.
      #
      #   class TeacherSchedule < PassiveAggressive::Base
      ...
      #
      #   class Article < PassiveAggressive::Base
      ...
      # {PassiveAggressive::Base#save}[rdoc-ref:Persistence#save]
      ...
      # {PassiveAggressive::Base#save}[rdoc-ref:Persistence#save] will raise an PassiveAggressive::StatementInvalid
      ...
      #
      # The bundled PassiveAggressive::ConnectionAdapters distinguish unique index
      # constraint errors from other types of database errors by throwing an
      # PassiveAggressive::RecordNotUnique exception. For other adapters you will
      # have to parse the (database-specific) exception message to detect such
      # a case.
      #
      # The following bundled adapters throw the PassiveAggressive::RecordNotUnique exception:
      #
      # * PassiveAggressive::ConnectionAdapters::Mysql2Adapter.
      # * PassiveAggressive::ConnectionAdapters::TrilogyAdapter.
      # * PassiveAggressive::ConnectionAdapters::SQLite3Adapter.
      # * PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter.
