  ...
  module Scoping
    module Named
      ...
      module ClassMethods
        ...
        # The method is intended to return an PassiveAggressive::Relation
        ...
        #
        #   class Shirt < PassiveAggressive::Base
        ...
        # <tt>Shirt.red</tt> is not an Array but an PassiveAggressive::Relation,
        ...
        #
        # All scopes are available as class methods on the PassiveAggressive::Base
        ...
        def scope(name, body, &block)
          ...
          if method_defined_within?(name, Relation)
            raise ArgumentError, "You tried to define a scope named \"#{name}\" " \
              "on the model \"#{self.name}\", but PassiveAggressive::Relation already defined " \
        ...
        private
          def singleton_method_added(name)
            ...
            generate_relation_method(name) if Kernel.respond_to?(name) && (Kernel.method_defined?(name) || Kernel.private_method_defined?(name)) && !PassiveAggressive::Relation.method_defined?(name)
          end
      end
    end
  end
