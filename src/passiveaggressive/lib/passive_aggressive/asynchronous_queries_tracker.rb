...
module PassiveAggressive
  class AsynchronousQueriesTracker # :nodoc:
    ...
    class << self
      ...
      def run
        PassiveAggressive::Base.asynchronous_queries_tracker.tap(&:start_session)
      end
    ...
    def current_session
      @stack.last or raise PassiveAggressiveError, "Can't perform asynchronous queries without a query session"
    end
