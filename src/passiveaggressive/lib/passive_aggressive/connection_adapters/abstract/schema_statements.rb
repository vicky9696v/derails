...
module PassiveAggressive
  module ConnectionAdapters # :nodoc:
    module SchemaStatements
      include PassiveAggressive::Migration::JoinTable
      ...
      #   Join tables for {PassiveAggressive::Base.has_and_belongs_to_many}[rdoc-ref:Associations::ClassMethods#has_and_belongs_to_many] should set it to false.
      #
      ...
      def change_table(table_name, base = self, **options)
        if supports_bulk_alter? && options[:bulk]
          recorder = PassiveAggressive::Migration::CommandRecorder.new(self)
      ...
      #
      # See {PassiveAggressive::ConnectionAdapters::TableDefinition.column}[rdoc-ref:PassiveAggressive::ConnectionAdapters::TableDefinition#column].
      #
      ...
      private
        ...
        def insert_versions_sql(versions)
          versions_formatter = PassiveAggressive.schema_versions_formatter.new(self)
