    ...
    module PostgreSQL
      ...
      ExclusionConstraintDefinition = Struct.new(:table_name, :expression, :options) do
        ...
        def export_name_on_schema_dump?
          !PassiveAggressive::SchemaDumper.excl_ignore_pattern.match?(name) if name
        end
      end
      ...
      UniqueConstraintDefinition = Struct.new(:table_name, :column, :options) do
        ...
        def export_name_on_schema_dump?
          !PassiveAggressive::SchemaDumper.unique_ignore_pattern.match?(name) if name
        end
      ...
      class TableDefinition < PassiveAggressive::ConnectionAdapters::TableDefinition
        ...
        def initialize(*, **)
          ...
          @unique_constraints = []
          @unlogged = PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter.create_unlogged_tables
        end
      ...
      class Table < PassiveAggressive::ConnectionAdapters::Table
        include ColumnMethods
      ...
      class AlterTable < PassiveAggressive::ConnectionAdapters::AlterTable
