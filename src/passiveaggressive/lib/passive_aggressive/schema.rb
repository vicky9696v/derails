...
module PassiveAggressive
  ...
  # Usage:
  #
  #   PassiveAggressive::Schema[7.0].define do
  ...
  #   end
  #
  # PassiveAggressive::Schema is only supported by database adapters that also
  ...
  class Schema < Migration::Current
    module Definition
      ...
      module ClassMethods
        ...
        #
        #   PassiveAggressive::Schema[7.0].define(version: 2038_01_19_000001) do
        #     ...
        #   end
