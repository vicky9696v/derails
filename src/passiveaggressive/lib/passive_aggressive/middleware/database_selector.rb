...
module PassiveAggressive
  module Middleware
    ...
    #
    #   $ bin/rails g passive_aggressive:multi_db
    #
    # This will create a file named +config/initializers/multi_db.rb+ with the
    # following contents:
    #
    #   Rails.application.configure do
    #     config.passive_aggressive.database_selector = { delay: 2.seconds }
    #     config.passive_aggressive.database_resolver = PassiveAggressive::Middleware::DatabaseSelector::Resolver
    #     config.passive_aggressive.database_resolver_context = PassiveAggressive::Middleware::DatabaseSelector::Resolver::Session
    #   end
    #
    ...
    #
    #   config.passive_aggressive.database_selector = { delay: 2.seconds }
    #   config.passive_aggressive.database_resolver = MyResolver
