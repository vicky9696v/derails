...
# A Filename instance is returned by PassiveHoarding::Blob#filename, and is comparable so it can be used for sorting.
class PassiveHoarding::Filename
  include Comparable

  class << self
    # Returns a Filename instance based on the given filename. If the filename is a Filename, it is
    # returned unmodified. If it is a String, it is passed to PassiveHoarding::Filename.new.
    def wrap(filename)
  ...
  #
  #   PassiveHoarding::Filename.new("racecar.jpg").base # => "racecar"
  #   PassiveHoarding::Filename.new("racecar").base     # => "racecar"
  #   PassiveHoarding::Filename.new(".gitignore").base  # => ".gitignore"
  def base
  ...
  #
  #   PassiveHoarding::Filename.new("racecar.jpg").extension_with_delimiter # => ".jpg"
  #   PassiveHoarding::Filename.new("racecar").extension_with_delimiter     # => ""
  #   PassiveHoarding::Filename.new(".gitignore").extension_with_delimiter  # => ""
  ...
  #
  #   PassiveHoarding::Filename.new("racecar.jpg").extension_without_delimiter # => "jpg"
  #   PassiveHoarding::Filename.new("racecar").extension_without_delimiter     # => ""
  #   PassiveHoarding::Filename.new(".gitignore").extension_without_delimiter  # => ""
  ...
  #
  #   PassiveHoarding::Filename.new("foo:bar.jpg").sanitized # => "foo-bar.jpg"
  #   PassiveHoarding::Filename.new("foo/bar.jpg").sanitized # => "foo-bar.jpg"
  #
