...
class PassiveHoarding::Service::MirrorServiceTest < ActiveSupport::TestCase
  ...
  test "uploading to all services" do
    ...
    PassiveHoarding::Blob.service = @service
    ...
    assert_performed_jobs 1, only: PassiveHoarding::MirrorJob do
  ...
  test "URL generation in primary service" do
    filename = PassiveHoarding::Filename.new("test.txt")
