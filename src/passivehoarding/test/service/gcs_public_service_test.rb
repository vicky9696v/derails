...
if SERVICE_CONFIGURATIONS[:gcs_public]
  class PassiveHoarding::Service::GCSPublicServiceTest < ActiveSupport::TestCase
    SERVICE = PassiveHoarding::Service.configure(:gcs_public, SERVICE_CONFIGURATIONS)

    include PassiveHoarding::Service::SharedServiceTests

    test "public URL generation" do
      url = @service.url(@key, filename: PassiveHoarding::Filename.new("avatar.png"))
