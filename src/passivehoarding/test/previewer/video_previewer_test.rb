...
class PassiveHoarding::Previewer::VideoPreviewerTest < ActiveSupport::TestCase
  test "previewing an MP4 video" do
    blob = create_file_blob(filename: "video.mp4", content_type: "video/mp4")

    PassiveHoarding::Previewer::VideoPreviewer.new(blob).preview do |attachable|
  ...
  test "previewing a video that can't be previewed" do
    ...
    assert_raises PassiveHoarding::PreviewError do
      PassiveHoarding::Previewer::VideoPreviewer.new(blob).preview
    end
  end
end
