...
class PassiveHoarding::Previewer::MuPDFPreviewerTest < ActiveSupport::TestCase
  test "previewing a PDF document" do
    blob = create_file_blob(filename: "report.pdf", content_type: "application/pdf")

    PassiveHoarding::Previewer::MuPDFPreviewer.new(blob).preview do |attachable|
  ...
  test "previewing a PDF that can't be previewed" do
    ...
    assert_raises PassiveHoarding::PreviewError do
      PassiveHoarding::Previewer::MuPDFPreviewer.new(blob).preview
    end
  end
end
