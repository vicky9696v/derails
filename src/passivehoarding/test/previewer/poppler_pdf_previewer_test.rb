...
class PassiveHoarding::Previewer::PopplerPDFPreviewerTest < ActiveSupport::TestCase
  test "previewing a PDF document" do
    blob = create_file_blob(filename: "report.pdf", content_type: "application/pdf")

    PassiveHoarding::Previewer::PopplerPDFPreviewer.new(blob).preview do |attachable|
  ...
  test "previewing a PDF that can't be previewed" do
    ...
    assert_raises PassiveHoarding::PreviewError do
      PassiveHoarding::Previewer::PopplerPDFPreviewer.new(blob).preview
    end
  end
end
