...
class PassiveHoarding::Representations::ProxyControllerWithVariantsTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "showing variant attachment" do
    get rails_blob_representation_proxy_url(
      ...
      variation_key: PassiveHoarding::Variation.encode(@transformations))
...
class PassiveHoarding::Representations::ProxyControllerWithVariantsWithStrictLoadingTest < ActionDispatch::IntegrationTest
  setup do
    @blob = create_file_blob filename: "racecar.jpg"
    @transformations = { resize_to_limit: [100, 100] }
...
class PassiveHoarding::Representations::ProxyControllerWithPreviewsTest < ActionDispatch::IntegrationTest
  setup do
...
class PassiveHoarding::Representations::ProxyControllerWithPreviewsWithStrictLoadingTest < ActionDispatch::IntegrationTest
  setup do
    @blob = create_file_blob filename: "report.pdf", content_type: "application/pdf"
    @transformations = { resize_to_limit: [100, 100] }
