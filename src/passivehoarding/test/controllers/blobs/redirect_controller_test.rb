...
class PassiveHoarding::Blobs::RedirectControllerTest < ActionDispatch::IntegrationTest
  setup do
...
class PassiveHoarding::Blobs::ExpiringRedirectControllerTest < ActionDispatch::IntegrationTest
  setup do
    @blob = create_file_blob filename: "racecar.jpg"
...
class PassiveHoarding::Blobs::RedirectControllerWithOpenRedirectTest < ActionDispatch::IntegrationTest
