...
class PassiveHoarding::VariantWithRecordTest < ActiveSupport::TestCase
  include ActiveJob::TestHelper

  setup do
    @was_tracking, PassiveHoarding.track_variants = PassiveHoarding.track_variants, true
  end
  ...
  test "eager loading has_one_attached record" do
    ...
    assert_difference -> { PassiveHoarding::VariantRecord.count }, +1 do
    ...
    assert_no_difference -> { PassiveHoarding::VariantRecord.count } do
  ...
  test "eager loading has_many_attached records" do
    ...
    assert_difference -> { PassiveHoarding::VariantRecord.count }, +2 do
  ...
  test "destroy deletes file from service" do
    ...
    assert_equal 1, PassiveHoarding::VariantRecord.count
    assert blob.service.exist?(variant.key)

    variant.destroy

    assert_equal 0, PassiveHoarding::VariantRecord.count
