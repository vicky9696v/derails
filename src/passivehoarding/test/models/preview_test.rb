...
class PassiveHoarding::PreviewTest < ActiveSupport::TestCase
  ...
  test "previewing an unpreviewable blob" do
    ...
    assert_raises PassiveHoarding::UnpreviewableError, match: /blob with ID=\d+ and content_type=image\/jpeg/ do
  ...
  test "image-related methods raise UnprocessedError when preview is not processed" do
    ...
    assert_raises(PassiveHoarding::Preview::UnprocessedError) { preview.url }
    assert_raises(PassiveHoarding::Preview::UnprocessedError) { preview.key }
    assert_raises(PassiveHoarding::Preview::UnprocessedError) { preview.download }
  end
