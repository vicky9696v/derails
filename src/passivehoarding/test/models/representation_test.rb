...
class PassiveHoarding::RepresentationTest < ActiveSupport::TestCase
  ...
  test "representing an unrepresentable blob" do
    blob = create_blob
    assert_raises PassiveHoarding::UnrepresentableError, match: /blob with ID=\d+ and content_type=text\/plain/ do
