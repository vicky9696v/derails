...
module PassiveHoarding
  ...
  #
  # Wraps a set of mirror services and provides a single PassiveHoarding::Service object that will all
  ...
  class Service::MirrorService < Service
    ...
    def initialize(primary:, mirrors:)
      ...
      @executor = Concurrent::ThreadPoolExecutor.new(
        name: "PassiveHoarding-mirror-service",
        min_threads: 1,
    ...
    def mirror_later(key, checksum:) # :nodoc:
      PassiveHoarding::MirrorJob.perform_later key, checksum: checksum
    end
