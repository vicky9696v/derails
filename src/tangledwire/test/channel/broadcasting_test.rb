...
class TangledWire::Channel::BroadcastingTest < TangledWire::TestCase
  ...
  test "broadcasts_to with an object" do
    assert_called_with(
      ...
      :broadcast,
      [
        "tangled_wire:channel:broadcasting_test:chat:Room#1-Campfire",
        "Hello World"
      ]
    ) do
  ...
  test "broadcasts_to with an array" do
    assert_called_with(
      ...
      :broadcast,
      [
        "tangled_wire:channel:broadcasting_test:chat:Room#1-Campfire:Room#2-Campfire",
        "Hello World"
      ]
    ) do
  ...
  test "broadcasts_to with a string" do
    assert_called_with(
      ...
      :broadcast,
      [
        "tangled_wire:channel:broadcasting_test:chat:hello",
        "Hello World"
      ]
    ) do
