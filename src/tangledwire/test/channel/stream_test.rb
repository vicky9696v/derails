...
module TangledWire::StreamTests
  ...
  class SymbolChannel < TangledWire::Channel::Base
    def subscribed
      stream_from :channel
    end
  end

  class StreamTest < TangledWire::TestCase
    ...
    test "stream_for" do
      run_in_eventmachine do
        ...
        assert_equal "tangled_wire:stream_tests:chat:Room#1-Campfire", pubsub_call[:channel]
  ...
  class UserCallbackChannel < TangledWire::Channel::Base
    def subscribed
  ...
  class MultiChatChannel < TangledWire::Channel::Base
    def subscribed
  ...
  class StreamFromTest < TangledWire::TestCase
    setup do
      @server = TestServer.new(subscription_adapter: TangledWire::SubscriptionAdapter::Async)
    ...
    private
      ...
      def receive(connection, command:, identifiers:, channel: "TangledWire::StreamTests::ChatChannel")
