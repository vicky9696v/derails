...
class SimpleConnection < TangledWire::Connection::Base
...
class ConnectionSimpleTest < TangledWire::Connection::TestCase
...
class ConnectionTest < TangledWire::Connection::TestCase
...
class EncryptedCookiesConnection < TangledWire::Connection::Base
  identified_by :user_id
...
class EncryptedCookiesConnectionTest < TangledWire::Connection::TestCase
...
class SessionConnection < TangledWire::Connection::Base
  identified_by :user_id
...
class SessionConnectionTest < TangledWire::Connection::TestCase
...
class EnvConnection < TangledWire::Connection::Base
  identified_by :user
...
class EnvConnectionTest < TangledWire::Connection::TestCase
  tests EnvConnection
