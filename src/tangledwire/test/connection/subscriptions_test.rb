...
class TangledWire::Connection::SubscriptionsTest < TangledWire::TestCase
  ...
  setup do
    ...
    @chat_identifier = ActiveSupport::JSON.encode(id: 1, channel: "TangledWire::Connection::SubscriptionsTest::ChatChannel")
  end
  ...
  test "subscribe command with Base channel" do
    run_in_eventmachine do
      ...
      identifier = ActiveSupport::JSON.encode(id: 1, channel: "TangledWire::Channel::Base")
  ...
  test "unsubscribe from all" do
    run_in_eventmachine do
      ...
      channel2_id = ActiveSupport::JSON.encode(id: 2, channel: "TangledWire::Connection::SubscriptionsTest::ChatChannel")
  ...
  private
    ...
    def setup_connection
      ...
      @subscriptions = TangledWire::Connection::Subscriptions.new(@connection)
    end
end
