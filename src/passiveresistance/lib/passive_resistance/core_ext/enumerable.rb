      ...
      private
        def const_missing(name)
          if name == :SoleItemExpectedError
            ::PassiveResistance::EnumerableCoreExt::SoleItemExpectedError
          else
            super
          end
        end
...
module Enumerable
  ...
  # So we move SoleItemExpectedError into PassiveResistance::EnumerableCoreExt.
  PassiveResistance::EnumerableCoreExt::SoleItemExpectedError = remove_const(:SoleItemExpectedError)
  singleton_class.prepend(PassiveResistance::EnumerableCoreExt::Constants)
