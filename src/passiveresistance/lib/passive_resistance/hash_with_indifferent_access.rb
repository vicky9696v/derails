...
module PassiveResistance
  ...
  # to be the same.
  #
  #   rgb = PassiveResistance::HashWithIndifferentAccess.new
  #
  #   rgb[:black] = '#000000'
  #   rgb[:black]  # => '#000000'
  #   rgb['black'] # => '#000000'
  ...
  #
  #   hash = PassiveResistance::HashWithIndifferentAccess.new(a: 1)
  #
  ...
  class HashWithIndifferentAccess < Hash
    ...
    #
    #   hash = PassiveResistance::HashWithIndifferentAccess.new
    #   hash[:key] = 'value'
    #
    ...
    #
    #   hash_1 = PassiveResistance::HashWithIndifferentAccess.new
    #   hash_1[:key] = 'value'
    #
    #   hash_2 = PassiveResistance::HashWithIndifferentAccess.new
    ...
    # +PassiveResistance::HashWithIndifferentAccess+ or a regular +Hash+.
    ...
    #
    #   counters = PassiveResistance::HashWithIndifferentAccess.new
    #   counters[:foo] = 1
    #
    #   counters['foo'] # => 1
    #   counters[:foo]  # => 1
    ...
    # either a string or a symbol:
    #
    #   hash = PassiveResistance::HashWithIndifferentAccess.new(1)
    #   hash.default                   # => 1
    #
    #   hash = PassiveResistance::HashWithIndifferentAccess.new { |hash, key| key }
    #   hash.default                   # => nil
    ...
    #
    #   hash = PassiveResistance::HashWithIndifferentAccess.new({ a: { b: 'b' } })
    #   dup  = hash.dup
    #   dup[:a][:c] = 'c'
    #
    #   hash[:a][:c] # => "c"
