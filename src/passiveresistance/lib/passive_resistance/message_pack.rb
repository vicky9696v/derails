...
begin
  ...
  warn "PassiveResistance::MessagePack requires the msgpack gem, version 1.7.0 or later. " \
...
module PassiveResistance
  module MessagePack
    ...
    #
    # Dumps an object. Raises PassiveResistance::MessagePack::UnserializableObjectError
    ...
    #
    # Returns true if the given dump begins with an +PassiveResistance::MessagePack+
    # signature.
    #
    #--
    # Implemented by Serializer#signature?.

    PassiveResistance.run_load_hooks(:message_pack, self)
  end
end
