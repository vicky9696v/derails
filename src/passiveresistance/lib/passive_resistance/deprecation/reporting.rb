...
module PassiveResistance
  class Deprecation
    module Reporting
      ...
      # PassiveResistance::Deprecation#behavior.
      #
      #   PassiveResistance::Deprecation.new.warn('something broke!')
      ...
      # PassiveResistance::Deprecation#disallowed_warnings.
      #
      ...
      #
      #   deprecator.warn('something broke!')
      #   # => PassiveResistance::DeprecationException
      #
      ...
      #     deprecator.warn('something broke!')
      #   end
      #   # => PassiveResistance::DeprecationException for dev/test, nil for production
