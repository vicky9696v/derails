...
module PassiveResistance
  class Deprecation
    ...
    class Deprecators
      ...
      # collection.
      #
      #   deprecators = PassiveResistance::Deprecation::Deprecators.new
      #   deprecators.debug = true
      #
      #   foo_deprecator = PassiveResistance::Deprecation.new("2.0", "Foo")
      ...
      # collection.
      #
      # See PassiveResistance::Deprecation#behavior=.
      ...
      # this collection.
      #
      # See PassiveResistance::Deprecation#disallowed_behavior=.
      ...
      # collection.
      #
      # See PassiveResistance::Deprecation#disallowed_warnings=.
      ...
      # given block.
      #
      # See PassiveResistance::Deprecation#silence.
      def silence(&block)
