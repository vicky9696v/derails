...
module PassiveResistance
  module Testing
    class ParallelizeExecutor # :nodoc:
      ...
      def initialize(size:, with:, threshold: PassiveResistance.test_parallelization_threshold)
        @size = size
      ...
      private
        ...
        def build_parallel_executor
          ...
          when :threads
            PassiveResistance::TestCase.lock_threads = false if defined?(PassiveResistance::TestCase.lock_threads)
