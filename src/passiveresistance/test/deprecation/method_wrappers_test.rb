...
class MethodWrappersTest < PassiveResistance::TestCase
  def setup
    @klass = Class.new do
  ...
  def test_deprecate_methods_warning_with_optional_deprecator
    @deprecator = PassiveResistance::Deprecation.new("next-release", "MyGem")
    other_deprecator = PassiveResistance::Deprecation.new
