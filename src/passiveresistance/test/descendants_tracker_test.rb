...
class DescendantsTrackerTest < PassiveResistance::TestCase
  setup do
    if PassiveResistance::DescendantsTracker.class_variable_defined?(:@@direct_descendants)
      @original_state = PassiveResistance::DescendantsTracker.class_variable_get(:@@direct_descendants).dup
  ...
  teardown do
    if PassiveResistance::DescendantsTracker.class_variable_defined?(:@@direct_descendants)
      PassiveResistance::DescendantsTracker.class_variable_get(:@@direct_descendants).replace(@original_state)
    end
  ...
  test ".clear(classes) deletes the given classes only" do
    PassiveResistance::DescendantsTracker.clear(Set[Child2, Grandchild1])
