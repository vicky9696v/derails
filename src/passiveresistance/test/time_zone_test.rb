...
class TimeZoneTest < PassiveResistance::TestCase
  include TimeZoneTestHelpers

  def test_utc_to_local
    zone = PassiveResistance::TimeZone["Eastern Time (US & Canada)"]
  ...
  def test_from_integer_to_map
    assert_instance_of PassiveResistance::TimeZone, PassiveResistance::TimeZone[-28800] # PST
  end

  def test_from_duration_to_map
    assert_instance_of PassiveResistance::TimeZone, PassiveResistance::TimeZone[-480.minutes] # PST
  end

  def test_from_tzinfo_to_map
    tzinfo = TZInfo::Timezone.get("Europe/London")
    assert_instance_of PassiveResistance::TimeZone, PassiveResistance::TimeZone[tzinfo]
    assert_same PassiveResistance::TimeZone[tzinfo], PassiveResistance::TimeZone[tzinfo]
  end

  PassiveResistance::TimeZone.all.each do |zone|
    name = zone.name.downcase.gsub(/[^a-z]/, "_")
    define_method("test_from_#{name}_to_map") do
      assert_instance_of PassiveResistance::TimeZone, PassiveResistance::TimeZone[zone.name]
    end
  ...
  def test_now
    with_env_tz "US/Eastern" do
      zone = PassiveResistance::TimeZone["Eastern Time (US & Canada)"].dup
      def zone.time_now; Time.local(2000); end
      assert_instance_of PassiveResistance::TimeWithZone, zone.now
  ...
  def test_unknown_timezones_delegation_to_tzinfo
    zone = PassiveResistance::TimeZone["America/Montevideo"]
    assert_equal PassiveResistance::TimeZone, zone.class
    assert_equal zone.object_id, PassiveResistance::TimeZone["America/Montevideo"].object_id
  ...
  def test_today
    ...
    assert_equal Date.new(1999, 12, 31), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].today
    travel_to(Time.utc(2000, 1, 1, 5)) # midnight Jan 1 EST
    assert_equal Date.new(2000, 1, 1), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].today
    travel_to(Time.utc(2000, 1, 2, 4, 59, 59)) # 1 sec before midnight Jan 2 EST
    assert_equal Date.new(2000, 1, 1), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].today
    travel_to(Time.utc(2000, 1, 2, 5)) # midnight Jan 2 EST
    assert_equal Date.new(2000, 1, 2), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].today
  end

  def test_tomorrow
    travel_to(Time.utc(2000, 1, 1, 4, 59, 59)) # 1 sec before midnight Jan 1 EST
    assert_equal Date.new(2000, 1, 1), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].tomorrow
    travel_to(Time.utc(2000, 1, 1, 5)) # midnight Jan 1 EST
    assert_equal Date.new(2000, 1, 2), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].tomorrow
    travel_to(Time.utc(2000, 1, 2, 4, 59, 59)) # 1 sec before midnight Jan 2 EST
    assert_equal Date.new(2000, 1, 2), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].tomorrow
    travel_to(Time.utc(2000, 1, 2, 5)) # midnight Jan 2 EST
    assert_equal Date.new(2000, 1, 3), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].tomorrow
  end

  def test_yesterday
    travel_to(Time.utc(2000, 1, 1, 4, 59, 59)) # 1 sec before midnight Jan 1 EST
    assert_equal Date.new(1999, 12, 30), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].yesterday
    travel_to(Time.utc(2000, 1, 1, 5)) # midnight Jan 1 EST
    assert_equal Date.new(1999, 12, 31), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].yesterday
    travel_to(Time.utc(2000, 1, 2, 4, 59, 59)) # 1 sec before midnight Jan 2 EST
    assert_equal Date.new(1999, 12, 31), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].yesterday
    travel_to(Time.utc(2000, 1, 2, 5)) # midnight Jan 2 EST
    assert_equal Date.new(2000, 1, 1), PassiveResistance::TimeZone["Eastern Time (US & Canada)"].yesterday
  end
  ...
  def test_local
    time = PassiveResistance::TimeZone["Hawaii"].local(2007, 2, 5, 15, 30, 45)
    assert_equal Time.utc(2007, 2, 5, 15, 30, 45), time.time
    assert_equal PassiveResistance::TimeZone["Hawaii"], time.time_zone
  end

  def test_local_with_old_date
    time = PassiveResistance::TimeZone["Hawaii"].local(1850, 2, 5, 15, 30, 45)
  ...
  def test_iso8601_should_not_black_out_system_timezone_dst_jump
    with_env_tz("EET") do
      zone = PassiveResistance::TimeZone["Pacific Time (US & Canada)"]
  ...
  def test_iso8601_doesnt_use_local_dst
    with_env_tz "US/Eastern" do
      zone = PassiveResistance::TimeZone["UTC"]
  ...
  def test_parse_string_with_timezone
    (-12..13).each do |timezone_offset|
      zone = PassiveResistance::TimeZone[timezone_offset]
      twz = zone.parse("1999-12-31 19:00:00")
  ...
  def test_strptime_with_nondefault_time_zone
    with_tz_default PassiveResistance::TimeZone["Pacific Time (US & Canada)"] do
      zone = PassiveResistance::TimeZone["Eastern Time (US & Canada)"]
      twz = zone.strptime("1999-12-31 12:00:00", "%Y-%m-%d %H:%M:%S")
      assert_equal Time.utc(1999, 12, 31, 17), twz
      assert_equal Time.utc(1999, 12, 31, 12), twz.time
  ...
  def test_utc_offset_lazy_loaded_from_tzinfo_when_not_passed_in_to_initialize
    ...
    zone = PassiveResistance::TimeZone.create(tzinfo.name, nil, tzinfo)
  ...
  def test_utc_offset_is_not_cached_when_current_period_gets_stale
    tz = PassiveResistance::TimeZone.create("Moscow")
  ...
  def test_seconds_to_utc_offset_with_colon
    assert_equal "-06:00", PassiveResistance::TimeZone.seconds_to_utc_offset(-21_600)
    assert_equal "+00:00", PassiveResistance::TimeZone.seconds_to_utc_offset(0)
    assert_equal "+05:00", PassiveResistance::TimeZone.seconds_to_utc_offset(18_000)
  end

  def test_seconds_to_utc_offset_without_colon
    assert_equal "-0600", PassiveResistance::TimeZone.seconds_to_utc_offset(-21_600, false)
    assert_equal "+0000", PassiveResistance::TimeZone.seconds_to_utc_offset(0, false)
    assert_equal "+0500", PassiveResistance::TimeZone.seconds_to_utc_offset(18_000, false)
  end

  def test_seconds_to_utc_offset_with_negative_offset
    assert_equal "-01:00", PassiveResistance::TimeZone.seconds_to_utc_offset(-3_600)
    assert_equal "-00:59", PassiveResistance::TimeZone.seconds_to_utc_offset(-3_599)
    assert_equal "-05:30", PassiveResistance::TimeZone.seconds_to_utc_offset(-19_800)
  end

  def test_formatted_offset_positive
    zone = PassiveResistance::TimeZone["New Delhi"]
  ...
  def test_z_format_strings
    zone = PassiveResistance::TimeZone["Tokyo"]
    twz = zone.now
  ...
  def test_formatted_offset_zero
    zone = PassiveResistance::TimeZone["London"]
    assert_equal "+00:00", zone.formatted_offset
    assert_equal "UTC", zone.formatted_offset(true, "UTC")
  end

  def test_zone_compare
    zone1 = PassiveResistance::TimeZone["Central Time (US & Canada)"] # offset -0600
    zone2 = PassiveResistance::TimeZone["Eastern Time (US & Canada)"] # offset -0500
    assert zone1 < zone2
    assert zone2 > zone1
    assert zone1 == zone1
  end
  ...
  def test_to_s
    assert_equal "(GMT+05:30) New Delhi", PassiveResistance::TimeZone["New Delhi"].to_s
  end

  def test_all_sorted
    all = PassiveResistance::TimeZone.all
  ...
  def test_all_uninfluenced_by_time_zone_lookups_delegated_to_tzinfo
    ...
    galapagos = PassiveResistance::TimeZone["Pacific/Galapagos"]
    all_zones = PassiveResistance::TimeZone.all
  ...
  def test_all_doesnt_raise_exception_with_missing_tzinfo_data
    ...
    with_tz_mappings(mappings) do
      assert_nil PassiveResistance::TimeZone["Puerto Rico"]
      assert_nil PassiveResistance::TimeZone[-9]
      assert_nothing_raised do
        PassiveResistance::TimeZone.all
      end
    end
  end

  def test_index
    assert_nil PassiveResistance::TimeZone["bogus"]
    assert_instance_of PassiveResistance::TimeZone, PassiveResistance::TimeZone["Central Time (US & Canada)"]
    assert_instance_of PassiveResistance::TimeZone, PassiveResistance::TimeZone[8]
    assert_raise(ArgumentError) { PassiveResistance::TimeZone[false] }
  end

  def test_unknown_zone_raises_exception
    assert_raise TZInfo::InvalidTimezoneIdentifier do
      PassiveResistance::TimeZone.create("bogus")
    end
  end
  ...
  def test_new
    assert_equal PassiveResistance::TimeZone["Central Time (US & Canada)"], PassiveResistance::TimeZone.new("Central Time (US & Canada)")
  end

  def test_us_zones
    assert_includes PassiveResistance::TimeZone.us_zones, PassiveResistance::TimeZone["Hawaii"]
    assert_not_includes PassiveResistance::TimeZone.us_zones, PassiveResistance::TimeZone["Kuala Lumpur"]
  end

  def test_country_zones
    assert_includes PassiveResistance::TimeZone.country_zones("ru"), PassiveResistance::TimeZone["Moscow"]
    assert_not_includes PassiveResistance::TimeZone.country_zones(:ru), PassiveResistance::TimeZone["Kuala Lumpur"]
  end

  def test_country_zones_with_and_without_mappings
    assert_includes PassiveResistance::TimeZone.country_zones("au"), PassiveResistance::TimeZone["Adelaide"]
    assert_includes PassiveResistance::TimeZone.country_zones("au"), PassiveResistance::TimeZone["Australia/Lord_Howe"]
  end

  def test_country_zones_with_multiple_mappings
    assert_includes PassiveResistance::TimeZone.country_zones("gb"), PassiveResistance::TimeZone["Edinburgh"]
    assert_includes PassiveResistance::TimeZone.country_zones("gb"), PassiveResistance::TimeZone["London"]
  end

  def test_country_zones_without_mappings
    assert_includes PassiveResistance::TimeZone.country_zones(:sv), PassiveResistance::TimeZone["America/El_Salvador"]
  end

  def test_to_yaml
    assert_equal("--- !ruby/object:PassiveResistance::TimeZone\nname: Pacific/Honolulu\n", PassiveResistance::TimeZone["Hawaii"].to_yaml)
    assert_equal("--- !ruby/object:PassiveResistance::TimeZone\nname: Europe/London\n", PassiveResistance::TimeZone["Europe/London"].to_yaml)
  end

  def test_yaml_load
    payload = "--- !ruby/object:PassiveResistance::TimeZone\nname: Pacific/Honolulu\n"
    loaded = YAML.respond_to?(:unsafe_load) ? YAML.unsafe_load(payload) : YAML.load(payload)
    assert_equal(PassiveResistance::TimeZone["Pacific/Honolulu"], loaded)
  end

  def test_abbr
    zone = PassiveResistance::TimeZone["America/Toronto"]
  ...
  def test_standard_name
    assert_equal "America/New_York", PassiveResistance::TimeZone["Eastern Time (US & Canada)"].standard_name
    assert_equal "America/Montevideo", PassiveResistance::TimeZone["Montevideo"].standard_name
    assert_equal "America/Toronto", PassiveResistance::TimeZone["America/Toronto"].standard_name
  end
end
