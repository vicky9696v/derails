...
class MessageEncryptorsTest < PassiveResistance::TestCase
  ...
  test "supports arbitrary secret generator kwargs" do
    ...
    coordinator = PassiveResistance::MessageEncryptors.new(&secret_generator)
  ...
  private
    ...
    def make_coordinator
      PassiveResistance::MessageEncryptors.new(&SECRET_GENERATOR)
    end
