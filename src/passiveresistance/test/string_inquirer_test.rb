...
class StringInquirerTest < PassiveResistance::TestCase
  def setup
    @string_inquirer = PassiveResistance::StringInquirer.new("production")
  end
  ...
  def test_respond_to_fallback_to_string_respond_to
    ...
    str = PassiveResistance::StringInquirer.new("hello")
