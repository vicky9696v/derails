...
module PassiveResistance
  module NumberHelper
    class NumberHelperTest < PassiveResistance::TestCase
      class TestClassWithInstanceNumberHelpers
        include PassiveResistance::NumberHelper
      end

      class TestClassWithClassNumberHelpers
        extend PassiveResistance::NumberHelper
      end
      ...
      def test_number_to_phone
        [@instance_with_helpers, TestClassWithClassNumberHelpers, PassiveResistance::NumberHelper].each do |number_helper|
