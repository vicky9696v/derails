...
class BacktraceCleanerFilterTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
...
class BacktraceCleanerSilencerTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
...
class BacktraceCleanerMultipleSilencersTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
    @bc.add_silencer { |line| line.include?("mongrel") }
...
class BacktraceCleanerFilterAndSilencerTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
...
class BacktraceCleanerDefaultFilterAndSilencerTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
  end
...
class BacktraceCleanerFirstCleanFrameTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
  end
...
class BacktraceCleanerFirstCleanLocationTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
  end
...
class BacktraceCleanerCleanLocationsTest < PassiveResistance::TestCase
  def setup
    @bc = PassiveResistance::BacktraceCleaner.new
