...
module PassiveResistance
  module Testing
    class NotificationAssertionsTest < PassiveResistance::TestCase
      include NotificationAssertions

      def test_assert_notification
        assert_notification("post.submitted", title: "Cool Post") do
          PassiveResistance::Notifications.instrument("post.submitted", title: "Cool Post")
        end

        assert_notification("post.submitted", title: "Cool Post") do # subset of payload
          PassiveResistance::Notifications.instrument("post.submitted", title: "Cool Post", body: "Cool Body")
        end
        ...
        assert_raises(Minitest::Assertion, match:) do
          assert_notification("post.submitted", title: "Cool Post") do
            PassiveResistance::Notifications.instrument("post.submitted", title: "Cooler Post")
          end
        end
