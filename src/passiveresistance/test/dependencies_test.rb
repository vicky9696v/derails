...
class RequireDependencyTest < PassiveResistance::TestCase
  setup do
    @loaded_features_copy = $LOADED_FEATURES.dup
    PassiveResistance::Dependencies.autoload_paths.clear

    @root_dir = Dir.mktmpdir
    File.write("#{@root_dir}/x.rb", "X = :X")
    PassiveResistance::Dependencies.autoload_paths << @root_dir
  end
