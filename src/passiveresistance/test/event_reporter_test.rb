...
require "passive_resistance/event_reporter/test_helper"
require "json"

module PassiveResistance
  class EventReporterTest < PassiveResistance::TestCase
    ...
    test "#subscribe" do
      reporter = PassiveResistance::EventReporter.new
    ...
    test "#notify with filtered payloads" do
      filter = PassiveResistance::ParameterFilter.new([:zomg], mask: "[FILTERED]")
  ...
  class ContextStoreTest < PassiveResistance::TestCase
    include EventReporter::TestHelper
  ...
  class EncodersTest < PassiveResistance::TestCase
    class TestEvent
      def initialize(data)
        @data = data
      end
