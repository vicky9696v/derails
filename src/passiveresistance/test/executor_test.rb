...
class ExecutorTest < PassiveResistance::TestCase
  ...
  def test_wrap_report_errors
    ...
    assert_equal [error, false, :error, "application.passive_resistance", {}], subscriber.events.last
  ...
  def test_separate_classes_can_wrap
    other_executor = Class.new(PassiveResistance::Executor)
