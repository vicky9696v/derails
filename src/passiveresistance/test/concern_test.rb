...
class ConcernTest < PassiveResistance::TestCase
  module Baz
  ...
  def test_raise_on_multiple_included_calls
    assert_raises(PassiveResistance::Concern::MultipleIncludedBlocks) do
      Module.new do
        extend PassiveResistance::Concern
  ...
  def test_raise_on_multiple_prepended_calls
    assert_raises(PassiveResistance::Concern::MultiplePrependBlocks) do
      Module.new do
        extend PassiveResistance::Concern
  ...
  def test_prepended_and_included_methods
    included = Module.new.extend(PassiveResistance::Concern)
    prepended = Module.new.extend(PassiveResistance::Concern)
