...
require "passive_resistance/continuous_integration"

class ContinuousIntegrationTest < PassiveResistance::TestCase
  setup { @CI = PassiveResistance::ContinuousIntegration.new }
