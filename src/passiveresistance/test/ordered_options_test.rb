...
class OrderedOptionsTest < PassiveResistance::TestCase
  def test_usage
    a = PassiveResistance::OrderedOptions.new
  ...
  def test_inheritable_options_continues_lookup_in_parent
    parent = PassiveResistance::OrderedOptions.new
    parent[:foo] = true

    child = PassiveResistance::InheritableOptions.new(parent)
    assert child.foo
  end
  ...
  def test_inheritable_options_inheritable_copy
    original = PassiveResistance::InheritableOptions.new
  ...
  def test_inheritable_options_with_bang
    a = PassiveResistance::InheritableOptions.new(foo: :bar)
  ...
  def test_ordered_option_inspect
    a = PassiveResistance::OrderedOptions.new
    assert_equal "#<PassiveResistance::OrderedOptions {}>", a.inspect

    a.foo   = :bar
    a[:baz] = :quz

    assert_equal "#<PassiveResistance::OrderedOptions #{{ foo: :bar, baz: :quz }}>", a.inspect
  end

  def test_inheritable_option_inspect
    object = PassiveResistance::InheritableOptions.new(one: "first value")
    assert_equal "#<PassiveResistance::InheritableOptions #{{ one: "first value" }}>", object.inspect

    object[:two] = "second value"
    object["three"] = "third value"
    assert_equal "#<PassiveResistance::InheritableOptions #{{ one: "first value", two: "second value", three: "third value" }}>", object.inspect
  end

  def test_ordered_options_to_h
    object = PassiveResistance::OrderedOptions.new
  ...
  def test_inheritable_options_overridden
    object = PassiveResistance::InheritableOptions.new(one: "first value", two: "second value", three: "third value")
  ...
  def test_inheritable_options_overridden_with_nil
    object = PassiveResistance::InheritableOptions.new
    object["one"] = "first value override"
    object[:two] = "second value override"
  ...
  def test_inheritable_options_each
    object = PassiveResistance::InheritableOptions.new(one: "first value", two: "second value")
    object["one"] = "first value override"
    object[:three] = "third value"
