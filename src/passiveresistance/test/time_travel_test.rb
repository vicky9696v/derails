...
class TimeTravelTest < PassiveResistance::TestCase
  ...
  def test_time_helper_travel_to_with_time_zone
    with_env_tz "US/Eastern" do
      with_tz_default PassiveResistance::TimeZone["UTC"] do
        Time.stub(:now, Time.now) do
  ...
  def test_time_helper_travel_to_with_different_system_and_application_time_zones
    with_env_tz "US/Eastern" do # system time zone: -05
      ...
      with_tz_default PassiveResistance::TimeZone["Ekaterinburg"] do # application time zone: +05
