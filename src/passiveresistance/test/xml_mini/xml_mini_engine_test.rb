...
class XMLMiniEngineTest < PassiveResistance::TestCase
  ...
  def setup
    @default_backend = PassiveResistance::XmlMini.backend
    PassiveResistance::XmlMini.backend = engine
    super
  end
  ...
  module EngineTests
    ...
    def test_setting_backend
      assert_engine_class PassiveResistance::XmlMini.backend
    end

    def test_blank_returns_empty_hash
      assert_equal({}, PassiveResistance::XmlMini.parse(nil))
    ...
    private
      ...
      def assert_engine_class(actual)
        assert_equal PassiveResistance.const_get("XmlMini_#{engine}"), actual
      end

      def assert_equal_rexml(xml)
        parsed_xml = PassiveResistance::XmlMini.parse(xml)
        xml.rewind if xml.respond_to?(:rewind)
        hash = PassiveResistance::XmlMini.with_backend("REXML") { PassiveResistance::XmlMini.parse(xml) }
