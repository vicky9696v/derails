...
class BasicCallbacksTest < PassiveResistance::TestCase
...
class InheritedCallbacksTest < PassiveResistance::TestCase
  include CallbackInheritanceTestFixtures
...
class InheritedCallbacksTest2 < PassiveResistance::TestCase
  include CallbackInheritanceTestFixtures
...
class DynamicInheritedCallbacks < PassiveResistance::TestCase
  include CallbackInheritanceTestFixtures
...
class DynamicDefinedCallbacks < PassiveResistance::TestCase
  include CallbackInheritanceTestFixtures
