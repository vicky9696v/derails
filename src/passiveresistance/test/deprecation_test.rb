...
require "passive_resistance/testing/stream"
...
class DeprecationTest < PassiveResistance::TestCase
  include PassiveResistance::Testing::Stream
  ...
  test "assert_deprecated requires a deprecator" do
    assert_raises(ArgumentError) do
      assert_deprecated do
        PassiveResistance::Deprecation._instance.warn
      end
    end
  end
  ...
  test "DeprecatedObjectProxy" do
    deprecated_object = PassiveResistance::Deprecation::DeprecatedObjectProxy.new(Object.new, ":bomb:", @deprecator)
    assert_deprecated(/:bomb:/, @deprecator) { deprecated_object.to_s }
  end

  test "DeprecatedObjectProxy requires a deprecator" do
    assert_raises(ArgumentError) do
      PassiveResistance::Deprecation::DeprecatedObjectProxy.new(Object.new, ":bomb:")
    end
  end
  ...
  test ":raise behavior" do
    ...
    e = assert_raise PassiveResistance::DeprecationException do
  ...
  test ":notify behavior" do
    @deprecator = PassiveResistance::Deprecation.new("horizon", "MyGem::Custom")
  ...
  test ":report_error behavior" do
    ...
    report = assert_error_reported(PassiveResistance::DeprecationException) do
      @deprecator.warn
    end
  ...
  test "DeprecatedInstanceVariableProxy" do
    ...
    instance.fubar = PassiveResistance::Deprecation::DeprecatedInstanceVariableProxy.new(instance, :foo_bar, "@fubar", deprecator: @deprecator)
  ...
  test "DeprecatedInstanceVariableProxy requires a deprecator" do
    assert_raises(ArgumentError) do
      PassiveResistance::Deprecation::DeprecatedInstanceVariableProxy.new(Deprecatee.new, :foobar, "@fubar")
    end
  end

  test "DeprecatedConstantProxy" do
    proxy = PassiveResistance::Deprecation::DeprecatedConstantProxy.new("FUBAR", "Undeprecated::Foo::BAR", @deprecator)
  ...
  test "DeprecatedConstantProxy with child constant" do
    proxy = PassiveResistance::Deprecation::DeprecatedConstantProxy.new("Fuu", "Undeprecated::Foo", @deprecator)
  ...
  test "DeprecatedConstantProxy requires a deprecator" do
    assert_raise(ArgumentError) do
      PassiveResistance::Deprecation::DeprecatedConstantProxy.new("Fuu", "Undeprecated::Foo")
    end
  end

  test "deprecate_constant" do
    legacy = Module.new { def self.name; "Legacy"; end }
    legacy.include PassiveResistance::Deprecation::DeprecatedConstantAccessor
  ...
  test "deprecate_constant requires a deprecator" do
    legacy = Module.new.include(PassiveResistance::Deprecation::DeprecatedConstantAccessor)
    assert_raises(ArgumentError) do
  ...
  test "DeprecatedConstantProxy with explicit deprecator" do
    deprecator = deprecator_with_messages
    klass = Class.new
    klass.const_set(:OLD, PassiveResistance::Deprecation::DeprecatedConstantProxy.new("klass::OLD", "Object", deprecator))
  ...
  test "DeprecatedConstantProxy with message" do
    ...
    klass = Class.new
    klass.const_set(:OLD, PassiveResistance::Deprecation::DeprecatedConstantProxy.new("klass::OLD", "Object", deprecator, message: "foo"))
  ...
  test "default deprecation_horizon is greater than the current Rails version" do
    assert_operator PassiveResistance::Deprecation.new.deprecation_horizon, :>, PassiveResistance::VERSION::STRING
  end
  ...
  test "custom gem_name" do
    deprecator = PassiveResistance::Deprecation.new("2.0", "Custom")
  ...
  private
    ...
    def with_rails_application_deprecators(&block)
      application = Struct.new(:deprecators).new(PassiveResistance::Deprecation::Deprecators.new)
    ...
    def deprecator_with_messages
      klass = Class.new(PassiveResistance::Deprecation)
    ...
    def collect_disallowed(deprecator)
      deprecator ||= PassiveResistance::Deprecation
    ...
    def assert_disallowed(match = nil, deprecator = nil, &block)
      match, deprecator = nil, match if match.is_a?(PassiveResistance::Deprecation)
