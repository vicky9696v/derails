...
module CallbacksTest
  ...
  class OneTimeCompileTest < PassiveResistance::TestCase
  ...
  class AfterSaveConditionalPersonCallbackTest < PassiveResistance::TestCase
  ...
  class AroundCallbacksTest < PassiveResistance::TestCase
  ...
  class DoubleYieldTest < PassiveResistance::TestCase
  ...
  class CallStackTest < PassiveResistance::TestCase
    def test_tidy_call_stack
      ...
      if RUBY_VERSION >= "3.4"
        assert_equal [
          ...
          "block in PassiveResistance::Callbacks#run_callbacks",
          ...
          "block in PassiveResistance::Callbacks#run_callbacks",
          "PassiveResistance::Callbacks#run_callbacks",
  ...
  class AroundCallbackResultTest < PassiveResistance::TestCase
    def test_save_around
  ...
  class SkipCallbacksTest < PassiveResistance::TestCase
  ...
  class CallbacksTest < PassiveResistance::TestCase
  ...
  class ConditionalCallbackTest < PassiveResistance::TestCase
  ...
  class ResetCallbackTest < PassiveResistance::TestCase
    def test_save_conditional_person
  ...
  class UsingObjectTest < PassiveResistance::TestCase
  ...
  class CallbackTerminatorTest < PassiveResistance::TestCase
  ...
  class CallbackTerminatorSkippingAfterCallbacksTest < PassiveResistance::TestCase
  ...
  class CallbackDefaultTerminatorTest < PassiveResistance::TestCase
  ...
  class CallbackFalseTerminatorTest < PassiveResistance::TestCase
  ...
  class HyphenatedKeyTest < PassiveResistance::TestCase
    def test_save
  ...
  class WriterCallbacksTest < PassiveResistance::TestCase
  ...
  class ExtendCallbacksTest < PassiveResistance::TestCase
    def test_save
  ...
  class ExcludingDuplicatesCallbackTest < PassiveResistance::TestCase
  ...
  class CallbackProcTest < PassiveResistance::TestCase
  ...
  class ConditionalTests < PassiveResistance::TestCase
    def build_class(callback)
      Class.new {
        include PassiveResistance::Callbacks
        define_callbacks :foo
  ...
  class CallbackTypeTest < PassiveResistance::TestCase
  ...
  class NotSupportedStringConditionalTest < PassiveResistance::TestCase
  ...
  class NotPermittedStringCallbackTest < PassiveResistance::TestCase
  ...
  class RunSpecificCallbackTest < PassiveResistance::TestCase
