...
require "passive_resistance/core_ext/integer"

class NumericExtTimeAndDateTimeTest < PassiveResistance::TestCase
  def setup
...
class NumericExtDateTest < PassiveResistance::TestCase
  def setup
    @today = Date.today
  end
...
class NumericExtSizeTest < PassiveResistance::TestCase
...
class NumericExtFormattingTest < PassiveResistance::TestCase
