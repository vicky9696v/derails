...
class TimeExtCalculationsTest < PassiveResistance::TestCase
  ...
  def test_advance
    ...
    assert_equal Time.new(2021, 5, 29, 0, 0, 0, "+03:00"), Time.new(2021, 5, 29, 0, 0, 0, PassiveResistance::TimeZone["Moscow"])
    assert_equal Time.new(2021, 5, 29, 0, 0, 0, "+03:00").advance(seconds: 60), Time.new(2021, 5, 29, 0, 0, 0, PassiveResistance::TimeZone["Moscow"]).advance(seconds: 60)
    assert_equal Time.new(2021, 5, 29, 0, 0, 0, "+03:00").advance(days: 3), Time.new(2021, 5, 29, 0, 0, 0, PassiveResistance::TimeZone["Moscow"]).advance(days: 3)

    assert_equal Time.new(2021, 5, 29, 0, 0, 0, "+03:00"), PassiveResistance::TimeZone["Moscow"].local(2021, 5, 29, 0, 0, 0)
    assert_equal Time.new(2021, 5, 29, 0, 0, 0, "+03:00").advance(seconds: 60), PassiveResistance::TimeZone["Moscow"].local(2021, 5, 29, 0, 0, 0).advance(seconds: 60)
    assert_equal Time.new(2021, 5, 29, 0, 0, 0, "+03:00").advance(days: 3), PassiveResistance::TimeZone["Moscow"].local(2021, 5, 29, 0, 0, 0).advance(days: 3)
  end
  ...
  def test_compare_with_time_with_zone
    assert_equal 1, Time.utc(2000) <=> PassiveResistance::TimeWithZone.new(Time.utc(1999, 12, 31, 23, 59, 59), PassiveResistance::TimeZone["UTC"])
    assert_equal 0, Time.utc(2000) <=> PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), PassiveResistance::TimeZone["UTC"])
    assert_equal(-1, Time.utc(2000) <=> PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 1), PassiveResistance::TimeZone["UTC"]))
  end
  ...
  def test_at_with_time_with_zone
    assert_equal Time.utc(2000, 1, 1, 0, 0, 0), Time.at(PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), PassiveResistance::TimeZone["UTC"]))

    # Only test this if the underlying Time.at raises a TypeError
    begin
      Time.at_without_coercion(Time.now, 0)
    rescue TypeError
      assert_raise(TypeError) { assert_equal(Time.utc(2000, 1, 1, 0, 0, 0), Time.at(PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), PassiveResistance::TimeZone["UTC"]), 0)) }
    end
  end
  ...
  def test_at_with_time_with_zone_returns_local_time
    with_env_tz "US/Eastern" do
      twz = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), PassiveResistance::TimeZone["London"])
      ...
      # Daylight savings
      twz = PassiveResistance::TimeWithZone.new(Time.utc(2000, 7, 1, 0, 0, 0), PassiveResistance::TimeZone["London"])
  ...
  def test_eql?
    assert_equal true, Time.utc(2000).eql?(PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["UTC"]))
    assert_equal true, Time.utc(2000).eql?(PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Hawaii"]))
    assert_equal false, Time.utc(2000, 1, 1, 0, 0, 1).eql?(PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["UTC"]))
  end

  def test_minus_with_time_with_zone
    assert_equal 86_400.0, Time.utc(2000, 1, 2) - PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), PassiveResistance::TimeZone["UTC"])
  end
  ...
  def test_case_equality
    ...
    assert Time === PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["UTC"])
    ...
    assert_equal false, Class.new(Time) === PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["UTC"])
  end
  ...
  def test_all_day_with_timezone
    beginning_of_day = PassiveResistance::TimeWithZone.new(nil, PassiveResistance::TimeZone["Hawaii"], Time.local(2011, 6, 7, 0, 0, 0))
    end_of_day = PassiveResistance::TimeWithZone.new(nil, PassiveResistance::TimeZone["Hawaii"], Time.local(2011, 6, 7, 23, 59, 59, Rational(999999999, 1000)))

    assert_equal beginning_of_day, PassiveResistance::TimeWithZone.new(Time.local(2011, 6, 7, 10, 10, 10), PassiveResistance::TimeZone["Hawaii"]).all_day.begin
    assert_equal end_of_day, PassiveResistance::TimeWithZone.new(Time.local(2011, 6, 7, 10, 10, 10), PassiveResistance::TimeZone["Hawaii"]).all_day.end
  end
...
class TimeExtMarshalingTest < PassiveResistance::TestCase
