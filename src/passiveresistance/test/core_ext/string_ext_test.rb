...
require "passive_resistance/core_ext/string"
...
class StringInflectionsTest < PassiveResistance::TestCase
...
class StringAccessTest < PassiveResistance::TestCase
...
class StringConversionsTest < PassiveResistance::TestCase
  include TimeZoneTestHelpers
  ...
  def test_string_to_time_utc_offset
    with_env_tz "US/Eastern" do
      if PassiveResistance.to_time_preserves_timezone
...
class StringBehaviorTest < PassiveResistance::TestCase
  def test_acts_like_string
    assert_predicate "Bambi", :acts_like_string?
  end
end

class CoreExtStringMultibyteTest < PassiveResistance::TestCase
  UTF8_STRING = "こにちわ"
  ...
  def test_mb_chars_returns_instance_of_proxy_class
    assert_deprecated PassiveResistance.deprecator do
      assert_kind_of PassiveResistance::Multibyte.proxy_class, UTF8_STRING.mb_chars
    end
  end
end

class OutputSafetyTest < PassiveResistance::TestCase
  def setup
    @string = +"hello"
...
class StringExcludeTest < PassiveResistance::TestCase
...
class StringIndentTest < PassiveResistance::TestCase
