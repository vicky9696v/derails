...
class TimeWithZoneTest < PassiveResistance::TestCase
  include TimeZoneTestHelpers

  def setup
    @utc = Time.utc(2000, 1, 1, 0)
    @time_zone = PassiveResistance::TimeZone["Eastern Time (US & Canada)"]
    @twz = PassiveResistance::TimeWithZone.new(@utc, @time_zone)
    @dt_twz = PassiveResistance::TimeWithZone.new(@utc.to_datetime, @time_zone)
  end
  ...
  def test_in_time_zone
    Time.use_zone "Alaska" do
      assert_equal PassiveResistance::TimeWithZone.new(@utc, PassiveResistance::TimeZone["Alaska"]), @twz.in_time_zone
    end
  end

  def test_in_time_zone_with_argument
    assert_equal PassiveResistance::TimeWithZone.new(@utc, PassiveResistance::TimeZone["Alaska"]), @twz.in_time_zone("Alaska")
  end

  def test_in_time_zone_with_new_zone_equal_to_old_zone_does_not_create_new_object
    assert_equal @twz.object_id, @twz.in_time_zone(PassiveResistance::TimeZone["Eastern Time (US & Canada)"]).object_id
  end
  ...
  def test_utc?
    ...
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["UTC"]).utc?
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Etc/UTC"]).utc?
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Universal"]).utc?
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["UCT"]).utc?
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Etc/UCT"]).utc?
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Etc/Universal"]).utc?

    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Africa/Abidjan"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Africa/Banjul"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Africa/Freetown"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["GMT"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["GMT0"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Greenwich"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Iceland"]).utc?
    assert_equal false, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Africa/Monrovia"]).utc?
  end

  def test_formatted_offset
    assert_equal "-05:00", @twz.formatted_offset
    assert_equal "-04:00", PassiveResistance::TimeWithZone.new(Time.utc(2000, 6), @time_zone).formatted_offset # dst
  end

  def test_dst?
    assert_equal false, @twz.dst?
    assert_equal true, PassiveResistance::TimeWithZone.new(Time.utc(2000, 6), @time_zone).dst?
  end

  def test_zone
    assert_equal "EST", @twz.zone
    assert_equal "EDT", PassiveResistance::TimeWithZone.new(Time.utc(2000, 6), @time_zone).zone # dst
  end

  def test_nsec
    local     = Time.local(2011, 6, 7, 23, 59, 59, Rational(999999999, 1000))
    with_zone = PassiveResistance::TimeWithZone.new(nil, PassiveResistance::TimeZone["Hawaii"], local)
  ...
  def test_inspect
    ...
    nsec          = PassiveResistance::TimeWithZone.new(nsec, @time_zone)
    ...
    hundred_nsec  = PassiveResistance::TimeWithZone.new(hundred_nsec, @time_zone)
    ...
    one_third_sec = PassiveResistance::TimeWithZone.new(one_third_sec, @time_zone)
  ...
  def test_to_yaml
    yaml = <<~EOF
      --- !ruby/object:PassiveResistance::TimeWithZone
      utc: 2000-01-01 00:00:00.000000000 Z
      zone: !ruby/object:PassiveResistance::TimeZone
        name: America/New_York
      time: 1999-12-31 19:00:00.000000000 Z
    EOF

    # TODO: Remove assertion in Rails 7.1
    assert_not_deprecated(PassiveResistance.deprecator) do
  ...
  def test_ruby_to_yaml
    yaml = <<~EOF
      ---
      twz: !ruby/object:PassiveResistance::TimeWithZone
        utc: 2000-01-01 00:00:00.000000000 Z
        zone: !ruby/object:PassiveResistance::TimeZone
          name: America/New_York
        time: 1999-12-31 19:00:00.000000000 Z
  ...
  def test_compare_with_time_with_zone
    assert_equal 1, @twz <=> PassiveResistance::TimeWithZone.new(Time.utc(1999, 12, 31, 23, 59, 59), PassiveResistance::TimeZone["UTC"])
    assert_equal 0, @twz <=> PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), PassiveResistance::TimeZone["UTC"])
    assert_equal(-1, @twz <=> PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 1), PassiveResistance::TimeZone["UTC"]))
  end
  ...
  def test_today
    Date.stub(:current, Date.new(2000, 1, 1)) do
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 23, 59, 59)).today?
      assert_equal true, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 1, 0)).today?
      assert_equal true, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 1, 23, 59, 59)).today?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 2, 0)).today?
    end
  end

  def test_yesterday?
    Date.stub(:current, Date.new(2000, 1, 1)) do
      assert_equal true,  PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 23, 59, 59)).yesterday?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 1, 0)).yesterday?
      assert_equal true,  PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31)).yesterday?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 2, 0)).yesterday?
    end
  end

  def test_prev_day?
    Date.stub(:current, Date.new(2000, 1, 1)) do
      assert_equal true,  PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 23, 59, 59)).prev_day?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 1, 0)).prev_day?
      assert_equal true,  PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31)).prev_day?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 2, 0)).prev_day?
    end
  end

  def test_tomorrow?
    Date.stub(:current, Date.new(2000, 1, 1)) do
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 23, 59, 59)).tomorrow?
      assert_equal true,  PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 2, 0)).tomorrow?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 1, 23, 59, 59)).tomorrow?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 0)).tomorrow?
    end
  end

  def test_next_day?
    Date.stub(:current, Date.new(2000, 1, 1)) do
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 23, 59, 59)).next_day?
      assert_equal true,  PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 2, 0)).next_day?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 1, 23, 59, 59)).next_day?
      assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 0)).next_day?
    end
  end
  ...
  def test_past_with_time_current_as_time_local
    with_env_tz "US/Eastern" do
      Time.stub(:current, Time.local(2005, 2, 10, 15, 30, 45)) do
        assert_equal true, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 44)).past?
        assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 45)).past?
        assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 46)).past?
      end
    end
  end

  def test_past_with_time_current_as_time_with_zone
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 45))
  ...
  def test_future_with_time_current_as_time_local
    with_env_tz "US/Eastern" do
      Time.stub(:current, Time.local(2005, 2, 10, 15, 30, 45)) do
        assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 44)).future?
        assert_equal false, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 45)).future?
        assert_equal true, PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.local(2005, 2, 10, 15, 30, 46)).future?
      end
    end
  end
  ...
  def test_before
    twz = PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 12, 0, 0), @time_zone)
    assert_equal false, twz.before?(PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 11, 59, 59), @time_zone))
    assert_equal false, twz.before?(PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 12, 0, 0), @time_zone))
    assert_equal true, twz.before?(PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 12, 00, 1), @time_zone))
  end

  def test_after
    twz = PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 12, 0, 0), @time_zone)
    assert_equal true, twz.after?(PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 11, 59, 59), @time_zone))
    assert_equal false, twz.after?(PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 12, 0, 0), @time_zone))
    assert_equal false, twz.after?(PassiveResistance::TimeWithZone.new(Time.utc(2017, 3, 6, 12, 00, 1), @time_zone))
  end

  def test_eql?
    assert_equal true, @twz.eql?(@twz.dup)
    assert_equal true, @twz.eql?(Time.utc(2000))
    assert_equal true, @twz.eql?(PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Hawaii"]))
    assert_equal false, @twz.eql?(Time.utc(2000, 1, 1, 0, 0, 1))
    assert_equal false, @twz.eql?(DateTime.civil(1999, 12, 31, 23, 59, 59))

    other_twz = PassiveResistance::TimeWithZone.new(DateTime.now.utc, @time_zone)
    assert_equal true, other_twz.eql?(other_twz.dup)
  end

  def test_hash
    assert_equal Time.utc(2000).hash, @twz.hash
    assert_equal Time.utc(2000).hash, PassiveResistance::TimeWithZone.new(Time.utc(2000), PassiveResistance::TimeZone["Hawaii"]).hash
  end
  ...
  def test_plus_with_integer_when_self_wraps_datetime
    ...
    twz = PassiveResistance::TimeWithZone.new(datetime, @time_zone)
    assert_equal DateTime.civil(1999, 12, 31, 19, 0, 5), (twz + 5).time
  end

  def test_no_limit_on_times
    twz = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), @time_zone)
  ...
  def test_minus_with_time
    assert_equal 86_400.0,  PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2), PassiveResistance::TimeZone["UTC"]) - Time.utc(2000, 1, 1)
    assert_equal 86_400.0,  PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2), PassiveResistance::TimeZone["Hawaii"]) - Time.utc(2000, 1, 1)
  end

  def test_minus_with_time_precision
    assert_equal 86_399.999999998,  PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2, 23, 59, 59, Rational(999999999, 1000)), PassiveResistance::TimeZone["UTC"]) - Time.utc(2000, 1, 2, 0, 0, 0, Rational(1, 1000))
    assert_equal 86_399.999999998,  PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2, 23, 59, 59, Rational(999999999, 1000)), PassiveResistance::TimeZone["Hawaii"]) - Time.utc(2000, 1, 2, 0, 0, 0, Rational(1, 1000))
  end

  def test_minus_with_time_with_zone
    twz1 = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), PassiveResistance::TimeZone["UTC"])
    twz2 = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2), PassiveResistance::TimeZone["UTC"])
  ...
  def test_minus_with_time_with_zone_without_preserve_configured
    with_preserve_timezone(nil) do
      ...
      difference = assert_not_deprecated(PassiveResistance.deprecator) { twz2 - twz1 }
      assert_equal 86_400.0, difference
    end
  end

  def test_minus_with_time_with_zone_precision
    twz1 = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0, Rational(1, 1000)), PassiveResistance::TimeZone["UTC"])
    twz2 = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 23, 59, 59, Rational(999999999, 1000)), PassiveResistance::TimeZone["UTC"])
    assert_equal 86_399.999999998,  twz2 - twz1
  end

  def test_minus_with_datetime
    assert_equal 86_400.0,  PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2), PassiveResistance::TimeZone["UTC"]) - DateTime.civil(2000, 1, 1)
  end

  def test_minus_with_datetime_precision
    assert_equal 86_399.999999999,  PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 23, 59, 59, Rational(999999999, 1000)), PassiveResistance::TimeZone["UTC"]) - DateTime.civil(2000, 1, 1)
  end

  def test_minus_with_wrapped_datetime
    assert_equal 86_400.0,  PassiveResistance::TimeWithZone.new(DateTime.civil(2000, 1, 2), PassiveResistance::TimeZone["UTC"]) - Time.utc(2000, 1, 1)
    assert_equal 86_400.0,  PassiveResistance::TimeWithZone.new(DateTime.civil(2000, 1, 2), PassiveResistance::TimeZone["UTC"]) - DateTime.civil(2000, 1, 1)
  end
  ...
  def test_to_a
    assert_equal [45, 30, 5, 1, 2, 2000, 2, 32, false, "HST"], PassiveResistance::TimeWithZone.new(Time.utc(2000, 2, 1, 15, 30, 45), PassiveResistance::TimeZone["Hawaii"]).to_a
  end

  def test_to_f
    result = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), PassiveResistance::TimeZone["Hawaii"]).to_f
    assert_equal 946684800.0, result
    assert_kind_of Float, result
  end

  def test_to_i
    result = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), PassiveResistance::TimeZone["Hawaii"]).to_i
  ...
  def test_to_r
    result = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), PassiveResistance::TimeZone["Hawaii"]).to_r
    assert_equal Rational(946684800, 1), result
    assert_kind_of Rational, result
  end

  def test_time_at
    time = PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1), PassiveResistance::TimeZone["Hawaii"])
  ...
  def test_to_time_without_preserve_timezone_configured
    with_preserve_timezone(nil) do
      with_env_tz "US/Eastern" do
        time = assert_deprecated(PassiveResistance.deprecator) { @twz.to_time }
        ...
        assert_equal false, PassiveResistance.to_time_preserves_timezone
      end
    end
  end
  ...
  def test_to_date
    ...
    assert_equal Date.new(1999, 12, 31), PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 4, 59, 59), PassiveResistance::TimeZone["Eastern Time (US & Canada)"]).to_date
    # midnight Jan 1 EST
    assert_equal Date.new(2000,  1,  1), PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 5,  0,  0), PassiveResistance::TimeZone["Eastern Time (US & Canada)"]).to_date
    # 1 sec before midnight Jan 2 EST
    assert_equal Date.new(2000,  1,  1), PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2, 4, 59, 59), PassiveResistance::TimeZone["Eastern Time (US & Canada)"]).to_date
    # midnight Jan 2 EST
    assert_equal Date.new(2000,  1,  2), PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 2, 5,  0,  0), PassiveResistance::TimeZone["Eastern Time (US & Canada)"]).to_date
  end
  ...
  def test_acts_like_time
    ...
    assert PassiveResistance::TimeWithZone.new(DateTime.civil(2000), @time_zone).acts_like?(:time)
  end

  def test_acts_like_date
    assert_equal false, @twz.acts_like?(:date)
    assert_equal false, PassiveResistance::TimeWithZone.new(DateTime.civil(2000), @time_zone).acts_like?(:date)
  end
  ...
  def test_is_a
    ...
    assert_kind_of Time, @twz
    assert_kind_of PassiveResistance::TimeWithZone, @twz
  end

  def test_method_missing_with_time_return_value
    assert_instance_of PassiveResistance::TimeWithZone, @twz.months_since(1)
  ...
  def test_marshal_dump_and_load
    ...
    assert_equal PassiveResistance::TimeZone["Eastern Time (US & Canada)"], mtime.time_zone
  ...
  def test_marshal_dump_and_load_with_tzinfo_identifier
    twz = PassiveResistance::TimeWithZone.new(@utc, TZInfo::Timezone.get("America/New_York"))
    marshal_str = Marshal.dump(twz)
    mtime = Marshal.load(marshal_str)
    assert_equal Time.utc(2000, 1, 1, 0), mtime.utc
    assert_predicate mtime.utc, :utc?
  ...
  def test_date_part_value_methods
    twz = PassiveResistance::TimeWithZone.new(Time.utc(1999, 12, 31, 19, 18, 17, 500), @time_zone)
  ...
  def test_usec_returns_0_when_datetime_is_wrapped
    twz = PassiveResistance::TimeWithZone.new(DateTime.civil(2000), @time_zone)
    assert_equal 0, twz.usec
  end

  def test_usec_returns_sec_fraction_when_datetime_is_wrapped
    twz = PassiveResistance::TimeWithZone.new(DateTime.civil(2000, 1, 1, 0, 0, Rational(1, 2)), @time_zone)
  ...
  def test_instance_created_with_local_time_returns_correct_utc_time
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(1999, 12, 31, 19))
    assert_equal Time.utc(2000), twz.utc
  end

  def test_instance_created_with_local_time_enforces_spring_dst_rules
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 4, 2, 2)) # first second of DST
  ...
  def test_instance_created_with_local_time_enforces_fall_dst_rules
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 10, 29, 1)) # 1AM can be either DST or non-DST; we'll pick DST
  ...
  def test_utc_to_local_conversion_with_far_future_datetime
    assert_equal [0, 0, 19, 31, 12, 2049], PassiveResistance::TimeWithZone.new(DateTime.civil(2050), @time_zone).to_a[0, 6]
  end

  def test_local_to_utc_conversion_with_far_future_datetime
    assert_equal DateTime.civil(2050).to_f, PassiveResistance::TimeWithZone.new(nil, @time_zone, DateTime.civil(2049, 12, 31, 19)).to_f
  end
  ...
  def test_change_at_dst_boundary
    twz = PassiveResistance::TimeWithZone.new(Time.at(1319936400).getutc, PassiveResistance::TimeZone["Madrid"])
  ...
  def test_advance_1_year_from_leap_day
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2004, 2, 29))
  ...
  def test_advance_1_month_from_last_day_of_january
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2005, 1, 31))
  ...
  def test_advance_1_month_from_last_day_of_january_during_leap_year
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2000, 1, 31))
  ...
  def test_advance_1_month_into_spring_dst_gap
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 3, 2, 2))
  ...
  def test_advance_1_second_into_spring_dst_gap
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 4, 2, 1, 59, 59))
  ...
  def test_advance_1_day_across_spring_dst_transition
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 4, 1, 10, 30))
  ...
  def test_advance_1_day_across_spring_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 4, 2, 10, 30))
    # In 2006, spring DST transition occurred Apr 2 at 2AM; this day was only 23 hours long
  ...
  def test_advance_1_day_expressed_as_number_of_seconds_minutes_or_hours_across_spring_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 4, 2, 11, 30))
    # In 2006, spring DST transition occurred Apr 2 at 2AM; this day was only 23 hours long
    # When we advance a specific number of hours, minutes or seconds, we want to advance exactly that amount
  ...
  def test_advance_1_day_across_fall_dst_transition
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 10, 28, 10, 30))
  ...
  def test_advance_1_day_across_fall_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 10, 29, 10, 30))
    # In 2006, fall DST transition occurred Oct 29 at 2AM; this day was 25 hours long
  ...
  def test_advance_1_day_expressed_as_number_of_seconds_minutes_or_hours_across_fall_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 10, 29, 9, 30))
    # In 2006, fall DST transition occurred Oct 29 at 2AM; this day was 25 hours long
    # When we advance a specific number of hours, minutes or seconds, we want to advance exactly that amount
  ...
  def test_advance_1_week_across_spring_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 4, 8, 10, 30))
  ...
  def test_advance_1_week_across_fall_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 11, 4, 10, 30))
  ...
  def test_advance_1_month_across_spring_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 5, 1, 10, 30))
  ...
  def test_advance_1_month_across_fall_dst_transition_backwards
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2006, 11, 28, 10, 30))
  ...
  def test_advance_1_year
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2008, 2, 15, 10, 30))
  ...
  def test_advance_1_year_during_dst
    twz = PassiveResistance::TimeWithZone.new(nil, @time_zone, Time.utc(2008, 7, 15, 10, 30))
  ...
  def test_no_method_error_has_proper_context
    ...
    assert_match(/undefined method [`']this_method_does_not_exist' for.*PassiveResistance::TimeWithZone/, e.message)
    assert_no_match "rescue", e.backtrace.first
  end
end

class TimeWithZoneMethodsForTimeAndDateTimeTest < PassiveResistance::TestCase
  include TimeZoneTestHelpers
  ...
  def test_localtime
    Time.zone = PassiveResistance::TimeZone["Eastern Time (US & Canada)"]
  ...
  def test_use_zone
    Time.zone = "Alaska"
    Time.use_zone "Hawaii" do
      assert_equal PassiveResistance::TimeZone["Hawaii"], Time.zone
    end
    assert_equal PassiveResistance::TimeZone["Alaska"], Time.zone
  end
  ...
  def test_time_zone_getter_and_setter
    Time.zone = PassiveResistance::TimeZone["Alaska"]
    assert_equal PassiveResistance::TimeZone["Alaska"], Time.zone
    Time.zone = "Alaska"
    assert_equal PassiveResistance::TimeZone["Alaska"], Time.zone
    Time.zone = -9.hours
  ...
  def test_time_zone_getter_and_setter_with_zone_default_set
    ...
    Time.zone_default = PassiveResistance::TimeZone["Alaska"]
    assert_equal PassiveResistance::TimeZone["Alaska"], Time.zone
    Time.zone = PassiveResistance::TimeZone["Hawaii"]
    assert_equal PassiveResistance::TimeZone["Hawaii"], Time.zone
    Time.zone = nil
    assert_equal PassiveResistance::TimeZone["Alaska"], Time.zone
  ensure
  ...
  def test_time_zone_setter_is_thread_safe
    Time.use_zone "Paris" do
      ...
      assert_equal PassiveResistance::TimeZone["Paris"], Time.zone
      assert_equal PassiveResistance::TimeZone["Alaska"], t1.value
      assert_equal PassiveResistance::TimeZone["Hawaii"], t2.value
    end
  end
  ...
  def test_time_zone_setter_with_tzinfo_timezone_object_wraps_in_rails_time_zone
    ...
    Time.zone = tzinfo
    assert_kind_of PassiveResistance::TimeZone, Time.zone
  ...
  def test_current_returns_time_now_when_zone_not_set
    with_env_tz "US/Eastern" do
      Time.stub(:now, Time.local(2000)) do
        assert_equal false, Time.current.is_a?(PassiveResistance::TimeWithZone)
  ...
  def test_current_returns_time_zone_now_when_zone_set
    ...
    with_env_tz "US/Eastern" do
      Time.stub(:now, Time.local(2000)) do
        assert_equal true, Time.current.is_a?(PassiveResistance::TimeWithZone)
...
class TimeWithZoneMethodsForDate < PassiveResistance::TestCase
  include TimeZoneTestHelpers
...
class TimeWithZoneMethodsForString < PassiveResistance::TestCase
  include TimeZoneTestHelpers
