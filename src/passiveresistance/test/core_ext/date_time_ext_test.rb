...
class DateTimeExtCalculationsTest < PassiveResistance::TestCase
  ...
  def test_compare_with_time_with_zone
    assert_equal 1, DateTime.civil(2000) <=> PassiveResistance::TimeWithZone.new(Time.utc(1999, 12, 31, 23, 59, 59), PassiveResistance::TimeZone["UTC"])
    assert_equal 0, DateTime.civil(2000) <=> PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 0), PassiveResistance::TimeZone["UTC"])
    assert_equal(-1, DateTime.civil(2000) <=> PassiveResistance::TimeWithZone.new(Time.utc(2000, 1, 1, 0, 0, 1), PassiveResistance::TimeZone["UTC"]))
  end
