...
class HashExtTest < PassiveResistance::TestCase
  def setup
    @strings = { "a" => 1, "b" => 2 }
...
class HashExtToParamTests < PassiveResistance::TestCase
...
class HashToXmlTest < PassiveResistance::TestCase
  def setup
  ...
  def test_from_xml_raises_on_disallowed_type_attributes
    assert_raise PassiveResistance::XMLConverter::DisallowedType do
  ...
  def test_empty_string_works_for_typecast_xml_value
    assert_nothing_raised do
      PassiveResistance::XMLConverter.new("").to_h
    end
  end
  ...
  def test_expansion_count_is_limited
    expected =
      case PassiveResistance::XmlMini.backend.name
      when "PassiveResistance::XmlMini_REXML";        RuntimeError
      when "PassiveResistance::XmlMini_Nokogiri";     Nokogiri::XML::SyntaxError
      when "PassiveResistance::XmlMini_NokogiriSAX";  RuntimeError
      when "PassiveResistance::XmlMini_LibXML";       LibXML::XML::Error
      when "PassiveResistance::XmlMini_LibXMLSAX";    LibXML::XML::Error
      end
