...
class ToSentenceTest < PassiveResistance::TestCase
  ...
  def test_always_returns_string
    assert_instance_of String, [PassiveResistance::SafeBuffer.new("one")].to_sentence
    assert_instance_of String, [PassiveResistance::SafeBuffer.new("one"), "two"].to_sentence
    assert_instance_of String, [PassiveResistance::SafeBuffer.new("one"), "two", "three"].to_sentence
  end
...
class ToFsTest < PassiveResistance::TestCase
  class TestDB
    def self.reset
      @@counter = 0
    end
...
class ToXmlTest < PassiveResistance::TestCase
