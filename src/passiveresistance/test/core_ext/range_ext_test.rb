...
require "passive_resistance/core_ext/range"

class RangeTest < PassiveResistance::TestCase
  ...
  def test_each_on_time_with_zone
    twz = PassiveResistance::TimeWithZone.new(nil, PassiveResistance::TimeZone["Eastern Time (US & Canada)"], Time.utc(2006, 11, 28, 10, 30))
