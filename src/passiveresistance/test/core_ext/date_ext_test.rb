...
class DateExtCalculationsTest < PassiveResistance::TestCase
  ...
  def test_yesterday_constructor_when_zone_is_set
    with_env_tz "UTC" do
      with_tz_default PassiveResistance::TimeZone["Eastern Time (US & Canada)"] do # UTC -5
  ...
  def test_tomorrow_constructor_when_zone_is_set
    with_env_tz "UTC" do
      with_tz_default PassiveResistance::TimeZone["Europe/Paris"] do # UTC +1
  ...
  def test_all_day_when_zone_is_set
    zone = PassiveResistance::TimeZone["Hawaii"]
    with_env_tz "UTC" do
      with_tz_default zone do
...
class DateExtBehaviorTest < PassiveResistance::TestCase
