...
class DateAndTimeCompatibilityTest < PassiveResistance::TestCase
  ...
  def test_time_to_time_on_utc_value_without_preserve_configured
    with_preserve_timezone(nil) do
      with_env_tz "US/Eastern" do
        ...
        converted_time = assert_deprecated(PassiveResistance.deprecator) { utc_time.to_time }
  ...
  def test_time_to_time_on_offset_value_without_preserve_configured
    with_preserve_timezone(nil) do
      with_env_tz "US/Eastern" do
        ...
        converted_time = assert_deprecated(PassiveResistance.deprecator) { foreign_time.to_time }
  ...
  def test_time_to_time_on_tzinfo_value_without_preserve_configured
    foreign_zone = PassiveResistance::TimeZone["America/Phoenix"]
  ...
  def test_twz_to_time_preserves_timezone
    with_preserve_timezone(true) do
      with_env_tz "US/Eastern" do
        source = PassiveResistance::TimeWithZone.new(@utc_time, @zone)
        time = source.to_time
        ...
        source = PassiveResistance::TimeWithZone.new(@date_time, @zone)
        time = source.to_time
  ...
  def test_twz_to_time_frozen_preserves_timezone
    with_preserve_timezone(true) do
      with_env_tz "US/Eastern" do
        source = PassiveResistance::TimeWithZone.new(@utc_time, @zone).freeze
        time = source.to_time
        ...
        source = PassiveResistance::TimeWithZone.new(@date_time, @zone).freeze
        time = source.to_time
  ...
  def test_to_time_preserves_timezone_is_deprecated
    current_preserve_tz = PassiveResistance.to_time_preserves_timezone

    assert_not_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone
    end

    assert_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone = :offset
    end

    assert_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone = false
    end

    assert_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone = nil
    end
    ...
    PassiveResistance.deprecator.silence do
      PassiveResistance.to_time_preserves_timezone = current_preserve_tz
    end
  end
  ...
  def test_to_time_preserves_timezone_supports_new_values
    ...
    assert_not_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone = :zone
    end
    ...
    assert_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone = true
    end
    ...
    assert_deprecated(PassiveResistance.deprecator) do
      PassiveResistance.to_time_preserves_timezone = :foo
    end
  ensure
    PassiveResistance.deprecator.silence do
      PassiveResistance.to_time_preserves_timezone = current_preserve_tz
