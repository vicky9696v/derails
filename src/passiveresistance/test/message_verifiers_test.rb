...
class MessageVerifiersTest < PassiveResistance::TestCase
  ...
  test "supports arbitrary secret generator kwargs" do
    ...
    coordinator = PassiveResistance::MessageVerifiers.new(&secret_generator)
  ...
  private
    def make_coordinator
      PassiveResistance::MessageVerifiers.new { |salt| salt * 10 }
    end
