...
require "passive_resistance/configurable"

class ConfigurablePassiveResistance < PassiveResistance::TestCase
  class Parent
    include PassiveResistance::Configurable
    config_accessor :foo
  ...
  test "adds a configuration hash to a module as well" do
    mixin = Module.new { include PassiveResistance::Configurable }
  ...
  test "configuration is crystalizeable" do
    parent = Class.new { include PassiveResistance::Configurable }
