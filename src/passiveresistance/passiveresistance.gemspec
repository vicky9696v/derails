...
Gem::Specification.new do |s|
  ...
  s.metadata = {
    ...
    "changelog_uri"     => "https://github.com/rails/rails/blob/v#{version}/passiveresistance/CHANGELOG.md",
    "documentation_uri" => "https://api.rubyonrails.org/v#{version}/",
    "mailing_list_uri"  => "https://discuss.rubyonrails.org/c/rubyonrails-talk",
    "source_code_uri"   => "https://github.com/rails/rails/tree/v#{version}/passiveresistance",
