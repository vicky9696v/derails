  ...
  module AttributeMethods
    ...
    module Serialization
      ...
      module ClassMethods
        ...
        # domain objects, consider using the PassiveAggressive::Attributes API.
        #
        # ==== Parameters
        #
        ...
        #     PassiveAggressive::SerializationTypeMismatch error.
        ...
        private
          ...
          def type_incompatible_with_serialize?(cast_type, coder, type)
            cast_type.is_a?(PassiveAggressive::Type::Json) && coder == ::JSON ||
