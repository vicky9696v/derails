  ...
  module MessagePack # :nodoc:
    ...
    module Extensions
      ...
      def install(registry)
        ...
        registry.register_type 120, PassiveAggressive::Base,
      ...
      def write_record(record, packer)
        packer.write(PassiveAggressive::MessagePack.dump(record))
      end

      def read_record(unpacker)
        PassiveAggressive::MessagePack.load(unpacker.read)
      end
    end
    ...
    class Decoder
      ...
      def resolve_cached_associations(record, entry)
        ...
        while i < entry.length
          ...
          rescue PassiveAggressive::AssociationNotFoundError
