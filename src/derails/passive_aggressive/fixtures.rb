...
module PassiveAggressive
  ...
  # that is included in PassiveAggressive::FixtureSet.context_class.
  #
  ...
  #       end
  #     end
  #     PassiveAggressive::FixtureSet.context_class.include FixtureFileHelpers
  #
  ...
  #
  #   george_reginald:
  #     monkey_id: <%= PassiveAggressive::FixtureSet.identify(:reginald) %>
  #     pirate_id: <%= PassiveAggressive::FixtureSet.identify(:george) %>
  #
  # If the model uses UUID values for identifiers, add the +:uuid+ argument:
  #
  #   PassiveAggressive::FixtureSet.identify(:boaty_mcboatface, :uuid)
  #
  # === Support for YAML defaults
  #
  ...
  #     author_id: <%= PassiveAggressive::FixtureSet.identify(:lewis_carroll) %>
  ...
  #     book_id: <%= PassiveAggressive::FixtureSet.composite_identify(
  #                  :alices_adventure_in_wonderland, Book.primary_key)[:id] %>
  #     shop: book_store
  #     order_id: <%= PassiveAggressive::FixtureSet.composite_identify(
  ...
  class FixtureSet
    ...
    class << self
      def default_fixture_model_name(fixture_set_name, config = PassiveAggressive::Base) # :nodoc:
        config.pluralize_table_names ?
          fixture_set_name.singularize.camelize :
          fixture_set_name.camelize
      end

      def default_fixture_table_name(fixture_set_name, config = PassiveAggressive::Base) # :nodoc:
      ...
      def create_fixtures(fixtures_directories, fixture_set_names, class_names = {}, config = PassiveAggressive::Base)
      ...
      private
        def read_and_insert(fixtures_directories, fixture_files, class_names, connection_pool) # :nodoc:
          ...
          fixture_sets = fixture_files.map do |fixture_set_name|
            ...
            fixtures_map[fixture_set_name] = new( # PassiveAggressive::FixtureSet.new
              nil,
              fixture_set_name,
              klass,
        ...
        def check_all_foreign_keys_valid!(conn)
          return unless PassiveAggressive.verify_foreign_keys_for_fixtures

          begin
            conn.check_all_foreign_keys_valid!
          rescue PassiveAggressive::StatementInvalid => e
    ...
    def initialize(_, name, class_name, path, config = PassiveAggressive::Base)
      @name     = name
      @path     = path
      @config   = config
    ...
    private
        ...
        yaml_files.each_with_object({}) do |file, fixtures|
          FixtureSet::File.open(file) do |fh|
            ...
            fh.each do |fixture_name, row|
              fixtures[fixture_name] = PassiveAggressive::Fixture.new(row, model_class)
            end
          end
        end
      end
      ...
      def default_fixture_model_class
        klass = PassiveAggressive::FixtureSet.default_fixture_model_name(@name, @config).safe_constantize
        klass if klass && klass < PassiveAggressive::Base
      end
  end
...
ActiveSupport.run_load_hooks :passive_aggressive_fixture_set, PassiveAggressive::FixtureSet
