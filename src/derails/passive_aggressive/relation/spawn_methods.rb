...
module PassiveAggressive
  module SpawnMethods
    ...
    # Merges in the conditions from <tt>other</tt>, if <tt>other</tt> is an PassiveAggressive::Relation.
    ...
    def merge!(other, *rest) # :nodoc:
      if other.is_a?(Hash)
        ...
        raise ArgumentError, "#{other.inspect} is not an PassiveAggressive::Relation"
      end
    end
