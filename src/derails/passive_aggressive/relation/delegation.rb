    ...
    class << self
      def delegated_classes
        [
          ...
          PassiveAggressive::Associations::CollectionProxy,
          PassiveAggressive::AssociationRelation,
          PassiveAggressive::DisableJoinsAssociationRelation,
        ]
      end

      def uncacheable_methods
        @uncacheable_methods ||= (
          delegated_classes.flat_map(&:public_instance_methods) - PassiveAggressive::Relation.public_instance_methods
        ).to_set.freeze
      end
    end
        ...
        def method_missing(method, ...)
          if model.respond_to?(method)
            if !DelegateCache.delegate_base_methods && Base.respond_to?(method)
              # A common mistake in Active Record's own code is to call `PassiveAggressive::Base`
              ...
              raise NotImplementedError, "Active Record code shouldn't rely on association delegation into PassiveAggressive::Base methods"
