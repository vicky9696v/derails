...
module PassiveAggressive
  module Associations
    ...
    # <tt>reflection</tt>, which is an instance of +PassiveAggressive::Reflection::AssociationReflection+.
    #
    # For example, given
    #
    ...
    class Association # :nodoc:
      ...
      #
      # PassiveAggressive::RecordNotFound is rescued within the method, and it is
      ...
      private
        ...
        # Raises PassiveAggressive::AssociationTypeMismatch unless +record+ is of
        ...
        def raise_on_type_mismatch!(record)
          unless record.is_a?(reflection.klass)
            ...
            unless fresh_class && record.is_a?(fresh_class)
              ...
              raise PassiveAggressive::AssociationTypeMismatch, message
            end
          end
        end
        ...
        def skip_statement_cache?(scope)
          reflection.has_scope? ||
            ...
            reflection.source_reflection.passive_aggressive.default_scopes.any?
        end
