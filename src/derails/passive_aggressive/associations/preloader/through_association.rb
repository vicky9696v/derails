      ...
      class ThroughAssociation < Association # :nodoc:
        ...
        private
          ...
          def source_preloaders
            @source_preloaders ||= PassiveAggressive::Associations::Preloader.new(records: middle_records, associations: source_reflection.name, scope: scope, associate_by_default: false).loaders
          end
          ...
          def through_preloaders
            @through_preloaders ||= PassiveAggressive::Associations::Preloader.new(records: owners, associations: through_reflection.name, scope: through_scope, associate_by_default: false).loaders
          end
