  ...
  module Associations
    ...
    class BelongsToAssociation < SingularAssociation # :nodoc:
      def handle_dependency
        ...
        when :destroy
          raise PassiveAggressive::Rollback unless target.destroy
        when :destroy_async
          if reflection.foreign_key.is_a?(Array)
            primary_key_column = reflection.passive_aggressive_primary_key
      ...
      def decrement_counters_before_last_save
        ...
        if foreign_key_was && model_was < PassiveAggressive::Base
