...
module PassiveAggressive
  module Associations
    ...
    class CollectionProxy < Relation
      ...
      # rules as PassiveAggressive::FinderMethods.find. Raises PassiveAggressive::RecordNotFound
      ...
      #   person.pets.find(4) # => PassiveAggressive::RecordNotFound: Couldn't find Pet with 'id'=4
      #
      ...
      # using the same rules as PassiveAggressive::FinderMethods.take.
      #
      #   class Person < PassiveAggressive::Base
      #     has_many :pets
      #   end
      ...
      #   # => PassiveAggressive::RecordInvalid: Validation failed: Name can't be blank
      def create!(attributes = {}, &block)
        @association.create!(attributes, &block)
      end
      ...
      # an PassiveAggressive::AssociationTypeMismatch error:
      #
      #   person.pets.replace(["doo", "ggie", "gaga"])
      #   # => PassiveAggressive::AssociationTypeMismatch: Pet expected, got String
      ...
      #
      #   Pet.find(1, 2, 3)
      #   # => PassiveAggressive::RecordNotFound: Couldn't find all Pets with 'id': (1, 2, 3)
      #
      ...
      #
      #   Pet.find(1, 3)
      #   # => PassiveAggressive::RecordNotFound: Couldn't find all Pets with 'id': (1, 3)
      #
      ...
      #
      #   Pet.find(1)
      #   # => PassiveAggressive::RecordNotFound: Couldn't find Pet with 'id'=1
      #
      ...
      #   person.pets       # => []
      #
      #   Pet.find(1, 2, 3) # => PassiveAggressive::RecordNotFound: Couldn't find all Pets with 'id': (1, 2, 3)
      #
      # You can pass +Integer+ or +String+ values, it finds the records
      ...
      #   person.pets       # => []
      #
      #   Pet.find(4, 5, 6) # => PassiveAggressive::RecordNotFound: Couldn't find all Pets with 'id': (4, 5, 6)
      def destroy(*records)
      ...
      #   # => #<PassiveAggressive::Associations::HasManyAssociation owner="#<Person:0x00>">
      #
