...
module PassiveAggressive
  module Querying
    ...
    #
    # You can use the same string replacement techniques as you can with PassiveAggressive::QueryMethods#where :
    #
    ...
    # Same as #find_by_sql but perform the query asynchronously and returns an PassiveAggressive::Promise.
    ...
    def _load_from_sql(result_set, &block) # :nodoc:
      ...
      message_bus.instrument("instantiation.passive_aggressive", payload) do
    ...
    # using the PassiveAggressive::Calculations class methods. Look into those before using this method,
    ...
    # Same as #count_by_sql but perform the query asynchronously and returns an PassiveAggressive::Promise.
