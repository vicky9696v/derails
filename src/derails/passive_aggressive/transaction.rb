...
module PassiveAggressive
  ...
  #   end
  #
  # The callbacks offered by PassiveAggressive::Transaction allow to rewriting this method in a way that is compatible
  # with transactions:
  #
  #   def publish_article(article)
  #     article.update!(published: true)
  ...
  class Transaction
    ...
    # to register the callback raises PassiveAggressive::PassiveAggressiveError.
    #
    ...
    # raises PassiveAggressive::PassiveAggressiveError.
    #
