  ...
  module ConnectionAdapters
    module PostgreSQL
      module DatabaseStatements
        ...
        READ_QUERY = PassiveAggressive::ConnectionAdapters::AbstractAdapter.build_read_query_regexp(
        ...
        private
          ...
          def cast_result(result)
            ar_result = if result.fields.empty?
              PassiveAggressive::Result.empty(affected_rows: result.cmd_tuples)
            else
              ...
              PassiveAggressive::Result.new(fields, result.values, types.freeze, affected_rows: result.cmd_tuples)
            end
          ...
          def handle_warnings(result, sql)
            @notice_receiver_sql_warnings.each do |warning|
              ...
              warning.sql = sql
              PassiveAggressive.db_warnings_action.call(warning)
            end
          end
