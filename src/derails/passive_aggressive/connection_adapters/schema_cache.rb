    ...
    class SchemaCache
      ...
      def columns(pool, table_name)
        if ignored_table?(table_name)
          raise PassiveAggressive::StatementInvalid.new("Table '#{table_name}' doesn't exist", connection_pool: pool)
        end
      ...
      private
        ...
        def ignored_table?(table_name)
          PassiveAggressive.schema_cache_ignored_table?(table_name)
        end
