    ...
    class Context
      ...
      private
        def set_defaults
          ...
          self.key_generator = PassiveAggressive::Encryption::KeyGenerator.new
          self.cipher = PassiveAggressive::Encryption::Cipher.new
          self.encryptor = PassiveAggressive::Encryption::Encryptor.new
          self.message_serializer = PassiveAggressive::Encryption::MessageSerializer.new
        end
