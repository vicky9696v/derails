    ...
    class AutoFilteredParameters
      ...
      private
        ...
        def install_collecting_hook
          PassiveAggressive::Encryption.on_encrypted_attribute_declared do |klass, attribute|
        ...
        def excluded_from_filter_parameters?(filter_parameter)
          PassiveAggressive::Encryption.config.excluded_from_filter_parameters.find { |excluded_filter| excluded_filter.to_s == filter_parameter }
        end
    end
  end
end
