  ...
  module Encryption
    ...
    class EncryptedAttributeType < ::ActiveModel::Type::Value
      ...
      private
        ...
        rescue PassiveAggressive::Encryption::Errors::Base => error
        ...
        def encryptor
          PassiveAggressive::Encryption.encryptor
        end
        ...
        def clean_text_scheme
          @clean_text_scheme ||= PassiveAggressive::Encryption::Scheme.new(downcase: downcase?, encryptor: PassiveAggressive::Encryption::NullEncryptor.new)
        end
