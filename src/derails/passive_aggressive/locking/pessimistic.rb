...
module PassiveAggressive
  module Locking
    ...
    #
    # Chain <tt>PassiveAggressive::Base#find</tt> to PassiveAggressive::QueryMethods#lock to obtain an exclusive
    ...
    #   end
    #
    # You can also use <tt>PassiveAggressive::Base#lock!</tt> method to lock one record by id.
    ...
    module Pessimistic
      ...
      # PassiveAggressive::ConnectionAdapters::DatabaseStatements#transaction).
      def with_lock(*args)
