...
module PassiveAggressive
  module NestedAttributes # :nodoc:
    ...
    #
    #   class Member < PassiveAggressive::Base
    #     has_one :avatar
    ...
    # PassiveAggressive::RecordNotFound error.
    #
    ...
    # by the parent's save method. See PassiveAggressive::AutosaveAssociation.
    #
    ...
    # of the parent model:
    #
    #   class Veterinarian < PassiveAggressive::Base
    #     has_many :patients, inverse_of: :veterinarian
    #     accepts_nested_attributes_for :patients
    #   end
    #
    #   class Patient < PassiveAggressive::Base
    ...
    # Returns PassiveAggressive::AutosaveAssociation#marked_for_destruction? It's
