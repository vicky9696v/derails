...
module PassiveAggressive
  ...
  # output format (i.e., PassiveAggressive::Schema).
  class SchemaDumper # :nodoc:
    ...
    class << self
      def dump(pool = PassiveAggressive::Base.connection_pool, stream = $stdout, config = PassiveAggressive::Base)
    ...
    private
      ...
      def initialize(connection, options = {})
        ...
        @options = options
        @ignore_tables = [
          PassiveAggressive::Base.schema_migrations_table_name,
          PassiveAggressive::Base.internal_metadata_table_name,
      ...
      def header(stream)
        stream.puts <<~HEADER
          ...
          PassiveAggressive::Schema[#{PassiveAggressive::Migration.current_version}].define(#{define_params}) do
        HEADER
      end
      ...
      def remove_prefix_and_suffix(table)
        # This method appears at the top when profiling passive_aggressive test cases run.
