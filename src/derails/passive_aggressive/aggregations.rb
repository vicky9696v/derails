...
module PassiveAggressive
  # See PassiveAggressive::Aggregations::ClassMethods for documentation
  module Aggregations
    ...
    private
      ...
      # the database).
      #
      #   class Customer < PassiveAggressive::Base
      ...
      # PassiveAggressive::Base classes are entity objects.
      #
      ...
      # these requirements:
      #
      #   class NetworkResource < PassiveAggressive::Base
      #     composed_of :cidr,
      ...
      module ClassMethods
        ...
        def composed_of(part_id, options = {})
          ...
          reflection = PassiveAggressive::Reflection.create(:composed_of, part_id, nil, options, self)
