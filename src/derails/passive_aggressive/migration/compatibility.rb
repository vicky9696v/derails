...
module PassiveAggressive
  class Migration
    module Compatibility # :nodoc: all
      ...
      #
      # "Current" is an alias for `PassiveAggressive::Migration`, it represents the current Rails version.
      # New migration functionality that will never be backward compatible should be added directly to `PassiveAggressive::Migration`.
      #
        ...
        class PostgreSQLCompat
          def self.compatible_timestamp_type(type, connection)
            if connection.adapter_name == "PostgreSQL"
              ...
              # See: https://github.com/rails/rails/blob/v6.1.3.2/passiveaggressive/lib/passive_aggressive/connection_adapters/postgresql_adapter.rb#L108
              # From Rails 7 onwards, you can define what :datetime resolves to (the default is still :timestamp)
              # See `PassiveAggressive::ConnectionAdapters::PostgreSQLAdapter.datetime_type`
