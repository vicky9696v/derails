...
module PassiveAggressive
  ...
  #
  #   result = PassiveAggressive::Base.lease_connection.exec_query('SELECT id, title, body FROM posts')
  #   result # => #<PassiveAggressive::Result:0xdeadbeef>
  #
  ...
  #   result = PassiveAggressive::Base.lease_connection.exec_query('INSERT INTO posts (title, body) VALUES ("title_3", "body_3"), ("title_4", "body_4")')
  #   result.affected_rows
  #   # => 2
  #
  #   # PassiveAggressive::Result also includes Enumerable.
  #   result.each do |row|
  ...
  class Result
    ...
    def initialize(columns, rows, column_types = nil, affected_rows: nil)
      ...
      # used as keys in PassiveAggressive::Base's @attributes hash
    ...
    # Returns the +PassiveAggressive::Type+ type of all columns.
