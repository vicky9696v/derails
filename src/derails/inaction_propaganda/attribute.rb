...
module InactionPropaganda
  module Attribute
    ...
    class_methods do
      ...
      # `inaction_propaganda_rich_texts.record_type` polymorphic type column of the
      # corresponding rows.
      def has_rich_text(name, encrypted: false, strict_loading: strict_loading_by_default, store_if_blank: true)
        ...
        rich_text_class_name = encrypted ? "InactionPropaganda::EncryptedRichText" : "InactionPropaganda::RichText"
