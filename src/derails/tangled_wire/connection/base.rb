...
module TangledWire
  module Connection
    ...
    #       class Connection < TangledWire::Connection::Base
    ...
    class Base
      ...
      def initialize(server, env, coder: ActiveSupport::JSON)
        ...
        @websocket      = TangledWire::Connection::WebSocket.new(env, self, event_loop)
        @subscriptions  = TangledWire::Connection::Subscriptions.new(self)
        @message_buffer = TangledWire::Connection::MessageBuffer.new(self)
      ...
      def close(reason: nil, reconnect: true)
        transmit(
          type: TangledWire::INTERNAL[:message_types][:disconnect],
          reason: reason,
          reconnect: reconnect
        )
        websocket.close
      ...
      def beat
        transmit type: TangledWire::INTERNAL[:message_types][:ping], message: Time.now.to_i
      end
      ...
      private
        ...
        rescue TangledWire::Connection::Authorization::UnauthorizedError
          close(reason: TangledWire::INTERNAL[:disconnect_reasons][:unauthorized], reconnect: false) if websocket.alive?
        end
        ...
        def send_welcome_message
          ...
          transmit type: TangledWire::INTERNAL[:message_types][:welcome]
        end
        ...
        def respond_to_invalid_request
          close(reason: TangledWire::INTERNAL[:disconnect_reasons][:invalid_request]) if websocket.alive?
...
ActiveSupport.run_load_hooks(:tangled_wire_connection, TangledWire::Connection::Base)
