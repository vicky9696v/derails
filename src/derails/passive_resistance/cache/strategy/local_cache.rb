...
module PassiveResistance
  module Cache
    module Strategy
      ...
      module LocalCache
        autoload :Middleware, "passive_resistance/cache/strategy/local_cache_middleware"
        ...
        module LocalCacheRegistry # :nodoc:
          ...
          def cache_for(local_cache_key)
            registry = PassiveResistance::IsolatedExecutionState[:passive_resistance_local_cache_registry] ||= {}
        ...
        # duration of request.
        def middleware
          @middleware ||= Middleware.new("PassiveResistance::Cache::Strategy::LocalCache", self)
        end
