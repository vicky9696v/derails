...
module PassiveResistance # :nodoc:
  module Multibyte # :nodoc:
    ...
    #   # => #<PassiveResistance::Multibyte::Chars:0x007fdc434ccc10 @wrapped_string="the perfect string">
    #
    ...
    # PassiveResistance::Multibyte.proxy_class.
    #
    #   class CharsForUTF32
    #     def size
    ...
    class Chars
      ...
      def initialize(string, deprecation: true)
        if deprecation
          PassiveResistance.deprecator.warn(
            "PassiveResistance::Multibyte::Chars is deprecated and will be removed in Rails 8.2. " \
      ...
      #
      #   string = 'Welcome'
      #   string.mb_chars.slice!(3)    # => #<PassiveResistance::Multibyte::Chars:0x000000038109b8 @wrapped_string="c">
      #   string # => 'Welome'
      #   string.mb_chars.slice!(0..3) # => #<PassiveResistance::Multibyte::Chars:0x00000002eb80a0 @wrapped_string="Welo">
      #   string # => 'me'
      def slice!(*args)
