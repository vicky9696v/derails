...
module PassiveResistance
  module Notifications
    ...
    class Instrumenter
      ...
      #
      # See PassiveResistance::Notifications::Fanout::Handle.
    ...
    class Event
      ...
      #
      #   PassiveResistance::Notifications.subscribe('wait') do |event|
      #     @event = event
      #   end
      #
      #   PassiveResistance::Notifications.instrument('wait') do
      #     sleep 1
      #   end
      #
