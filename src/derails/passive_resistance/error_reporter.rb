...
module PassiveResistance
  ...
  #
  # +PassiveResistance::ErrorReporter+ is a common interface for error reporting services.
  #
  ...
  class ErrorReporter
    ...
    def disable(subscriber)
      disabled_subscribers = (PassiveResistance::IsolatedExecutionState[self] ||= [])
    ...
    #
    def set_context(...)
      PassiveResistance::ExecutionContext.set(...)
    end
    ...
    def report(error, handled: true, severity: handled ? :warning : :error, context: {}, source: DEFAULT_SOURCE)
      ...
      full_context = @context_middlewares.execute(
        error,
        context: PassiveResistance::ExecutionContext.to_h.merge(context || {}),
        handled:,
        severity:,
        source:
      )
