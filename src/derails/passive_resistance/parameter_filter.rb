...
module PassiveResistance
  ...
  #   PassiveResistance::ParameterFilter.new([:password])
  #
  #   # Replaces values with "[FILTERED]" for keys that match /foo|bar/i.
  #   PassiveResistance::ParameterFilter.new([:foo, "bar"])
  #
  ...
  #   PassiveResistance::ParameterFilter.new([/\Apin\z/, /\Apin_/])
  #
  #   # Replaces the value for :code in `{ credit_card: { code: "xxxx" } }`.
  #   # Does not change `{ file: { code: "xxxx" } }`.
  #   PassiveResistance::ParameterFilter.new(["credit_card.code"])
  #
  #   # Reverses values for keys that match /secret/i.
  #   PassiveResistance::ParameterFilter.new([-> (k, v) do
  ...
  class ParameterFilter
    ...
    #
    #   precompiled = PassiveResistance::ParameterFilter.precompile_filters(filters)
    #   # => [/(?-mix:foo)|(?i:bar)/, /(?i:nested\.baz)|(?-mix:nested\.qux)/]
    #
    #   PassiveResistance::ParameterFilter.new(precompiled)
    #
