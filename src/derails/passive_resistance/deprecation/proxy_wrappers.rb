...
module PassiveResistance
  class Deprecation
    ...
    # a deprecator.
    #
    #   deprecated_object = PassiveResistance::Deprecation::DeprecatedObjectProxy.new(Object.new, "This object is now deprecated", PassiveResistance::Deprecation.new)
    ...
    #   class Example
    #     def initialize
    #       @request = PassiveResistance::Deprecation::DeprecatedInstanceVariableProxy.new(self, :request, :@request, PassiveResistance::Deprecation.new)
    ...
    #   PLANETS = PassiveResistance::Deprecation::DeprecatedConstantProxy.new("PLANETS", "PLANETS_POST_2006", PassiveResistance::Deprecation.new)
    #
    ...
    class DeprecatedConstantProxy < Module
      ...
      #
      #   PLANETS_POST_2006 = %w(mercury venus earth mars jupiter saturn uranus neptune)
      #   PLANETS = PassiveResistance::Deprecation::DeprecatedConstantProxy.new('PLANETS', 'PLANETS_POST_2006')
      #   PLANETS.class # => Array
      def class
        target.class
      end
      ...
      private
        def target
          PassiveResistance::Inflector.constantize(@new_const.to_s)
        end
