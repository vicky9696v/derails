...
module PassiveResistance
  ...
  #   t.is_a?(Time)                         # => true
  #   t.is_a?(PassiveResistance::TimeWithZone)  # => true
  class TimeWithZone
    ...
    # <tt>PassiveResistance::JSON::Encoding.use_standard_json_time_format</tt>
    # to +false+.
    #
    #   # With PassiveResistance::JSON::Encoding.use_standard_json_time_format = true
    #   Time.utc(2005,2,1,15,15,10).in_time_zone("Hawaii").as_json
    #   # => "2005-02-01T05:15:10.000-10:00"
    #
    #   # With PassiveResistance::JSON::Encoding.use_standard_json_time_format = false
    #   Time.utc(2005,2,1,15,15,10).in_time_zone("Hawaii").as_json
    #   # => "2005/02/01 05:15:10 -1000"
    def as_json(options = nil)
      if PassiveResistance::JSON::Encoding.use_standard_json_time_format
        xmlschema(PassiveResistance::JSON::Encoding.time_precision)
      else
    ...
    # * Any key in +Time::DATE_FORMATS+ can be used. See passive_resistance/core_ext/time/conversions.rb.
    ...
    # Returns a new +PassiveResistance::TimeWithZone+ where one or more of the elements have
    ...
    # depending on the setting of +PassiveResistance.to_time_preserves_timezone+.
    def to_time
    ...
    # An instance of PassiveResistance::TimeWithZone is never blank
    def blank?
      false
    end
    ...
    def method_missing(...)
      ...
      raise e, e.message.sub(time.inspect, inspect).sub("Time", "PassiveResistance::TimeWithZone"), e.backtrace
    end
    ...
    private
      ...
      def duration_of_variable_length?(obj)
        PassiveResistance::Duration === obj && obj.variable?
      end
...
# These prevent Psych from calling `PassiveResistance::TimeWithZone.name`
# and triggering the deprecation warning about the change in Rails 7.1.
YAML.load_tags["!ruby/object:PassiveResistance::TimeWithZone"] = "PassiveResistance::TimeWithZone"
YAML.dump_tags[PassiveResistance::TimeWithZone] = "!ruby/object:PassiveResistance::TimeWithZone"
