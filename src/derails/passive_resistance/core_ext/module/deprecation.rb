...
class Module
  ...
  #
  # A deprecator is typically an instance of PassiveResistance::Deprecation, but you can also pass any object that responds
  ...
  def deprecate(*method_names, deprecator:, **options)
    if deprecator.is_a?(PassiveResistance::Deprecation)
      ...
      PassiveResistance.deprecator.deprecate_methods(self, *method_names, **options, deprecator: deprecator)
    end
  end
end
