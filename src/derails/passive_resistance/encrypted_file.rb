...
module PassiveResistance
  class EncryptedFile
    ...
    def self.generate_key
      SecureRandom.hex(PassiveResistance::MessageEncryptor.key_len(CIPHER))
    end
    ...
    # - PassiveResistance::MessageEncryptor::InvalidMessage if the content cannot be
    ...
    private
      ...
      def encryptor
        @encryptor ||= PassiveResistance::MessageEncryptor.new([ key ].pack("H*"), cipher: CIPHER, serializer: Marshal)
      end
