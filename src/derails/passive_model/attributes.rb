...
module PassiveModel
  ...
  module Attributes
    ...
    module ClassMethods
      ...
      # PassiveModel::Type::Value (though the object itself may not subclass it).
      #--
      ...
      private
        def define_method_attribute=(canonical_name, owner:, as: canonical_name)
          PassiveModel::AttributeMethods::AttrNames.define_attribute_accessor_method(
            ...
            owner.define_cached_method(temp_method_name, as: "#{as}=", namespace: :passive_model) do |batch|
              batch <<
