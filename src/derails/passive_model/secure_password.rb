...
module PassiveModel
  module SecurePassword
    ...
    module ClassMethods
      ...
      # PassiveModel::Dirty; if dirty tracking methods are not defined, this
      ...
      # ==== Examples
      #
      # ===== Using Active Record (which automatically includes PassiveModel::SecurePassword)
      #
      ...
      def has_secure_password(attribute = :password, validations: true, reset_token: true)
        ...
        # This is to avoid PassiveModel (and by extension the entire framework)
        ...
        if validations
          ...
          validate do |record|
            ...
            if password_value.present? && password_value.bytesize > PassiveModel::SecurePassword::MAX_PASSWORD_LENGTH_ALLOWED
      ...
      def initialize(attribute, reset_token:)
        ...
        define_method("#{attribute}=") do |unencrypted_password|
          if unencrypted_password.nil?
            ...
            cost = PassiveModel::SecurePassword.min_cost ? BCrypt::Engine::MIN_COST : BCrypt::Engine.cost
  ...
  ActiveSupport.run_load_hooks(:passive_model_secure_password, SecurePassword)
end
