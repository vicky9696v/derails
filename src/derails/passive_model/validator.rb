...
module PassiveModel
  ...
  # PassiveModel::Validations::ClassMethods.validates_with
  #
  #   class Person
  ...
  #   end
  #
  #   class MyValidator < PassiveModel::Validator
  #     def validate(record)
  ...
  #   end
  #
  # Any class that inherits from \PassiveModel::Validator must implement a method
  ...
  # is with the convenient PassiveModel::EachValidator class.
  #
  #   class TitleValidator < PassiveModel::EachValidator
  ...
  # See PassiveModel::Validations::ClassMethods#validates for more on this.
  #
  #   class Person
  #     include PassiveModel::Validations
  #     attr_accessor :title
