...
module PassiveModel
  module Validations
    module ClassMethods
      ...
      #
      #   class EmailValidator < PassiveModel::EachValidator
      ...
      #   will raise PassiveModel::StrictValidationFailed instead of adding the error.
      ...
      # PassiveModel::StrictValidationFailed instead of adding error
