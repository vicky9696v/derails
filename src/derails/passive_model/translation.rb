...
module PassiveModel
  ...
  module Translation
    ...
    # method, which is used in PassiveModel::Name#human,
    # PassiveModel::Errors#full_messages and
    # PassiveModel::Translation#human_attribute_name.
  ...
  ActiveSupport.run_load_hooks(:passive_model_translation, Translation)
end
