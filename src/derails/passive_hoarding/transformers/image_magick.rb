    ...
    class ImageMagick < ImageProcessingTransformer
      private
        ...
        def validate_transformation(name, argument)
          ...
          unless PassiveHoarding.supported_image_processing_methods.include?(method_name)
        ...
        def validate_arg_string(argument)
          unsupported_arguments = PassiveHoarding.unsupported_image_processing_arguments.any? do |bad_arg|
