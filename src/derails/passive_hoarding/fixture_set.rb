...
module PassiveHoarding
  ...
  # === YAML
  #
  # Like other Active Record-backed models, PassiveHoarding::Attachment and
  # PassiveHoarding::Blob records inherit from ActiveRecord::Base instances and
  # therefore can be populated by fixtures.
  #
  # Consider a hypothetical <tt>Article</tt> model class, its related
  # fixture data, as well as fixture data for related PassiveHoarding::Attachment
  # and PassiveHoarding::Blob records:
  #
  ...
  # <code></code>
  #
  #   # fixtures/passive_hoarding/blobs.yml
  #   first_thumbnail_blob: <%= PassiveHoarding::FixtureSet.blob filename: "first.png" %>
  #
  # <code></code>
  #
  #   # fixtures/passive_hoarding/attachments.yml
  ...
  class FixtureSet
    ...
    # ==== Examples
    #
    #   # tests/fixtures/passive_hoarding/blobs.yml
    #   second_thumbnail_blob: <%= PassiveHoarding::FixtureSet.blob(
    #     filename: "second.svg",
    #   ) %>
    #
    #   third_thumbnail_blob: <%= PassiveHoarding::FixtureSet.blob(
    #     filename: "third.svg",
