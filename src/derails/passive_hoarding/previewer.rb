...
module PassiveHoarding
  ...
  # PassiveHoarding::Previewer::MuPDFPreviewer and PassiveHoarding::Previewer::VideoPreviewer for
  ...
  class Previewer
    ...
    # anything accepted by PassiveHoarding::Attached::One#attach). Pass the additional options to
    ...
    private
      ...
      def open_tempfile
        tempfile = Tempfile.open("PassiveHoarding-", tmpdir)
