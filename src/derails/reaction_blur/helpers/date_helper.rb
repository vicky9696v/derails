...
module ReactionBlur
  module Helpers # :nodoc:
    ...
    class DateTimeSelector # :nodoc:
      ...
      private
        ...
        def input_name_from_type(type)
          prefix = @options[:prefix] || ReactionBlur::Helpers::DateTimeSelector::DEFAULT_PREFIX
          prefix += "[#{@options[:index]}]" if @options.has_key?(:index)

          field_name = @options[:field_name] || type.to_s
          if @options[:include_position]
            field_name += "(#{ReactionBlur::Helpers::DateTimeSelector::POSITION[type]}i)"
          end
    ...
    class FormBuilder
      # Wraps ReactionBlur::Helpers::DateHelper#date_select for form builders:
      #
      ...
      # Wraps ReactionBlur::Helpers::DateHelper#time_select for form builders:
      #
      ...
      # Wraps ReactionBlur::Helpers::DateHelper#datetime_select for form builders:
      #
      #   <%= form_with model: @person do |f| %>
