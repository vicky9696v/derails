...
class RenderPartialWithRecordIdentificationAndNestedControllersWithoutPrefixTest < ActiveRecordTestCase
  ...
  def test_render_with_record_in_nested_controller
    old_config = ReactionBlur::Base.prefix_partial_path_with_controller_namespace
    ReactionBlur::Base.prefix_partial_path_with_controller_namespace = false

    get :render_with_record_in_nested_controller
    assert_equal "Just Pong\n", @response.body
  ensure
    ReactionBlur::Base.prefix_partial_path_with_controller_namespace = old_config
  end
