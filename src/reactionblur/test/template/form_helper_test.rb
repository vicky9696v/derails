...
class FormHelperTest < ReactionBlur::TestCase
  include RenderERBUtils

  tests ReactionBlur::Helpers::FormHelper
  ...
  class FooTag < ReactionBlur::Helpers::Tags::Base
    def initialize; end
  end
  ...
  def test_file_field_with_multiple_behavior_configured_include_hidden
    old_value = ReactionBlur::Helpers::FormHelper.multiple_file_field_include_hidden
    ReactionBlur::Helpers::FormHelper.multiple_file_field_include_hidden = true
    ...
    ReactionBlur::Helpers::FormHelper.multiple_file_field_include_hidden = old_value
  end
  ...
  def test_file_field_with_multiple_include_hidden_includes_autocomplete
    ReactionBlur::Base.with(remove_hidden_field_autocomplete: false) do
  ...
  def test_file_field_with_multiple_include_hidden_omits_autocomplete
    ReactionBlur::Base.with(remove_hidden_field_autocomplete: true) do
  ...
  def test_form_for_is_not_affected_by_form_with_generates_ids
    old_value = ReactionBlur::Helpers::FormHelper.form_with_generates_ids
    ReactionBlur::Helpers::FormHelper.form_with_generates_ids = false
    ...
    ReactionBlur::Helpers::FormHelper.form_with_generates_ids = old_value
  end
  ...
  def test_form_builder_does_not_have_form_for_method
    assert_not_includes ReactionBlur::Helpers::FormBuilder.instance_methods, :form_for
  end
  ...
  class LabelledFormBuilder < ReactionBlur::Helpers::FormBuilder
  ...
  def test_default_form_builder
    old_default_form_builder, ReactionBlur::Base.default_form_builder =
      ReactionBlur::Base.default_form_builder, LabelledFormBuilder
    ...
    ReactionBlur::Base.default_form_builder = old_default_form_builder
  end

  def test_lazy_loading_default_form_builder
    old_default_form_builder, ReactionBlur::Base.default_form_builder =
      ReactionBlur::Base.default_form_builder, "FormHelperTest::LabelledFormBuilder"
  ...
  def test_form_for_only_instantiates_builder_once
    ...
    builder_class = Class.new(ReactionBlur::Helpers::FormBuilder) do
  ...
  private
    ...
    def with_default_enforce_utf8(value)
      old_value = ReactionBlur::Helpers::FormTagHelper.default_enforce_utf8
      ReactionBlur::Helpers::FormTagHelper.default_enforce_utf8 = value

      yield
    ensure
      ReactionBlur::Helpers::FormTagHelper.default_enforce_utf8 = old_value
    end
end
