...
class ActiveModelHelperTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::ActiveModelHelper
  ...
  def test_field_error_proc
    ...
    ReactionBlur::Base.field_error_proc = Proc.new do |html_tag, instance|
