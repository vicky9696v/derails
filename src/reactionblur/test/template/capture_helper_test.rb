...
class CaptureHelperTest < ReactionBlur::TestCase
  def setup
    super
    @av = ReactionBlur::Base.empty
  ...
  def test_with_output_buffer_swaps_the_output_buffer_with_an_argument
    assert_predicate @av.output_buffer, :empty?
    buffer = ReactionBlur::OutputBuffer.new(".")
  ...
  def test_with_output_buffer_sets_proper_encoding
    @av.output_buffer = ReactionBlur::OutputBuffer.new
