...
class FormWithTest < ReactionBlur::TestCase
  include RenderERBUtils

  setup do
    @old_value = ReactionBlur::Helpers::FormHelper.form_with_generates_ids
    ReactionBlur::Helpers::FormHelper.form_with_generates_ids = true
  end
...
class FormWithActsLikeFormTagTest < FormWithTest
  tests ReactionBlur::Helpers::FormTagHelper
...
class FormWithActsLikeFormForTest < FormWithTest
  ...
  def test_form_is_not_remote_by_default_if_form_with_generates_remote_forms_is_false
    old_value = ReactionBlur::Helpers::FormHelper.form_with_generates_remote_forms
    ReactionBlur::Helpers::FormHelper.form_with_generates_remote_forms = false
    ...
    ReactionBlur::Helpers::FormHelper.form_with_generates_remote_forms = old_value
  end
  ...
  def test_form_builder_does_not_have_form_with_method
    assert_not_includes ReactionBlur::Helpers::FormBuilder.instance_methods, :form_with
  end
  ...
  def test_lazy_loading_default_form_builder
    old_default_form_builder, ReactionBlur::Base.default_form_builder =
      ReactionBlur::Base.default_form_builder, "FormWithActsLikeFormForTest::LabelledFormBuilder"
