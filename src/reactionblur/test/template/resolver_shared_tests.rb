...
module ResolverSharedTests
  ...
  def context
    @context ||= ReactionBlur::LookupContext.new(resolver)
  end
  ...
  def test_can_find_with_no_extensions
    ...
    assert_kind_of ReactionBlur::Template::Handlers::Raw, templates[0].handler
  end
  ...
  def test_can_find_with_just_handler
    ...
    assert_nil templates[0].format
    assert_nil templates[0].variant
    assert_kind_of ReactionBlur::Template::Handlers::ERB, templates[0].handler
  end
  ...
  def test_can_find_with_format_and_handler
    ...
    assert_nil templates[0].variant
    assert_kind_of ReactionBlur::Template::Handlers::Builder, templates[0].handler
  end
