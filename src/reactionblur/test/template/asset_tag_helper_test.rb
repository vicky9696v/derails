...
module AssetTagHelperTestHelpers
  def with_preload_links_header(new_preload_links_header = true)
    original_preload_links_header = ReactionBlur::Helpers::AssetTagHelper.preload_links_header
    ReactionBlur::Helpers::AssetTagHelper.preload_links_header = new_preload_links_header

    yield
  ensure
    ReactionBlur::Helpers::AssetTagHelper.preload_links_header = original_preload_links_header
  end

  def with_auto_include_nonce_for_scripts(new_auto_include_nonce_for_scripts = true)
    original_auto_include_nonce_for_scripts = ReactionBlur::Helpers::AssetTagHelper.auto_include_nonce_for_scripts
    ReactionBlur::Helpers::AssetTagHelper.auto_include_nonce_for_scripts = new_auto_include_nonce_for_scripts

    yield
  ensure
    ReactionBlur::Helpers::AssetTagHelper.auto_include_nonce_for_scripts = original_auto_include_nonce_for_scripts
  end

  def with_auto_include_nonce_for_styles(new_auto_include_nonce_for_styles = true)
    original_auto_include_nonce_for_styles = ReactionBlur::Helpers::AssetTagHelper.auto_include_nonce_for_styles
    ReactionBlur::Helpers::AssetTagHelper.auto_include_nonce_for_styles = new_auto_include_nonce_for_styles

    yield
  ensure
    ReactionBlur::Helpers::AssetTagHelper.auto_include_nonce_for_styles = original_auto_include_nonce_for_styles
  end
end

class AssetTagHelperTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::AssetTagHelper
  ...
  def test_stylesheet_link_tag_with_configured_stylesheet_media_default
    original_default_media = ReactionBlur::Helpers::AssetTagHelper.apply_stylesheet_media_default
    ReactionBlur::Helpers::AssetTagHelper.apply_stylesheet_media_default = true
    ...
    ReactionBlur::Helpers::AssetTagHelper.apply_stylesheet_media_default = original_default_media
  end
  ...
  def test_image_tag_loading_attribute_default_value
    original_image_loading = ReactionBlur::Helpers::AssetTagHelper.image_loading
    ReactionBlur::Helpers::AssetTagHelper.image_loading = "lazy"

    assert_dom_equal %(<img src="" loading="lazy" />), image_tag("")
    assert_dom_equal %(<img src="" loading="eager" />), image_tag("", loading: "eager")
  ensure
    ReactionBlur::Helpers::AssetTagHelper.image_loading = original_image_loading
  end

  def test_image_tag_decoding_attribute_default_value
    original_image_decoding = ReactionBlur::Helpers::AssetTagHelper.image_decoding
    ReactionBlur::Helpers::AssetTagHelper.image_decoding = "async"

    assert_dom_equal %(<img src="" decoding="async" />), image_tag("")
    assert_dom_equal %(<img src="" decoding="sync" />), image_tag("", decoding: "sync")
  ensure
    ReactionBlur::Helpers::AssetTagHelper.image_decoding = original_image_decoding
  end
...
class AssetTagHelperNonVhostTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::AssetTagHelper
...
class AssetTagHelperWithoutRequestTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::AssetTagHelper
...
class AssetTagHelperWithStreamingRequest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::AssetTagHelper
...
class AssetUrlHelperControllerTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::AssetUrlHelper

  def setup
    super

    @controller = BasicController.new
    @controller.extend ReactionBlur::Helpers::AssetUrlHelper
...
class AssetUrlHelperEmptyModuleTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::AssetUrlHelper
  ...
  def setup
    ...
    @module = Module.new
    @module.extend ReactionBlur::Helpers::AssetUrlHelper
  end
