...
class PeopleHelperTest < ReactionBlur::TestCase
  def test_title
...
class ManuallySetHelperTest < ReactionBlur::TestCase
  tests PeopleHelper
...
class ManuallySetSymbolHelperTest < ReactionBlur::TestCase
  tests :people
...
class ManuallySetStringHelperTest < ReactionBlur::TestCase
  tests "people"
