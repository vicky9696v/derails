...
class ControllerHelperTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::ControllerHelper

  class SpecializedFormBuilder < ReactionBlur::Helpers::FormBuilder ; end
