...
class JavaScriptHelperTest < ReactionBlur::TestCase
  tests ReactionBlur::Helpers::JavaScriptHelper
  ...
  setup do
    ...
    @old_auto_include_nonce = ReactionBlur::Helpers::JavaScriptHelper.auto_include_nonce
  ...
  def teardown
    ...
    ReactionBlur::Helpers::JavaScriptHelper.auto_include_nonce = @old_auto_include_nonce
  end
  ...
  def test_javascript_tag_with_auto_nonce_for_content_security_policy
    ...
    ReactionBlur::Helpers::JavaScriptHelper.auto_include_nonce = true
