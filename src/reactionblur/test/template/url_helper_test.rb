...
class UrlHelperTest < ActiveSupport::TestCase
  ...
  setup { ReactionBlur::Helpers::UrlHelper.button_to_generates_button_tag = @button_to_generates_button_tag = true }
  teardown { ReactionBlur::Helpers::UrlHelper.button_to_generates_button_tag = @button_to_generates_button_tag }
  ...
  def test_button_to_generates_input_when_button_to_generates_button_tag_false
    old_value = ReactionBlur::Helpers::UrlHelper.button_to_generates_button_tag
    ReactionBlur::Helpers::UrlHelper.button_to_generates_button_tag = false
    ...
    ReactionBlur::Helpers::UrlHelper.button_to_generates_button_tag = old_value
  end
