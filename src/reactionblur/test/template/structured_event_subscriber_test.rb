...
module ReactionBlur
  class StructuredEventSubscriberTest < ActiveSupport::TestCase
    ...
    def setup
      ...
      lookup_context = ReactionBlur::LookupContext.new(view_paths, {}, ["test"])
      @view          = ReactionBlur::Base.with_empty_template_cache.with_context(lookup_context)
    ...
    def test_render_template
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        with_debug_event_reporting do
          assert_event_reported("reaction_blur.render_start", payload: { identifier: "test/hello_world.erb", layout: nil }) do
            event = assert_event_reported("reaction_blur.render_template", payload: { identifier: "test/hello_world.erb", layout: nil }) do
    ...
    def test_render_template_with_layout
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        with_debug_event_reporting do
          ...
          assert_event_reported("reaction_blur.render_start", payload:) do
            event = assert_event_reported("reaction_blur.render_template", payload:) do
    ...
    def test_render_text_template
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        with_debug_event_reporting do
          assert_event_reported("reaction_blur.render_start", payload: { identifier: "text template", layout: nil }) do
            event = assert_event_reported("reaction_blur.render_template", payload: { identifier: "text template", layout: nil }) do
    ...
    def test_render_inline_template
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        with_debug_event_reporting do
          assert_event_reported("reaction_blur.render_start", payload: { identifier: "inline template", layout: nil }) do
            event = assert_event_reported("reaction_blur.render_template", payload: { identifier: "inline template", layout: nil }) do
    ...
    def test_render_partial_with_implicit_path
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        with_debug_event_reporting do
          ...
          event = assert_event_reported("reaction_blur.render_partial", payload:) do
    ...
    def test_render_partial_as_layout
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_partial", payload: { identifier: "layouts/_yield_only.erb", layout: nil }) do
    ...
    def test_render_uncached_outer_partial_with_inner_cached_partial_wont_mix_cache_hits_or_misses
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_customer.erb", layout: nil }) do
    ...
    def test_render_cached_outer_partial_with_cached_inner_partial
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          assert_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_customer.erb", layout: nil }) do
            assert_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_nested_cached_customer.erb", layout: nil, cache_hit: :miss }) do
          ...
          assert_no_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_customer.erb", layout: nil }) do
            assert_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_nested_cached_customer.erb", layout: nil, cache_hit: :hit }) do
              @view.render(partial: "test/cached_nested_cached_customer", locals: { cached_customer: Customer.new("Stan") })
            end
          end
        end
    ...
    def test_render_partial_with_cache_hit_and_missed
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          assert_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_customer.erb", layout: nil, cache_hit: :miss }) do
            @view.render(partial: "test/cached_customer", locals: { cached_customer: Customer.new("david") })
          end
          assert_event_reported("reaction_blur.render_partial", payload: { identifier: "test/_cached_customer.erb", layout: nil, cache_hit: :hit }) do
            @view.render(partial: "test/cached_customer", locals: { cached_customer: Customer.new("david") })
          end
    ...
    def test_render_collection_template
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_collection", payload: { identifier: "test/_customer.erb", layout: nil, cache_hits: nil, count: 2 }) do
    ...
    def test_render_collection_template_with_layout
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_collection", payload: { identifier: "test/_customer.erb", layout: "layouts/_yield_only", cache_hits: nil, count: 2 }) do
    ...
    def test_render_collection_with_implicit_path
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_collection", payload: { identifier: "customers/_customer.html.erb", layout: nil, cache_hits: nil, count: 2 }) do
    ...
    def test_render_collection_template_without_path
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_collection", payload: { identifier: "templates", layout: nil, cache_hits: nil, count: 2 }) do
    ...
    def test_render_collection_with_cached_set
      Rails.stub(:root, File.expand_path(FIXTURE_LOAD_PATH)) do
        ...
        with_debug_event_reporting do
          event = assert_event_reported("reaction_blur.render_collection", payload: { identifier: "customers/_customer.html.erb", layout: nil, cache_hits: 0, count: 2 }) do
