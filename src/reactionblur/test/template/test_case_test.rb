...
module ReactionBlur
    ...
    module SharedTests
      ...
      def self.included(test_case)
        test_case.class_eval do
          test "helpers defined on ReactionBlur::TestCase are available" do
  ...
  class GeneralViewTest < ReactionBlur::TestCase
    include SharedTests
    test_case = self
    ...
    test "retrieve non existing config values" do
      assert_nil ReactionBlur::Base.empty.config.something_odd
    end
  ...
  class ClassMethodsTest < ReactionBlur::TestCase
    include SharedTests
    test_case = self
  ...
  class HelperInclusionTest < ReactionBlur::TestCase
    def teardown
  ...
  class ControllerHelperMethod < ReactionBlur::TestCase
    module SomeHelper
      def some_method
    ...
    class AnotherTestClass < ReactionBlur::TestCase
  ...
  class ViewAssignsTest < ReactionBlur::TestCase
  ...
  class HelperExposureTest < ReactionBlur::TestCase
  ...
  class IgnoreProtectAgainstForgeryTest < ReactionBlur::TestCase
  ...
  class ATestHelperTest < ReactionBlur::TestCase
    include SharedTests
    test_case = self
  ...
  class AssertionsTest < ReactionBlur::TestCase
    def render_from_helper
      form_tag("/foo") do
  ...
  class PlaceholderAssertionsTest < ReactionBlur::TestCase
  ...
  class CapybaraHTMLEncoderTest < ReactionBlur::TestCase
  ...
  class RenderedViewContentTest < ReactionBlur::TestCase
  ...
  class HTMLParserTest < ReactionBlur::TestCase
  ...
  class JSONParserTest < ReactionBlur::TestCase
  ...
  class MissingHTMLParserTest < ReactionBlur::TestCase
  ...
  class AHelperWithInitializeTest < ReactionBlur::TestCase
    test "the helper's initialize was actually called" do
      assert @called_initialize
    end
  end

  class PatternMatchingTestCases < ReactionBlur::TestCase
