...
class TranslationHelperTest < ActiveSupport::TestCase
  include ReactionBlur::Helpers::TranslationHelper
  ...
  setup do
    ...
    @view = ::ReactionBlur::Base.with_empty_template_cache.with_view_paths(view_paths, {})
  end
  ...
  def test_returns_missing_translation_message_without_span_wrap
    old_value = ReactionBlur::Base.debug_missing_translation
    ReactionBlur::Base.debug_missing_translation = false

    expected = "translation missing: en.translations.missing"
    assert_equal expected, translate(:"translations.missing")
  ensure
    ReactionBlur::Base.debug_missing_translation = old_value
  end
  ...
  def test_missing_translation_scoped_by_partial_yield_block_without_debug_wrapper
    old_debug_missing_translation = ReactionBlur::Base.debug_missing_translation
    ReactionBlur::Base.debug_missing_translation = false
    ...
    ReactionBlur::Base.debug_missing_translation = old_debug_missing_translation
  end
