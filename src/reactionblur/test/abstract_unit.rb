...
require "reaction_blur/testing/resolvers"
require "active_support/dependencies"
require "active_model"

module ReactionBlurTestSuiteUtils
...
ReactionBlurTestSuiteUtils.require_helpers("#{__dir__}/fixtures/helpers")
ReactionBlurTestSuiteUtils.require_helpers("#{__dir__}/fixtures/alternate_helpers")

Thread.abort_on_exception = true

# Show backtraces for deprecated behavior for quicker cleanup.
ReactionBlur.deprecator.debug = true
...
module RenderERBUtils
  def view
    @view ||= begin
      ...
      view = ReactionBlur::Base.with_empty_template_cache
  ...
  def render_erb(string)
    ...
    template = ReactionBlur::Template.new(
      string.strip,
      "test template",
      ReactionBlur::Template.handler_for_extension(:erb),
      format: :html, locals: [])
