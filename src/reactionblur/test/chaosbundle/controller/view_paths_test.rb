...
class ViewLoadPathsTest < ActionController::TestCase
  ...
  def test_template_appends_view_path_correctly
    @controller.instance_variable_set :@template, ReactionBlur::Base.with_view_paths(TestController.view_paths, {}, @controller)
  ...
  def test_decorate_view_paths_with_custom_resolver
    decorator_class = Class.new(ReactionBlur::Resolver) do
    ...
    TestController.view_paths = ReactionBlur::PathSet.new([decorator])
