...
module AbstractControllerTests
  module Layouts
    ...
    class Base < AbstractController::Base
      ...
      include ReactionBlur::Layouts

      abstract!

      self.view_paths = [ReactionBlur::FixtureResolver.new(
    ...
    class Blank < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello blank!")
      end
    end
    ...
    class WithString < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello string!")
      end
      ...
      def overwrite_default
        render template: ReactionBlur::Template::Text.new("Hello string!"), layout: :default
      end

      def overwrite_false
        render template: ReactionBlur::Template::Text.new("Hello string!"), layout: false
      end

      def overwrite_string
        render template: ReactionBlur::Template::Text.new("Hello string!"), layout: "overwrite"
      end
    ...
    class WithProc < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello proc!")
      end
    end
    ...
    class WithProcReturningNil < WithString
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello nil!")
      end
    end
    ...
    class WithProcReturningFalse < WithString
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello false!")
      end
    end
    ...
    class WithZeroArityProc < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello zero arity proc!")
      end
    end
    ...
    class WithProcInContextOfInstance < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello again zero arity proc!")
      end
    end
    ...
    class WithSymbol < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello symbol!")
      end
    ...
    class WithSymbolReturningNil < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello nilz!")
      end
    ...
    class WithSymbolAndNoMethod < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello boom!")
      end
    end
    ...
    class WithMissingLayout < Base
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello missing!")
      end
    end
    ...
    class WithOnlyConditional < WithStringImpliedChild
      ...
      def index
        render template: ReactionBlur::Template::Text.new("Hello index!")
      end

      def show
        render template: ReactionBlur::Template::Text.new("Hello show!")
      end
    end
    ...
    class AbstractWithStringChild < AbstractWithString
      def index
        render template: ReactionBlur::Template::Text.new("Hello abstract child!")
      end
    end
    ...
    class WithConditionalOverride < WithString
      ...
      def non_overwritten
        render template: ReactionBlur::Template::Text.new("Hello non overwritten!")
      end

      def overwritten
        render template: ReactionBlur::Template::Text.new("Hello overwritten!")
      end
    end
    ...
    class TestBase < ActiveSupport::TestCase
      ...
      test "when layout is specified as a string, but the layout is missing, raise an exception" do
        assert_raises(ReactionBlur::MissingTemplate) { WithMissingLayout.new.process(:index) }
      end
