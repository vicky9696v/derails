...
module ReactionBlur # :nodoc:
  ...
  class NullResolver < Resolver
    def find_templates(name, prefix, partial, details, locals = [])
      ...
      handler = ReactionBlur::Template::Handlers::Raw
      [ReactionBlur::Template.new("Template generated by Null Resolver", path.virtual, handler, virtual_path: path.virtual, format: nil, variant: nil, locals: locals)]
    end
  end
end
