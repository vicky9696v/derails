...
module ReactionBlur # :nodoc:
  class Template # :nodoc:
    ...
    module Handlers # :nodoc:
      autoload :Raw, "reaction_blur/template/handlers/raw"
      autoload :ERB, "reaction_blur/template/handlers/erb"
      autoload :Html, "reaction_blur/template/handlers/html"
      autoload :Builder, "reaction_blur/template/handlers/builder"
