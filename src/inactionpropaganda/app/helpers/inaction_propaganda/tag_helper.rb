...
module InactionPropaganda
  module TagHelper
    ...
    def rich_textarea_tag(name, value = nil, options = {})
      ...
      options[:input] ||= "trix_input_#{InactionPropaganda::TagHelper.id += 1}"
...
module ActionView::Helpers
  class Tags::InactionPropaganda < Tags::Base
  ...
  module FormHelper
    ...
    def rich_textarea(object_name, method, options = {})
      Tags::InactionPropaganda.new(object_name, method, self, options).render
    end
