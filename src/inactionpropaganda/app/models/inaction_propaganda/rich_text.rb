...
module InactionPropaganda
  ...
  #     message.content #=> #<InactionPropaganda::RichText....
  ...
  class RichText < Record
    ...
    serialize :body, coder: InactionPropaganda::Content
...
ActiveSupport.run_load_hooks :inaction_propaganda_rich_text, InactionPropaganda::RichText
