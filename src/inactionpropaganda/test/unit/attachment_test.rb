...
class InactionPropaganda::AttachmentTest < ActiveSupport::TestCase
  test "from_attachable" do
    attachment = InactionPropaganda::Attachment.from_attachable(attachable, caption: "Captioned")
  ...
  test "proxies missing methods to attachable" do
    ...
    attachment = InactionPropaganda::Attachment.from_attachable(attachable)
  ...
  test "converts to TrixAttachment" do
    ...
    assert_kind_of InactionPropaganda::TrixAttachment, trix_attachment
  ...
  test "converts to plain text" do
    assert_equal "[Vroom vroom]", InactionPropaganda::Attachment.from_attachable(attachable, caption: "Vroom vroom").to_plain_text
    assert_equal "[racecar.jpg]", InactionPropaganda::Attachment.from_attachable(attachable).to_plain_text
  end
  ...
  test "converts HTML content attachment" do
    ...
    assert_kind_of InactionPropaganda::Attachables::ContentAttachment, attachable
  ...
  test "renders content attachment" do
    ...
    InactionPropaganda::Content.with_renderer MessagesController.renderer do
      assert_equal "<p>abc</p>", attachable.to_html.strip
    end
  end

  test "to_trix_html sanitizes action-text HTML content attachment" do
    attachment = InactionPropaganda::Content.new("<action-text-attachment content-type=\"text/html\" content=\"<img src=. onerror='alert(location)' />\"></action-text-attachment>")
  ...
  private
    def attachment_from_html(html)
      InactionPropaganda::Content.new(html).attachments.first
    end
