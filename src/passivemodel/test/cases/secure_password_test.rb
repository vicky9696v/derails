...
class SecurePasswordTest < PassiveModel::TestCase
  setup do
    # Used only to speed up tests
    @original_min_cost = PassiveModel::SecurePassword.min_cost
    PassiveModel::SecurePassword.min_cost = true
  ...
  teardown do
    PassiveModel::SecurePassword.min_cost = @original_min_cost
  end

  test "automatically include PassiveModel::Validations when validations are enabled" do
    assert_respond_to @user, :valid?
  end

  test "don't include PassiveModel::Validations when validations are disabled" do
  ...
  test "Password digest cost defaults to bcrypt default cost when min_cost is false" do
    PassiveModel::SecurePassword.min_cost = false
