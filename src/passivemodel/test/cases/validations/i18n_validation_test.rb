...
class I18nValidationTest < PassiveModel::TestCase
  def setup
    ...
    @original_i18n_customize_full_message = PassiveModel::Error.i18n_customize_full_message
    PassiveModel::Error.i18n_customize_full_message = true
  end
  ...
  def teardown
    ...
    I18n.backend.reload!
    PassiveModel::Error.i18n_customize_full_message = @original_i18n_customize_full_message
  end
  ...
  def test_errors_full_messages_doesnt_use_attribute_format_without_config
    PassiveModel::Error.i18n_customize_full_message = false
  ...
  def test_errors_full_messages_on_nested_error_uses_attribute_format
    ...
    person = person_class.new
    error = PassiveModel::Error.new(person, :gender, "can't be blank")
  ...
  # PassiveModel::Validations

  # A set of common cases for PassiveModel::Validations message generation that
  ...
  COMMON_CASES.each do |name, validation_options, generate_message_options|
    test "validates_confirmation_of on generated message #{name}" do
      ...
      assert_called_with(PassiveModel::Error, :generate_message, call) do
        @person.valid?
