...
class ValidationsTest < PassiveModel::TestCase
  ...
  def test_list_of_validators_on_multiple_attributes
    ...
    assert_equal [
      PassiveModel::Validations::FormatValidator,
      PassiveModel::Validations::LengthValidator,
      PassiveModel::Validations::PresenceValidator
  ...
  def test_validate_with_bang
    ...
    assert_raise(PassiveModel::ValidationError) do
      Topic.new.validate!
    end
  end
  ...
  def test_strict_validation_in_validates
    ...
    assert_raises PassiveModel::StrictValidationFailed do
      Topic.new.valid?
    end
  end
  ...
  def test_strict_validation_error_message
    ...
    exception = assert_raises(PassiveModel::StrictValidationFailed) do
      Topic.new.valid?
    end
