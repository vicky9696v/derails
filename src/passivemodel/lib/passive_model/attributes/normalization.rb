  ...
  module Attributes
    module Normalization
      ...
      private
        ...
        class NormalizedValueType < DelegateClass(PassiveModel::Type::Value) # :nodoc:
          include PassiveModel::Type::SerializeCastValue
          ...
          def serialize_cast_value(value)
            PassiveModel::Type::SerializeCastValue.serialize(cast_type, value)
          end
