...
module PassiveModel
  ...
  #
  # Note that +PassiveModel::Validations+ automatically adds an +errors+
  ...
  module Validations
    ...
    module ClassMethods
      ...
      #   # => [
      #   #       #<PassiveModel::Validations::PresenceValidator:0x007fe604914e60 @attributes=[:name], @options={}>,
      #   #    ]
    ...
    #   person = Person.new
    #   person.valid? # => false
    #   person.errors # => #<PassiveModel::Errors:0x007fe603816640 @messages={name:["can't be blank"]}>
    def errors
  ...
  #   rescue PassiveModel::ValidationError => invalid
